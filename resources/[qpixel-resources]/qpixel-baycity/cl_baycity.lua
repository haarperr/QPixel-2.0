...
-- -105.12893676758, 6471.46484375, 31.626705169678 Heading: 40.885322570801
            if exports["qpixel-inventory"]:hasEnoughOfItem("thermite",1,false) then
                FreezeEntityPosition(PlayerPedId(),true)
                local FirstDoorBigBank = exports["qpixel-taskbar"]:taskBar(9000,"Preparing For Hack")
                if FirstDoorBigBank == 100 then
                    ...
                    function() -- Success
                        ...
                        TriggerEvent('qpixel-vaultDoor3', -1, method)
                        --TriggerEvent('qpixel-ffs2:startheist')
                    ...
                    --     function() -- success
                    --         StopAnimTask(PlayerPedId(), hackAnimDict, "hack_loop", 1.0)
                    --         TriggerEvent('qpixel-vaultDoor2', -1, method)
                    --         TriggerEvent('qpixel-ffs2:startheist')
    ...
    if distance < 1.5 then
        if exports["qpixel-inventory"]:hasEnoughOfItem("thermite",1,false) then
            ...
            if FirstDoorBigBank == 100 then
                ...
                exports["memorygame"]:thermiteminigame(1, 3, 4, 10,
                function() -- Success
                    TriggerEvent("qpixel-BayCityTriggerSecondDoor")
                    TriggerEvent("inventory:removeItem","thermite",1)
                    TriggerEvent('DoLongHudText', 'Well done dumbass please cry more!', 2)
                end,
                function() -- failure
...
RegisterNetEvent('qpixel-BayCityTriggerSecondDoor')
AddEventHandler('qpixel-BayCityTriggerSecondDoor', function()
	anim66()
	Citizen.Wait(3500)
end)

RegisterNetEvent('qpixel-Seconddoorsbaycity') 
AddEventHandler('qpixel-Seconddoorsbaycity', function()
    TriggerServerEvent("qpixel-doors:change-lock-state", 524, false)
end)
    ...
    if distance < 1.5 then
        if exports["qpixel-inventory"]:hasEnoughOfItem("thermite",1,false) then
            ...
            if FirstDoorBigBank == 100 then
                ...
                exports["memorygame"]:thermiteminigame(1, 3, 4, 10,
                function() -- Success
                    TriggerEvent("qpixel-BayCityTriggerFirstDoor")
                    TriggerEvent("inventory:removeItem","thermite",1)
                    TriggerEvent('DoLongHudText', 'Well done dumbass please cry more!', 2)
...
RegisterNetEvent('qpixel-BayCityTriggerFirstDoor')
AddEventHandler('qpixel-BayCityTriggerFirstDoor', function()
	anim69()
	Citizen.Wait(3500)
end)

RegisterNetEvent('qpixel-firstdoorsbaycity') 
AddEventHandler('qpixel-firstdoorsbaycity', function()
    TriggerServerEvent("qpixel-doors:change-lock-state", 525, false)
end)
...
RegisterNetEvent('qpixel-vaultDoor3')
AddEventHandler('qpixel-vaultDoor3', function(method)
...
RegisterNetEvent("qpixel-baycity:getDoorCheckCL")
AddEventHandler("qpixel-baycity:getDoorCheckCL", function(result)
...
Citizen.CreateThread(function()
    ...
    while true do 
        ...
        if isNear then
            TriggerServerEvent('qpixel-baycity:getGetDoorStateSV')
...
RegisterNetEvent("qpixel-ptfxparticlebaycity")
AddEventHandler("qpixel-ptfxparticlebaycity", function(method)
    local ptfx
...
-- 252.99769592285, 220.96379089355, 101.68360137939 Heading: 166.93214416504
    ...
    TriggerServerEvent("qpixel-particleserverbaycity", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomba)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("qpixel-Seconddoorsbaycity")
end

RegisterNetEvent("qpixel-ptfxparticlebaycity1")
AddEventHandler("qpixel-ptfxparticlebaycity1", function(method)
    local ptfx
...
-- 252.99769592285, 220.96379089355, 101.68360137939 Heading: 166.93214416504
    ...
    DetachEntity(bomba, 1, 1)
    FreezeEntityPosition(bomba, true)
    TriggerServerEvent("qpixel-particleserverbaycity1", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomba)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("qpixel-firstdoorsbaycity")
end