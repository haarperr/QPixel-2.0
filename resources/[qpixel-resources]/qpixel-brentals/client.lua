RegisterNetEvent('qpixel-bikerent:menu')
AddEventHandler('qpixel-bikerent:menu', function()                           
  TriggerEvent('qpixel-context:sendMenu', {
        ...
        },
        {
			...
			params = {
                event = "qpixel-bikerent:checkmoney",
                args = {
                    car = Config.bike1,
...
RegisterNetEvent('qpixel-bikerent:checkmoney')
AddEventHandler('qpixel-bikerent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("qpixel-bikerent:hasmoney", price, vehicle)

end)

RegisterNetEvent('qpixel-bikerent:spawnbike')
AddEventHandler('qpixel-bikerent:spawnbike', function(vehicleName)                            
