	...
	while true do
		...
		for k,v in pairs (pedList) do
			...
			if dist < 20.0 and hasAlreadyEntered == false then
				TriggerEvent('qpixel-peds:nearPed', v.model, v.coords, v.heading, v.gender, v.animDict, v.animName)
...
AddEventHandler('qpixel-peds:nearPed', function(model, coords, heading, gender, animDict, animName)
	RequestModel(model)
