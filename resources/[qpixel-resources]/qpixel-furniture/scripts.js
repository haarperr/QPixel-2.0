$(document).ready(function(){
  ...
  $(".btnClose").click(function(){
      closeMain()
      $.post('http://qpixel-furniture/close', JSON.stringify({}));
  });
  ...
  $(".btnMove").click(function(){
      ...
      $(".SelectObject").css("display", "none");
      $.post('http://qpixel-furniture/scanObject', JSON.stringify({}));
  });

  $(".btnFree").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://qpixel-furniture/FreeCam', JSON.stringify({}));
  });
  ...
  $(".btnModify").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://qpixel-furniture/newObject', JSON.stringify({}));
  ...
  $(".btnDelObj").click(function(){
    $.post('http://qpixel-furniture/DelSelectedObj', JSON.stringify({}));
  });
  ...
  $(".btnDel").click(function(){
      ...
      $.post('http://qpixel-furniture/DelObj', JSON.stringify({}));
  });

  $(".btnNextObj").click(function(){
    $.post('http://qpixel-furniture/NextObj', JSON.stringify({}));
  });
  $(".btnPrevObj").click(function(){
    $.post('http://qpixel-furniture/PrevObj', JSON.stringify({}));
  });
    ...
    if(item.redoCSS === true) {
      $('select').each(function(){
          ...
          $listItems.click(function(e) {
              ...
              $.post('http://qpixel-furniture/selectObject', JSON.stringify({selectObject: $this.val()}));
          });
