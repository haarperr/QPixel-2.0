        ...
        while nearBuy2 do
            ...
            if job == 'ems' then
                if IsControlJustReleased(0, 38) then
                    TriggerEvent('qpixel-garages:openBuyMenu2')
                end
            end
        end
    end)
...
RegisterNetEvent('qpixel-garages:openBuyMenu2')
AddEventHandler('qpixel-garages:openBuyMenu2', function()
...
RegisterNetEvent('qpixel-garages:PurchasedBexp')
AddEventHandler('qpixel-garages:PurchasedBexp', function()
...
RegisterNetEvent('qpixel-garages:PurchasedVeh2')
AddEventHandler('qpixel-garages:PurchasedVeh2', function(name, veh, price)
    ...
    TriggerServerEvent('qpixel-garages:FinalizedPur2', plate, name, vehicle, price)
    Citizen.Wait(100)
    exports['qpixel-interface']:hideInteraction()
end)
