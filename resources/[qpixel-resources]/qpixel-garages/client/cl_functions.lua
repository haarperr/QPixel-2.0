...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    if exports['qpixel-menu']:houseGarageCoords() ~= nil and exports['qpixel-menu']:NearHouseGarage() and exports['qpixel-menu']:NearHouseGarage2() then
        HousingSpawn = exports['qpixel-menu']:houseGarageCoords()
	...
	Citizen.CreateThread(function()			
        ...
        --RPC.execute("qpixel-wheelfitment_sv:getfuckingdata",veh, plate)
