;(function () {
        ...
        678: function (_0x534c9f, _0x59ee9e) {
          ...
          _0x59ee9e.Events = {
            on: (_0x4af429, _0x12ba93) => {
              return QPX.Events.on(_0x4af429, _0x12ba93)
            },
            onNet: (_0x590ec8, _0x42e66e) => {
              return QPX.Events.onNet(_0x590ec8, _0x42e66e)
            },
            emit: (_0x48e122, ..._0x827523) => {
              return QPX.Events.emit(_0x48e122, ..._0x827523)
            },
            emitNet: (_0x4c7651, ..._0x56a753) => {
              return QPX.Events.emitNet(_0x4c7651, ..._0x56a753)
            },
            remove: (_0x210fa4, _0x69991a) => {
              return QPX.Events.remove(_0x210fa4, _0x69991a)
            },
          }
          _0x59ee9e.Procedures = {
            register: (_0x250d48, _0x99db80) => {
              return QPX.Procedures.register(_0x250d48, _0x99db80)
            },
            execute: (_0x2063ee, ..._0x599124) => {
              return (
                console.log('execute', _0x2063ee, _0x599124),
                QPX.Procedures.execute(_0x2063ee, ..._0x599124)
              )
            },
          }
          _0x59ee9e.Zones = {
            isActive: (_0x1a9aae, _0x2459cc) => {
              return QPX.Zones.isActive(_0x1a9aae, _0x2459cc)
            },
            onEnter: (_0x2845ef, _0x9eaa89) => {
              return QPX.Zones.onEnter(_0x2845ef, _0x9eaa89)
            },
            onExit: (_0x47dacf, _0xfcdb30) => {
              return QPX.Zones.onExit(_0x47dacf, _0xfcdb30)
            },
            addBoxZone: (
              _0xbcbd01,
              _0x45fd32,
          ...
          _0x59ee9e.Streaming = {
            loadModel: (_0x2a80a1) => {
              return QPX.Streaming.loadModel(_0x2a80a1)
            },
            loadTexture: (_0x2923c5) => {
              return QPX.Streaming.loadTexture(_0x2923c5)
            },
            loadAnim: (_0x21c395) => {
              return QPX.Streaming.loadAnim(_0x21c395)
            },
            loadClipSet: (_0x5e9268) => {
              return QPX.Streaming.loadClipSet(_0x5e9268)
            },
            loadWeaponAsset: (_0xbf7be2, _0x294015, _0x5e144f) => {
              return QPX.Streaming.loadWeaponAsset(_0xbf7be2)
            },
            loadNamedPtfxAsset: (_0x22361b) => {
              return QPX.Streaming.loadNamedPtfxAsset(_0x22361b)
            },
          }
          _0x59ee9e.Utils = {
            cache: (_0x3bac3b, _0x53e624) => {
              return QPX.Utils.cache(_0x3bac3b, _0x53e624)
            },
            cacheableMap: (_0x569b73, _0x5ace11) => {
              return QPX.Utils.cacheableMap(_0x569b73, _0x5ace11)
            },
            waitForCondition: (_0x46ec18, _0xa7c1fb) => {
              return QPX.Utils.waitForCondition(_0x46ec18, _0xa7c1fb)
            },
            getMapRange: (_0x5bb90d, _0x2adc5b, _0x1f95a9) => {
              return QPX.Utils.getMapRange(_0x5bb90d, _0x2adc5b, _0x1f95a9)
            },
            getDistance: (
            ...
            getRandomNumber: (_0x5bb79e, _0x39625e) => {
              return QPX.Utils.getRandomNumber(_0x5bb79e, _0x39625e)
            },
          }
          _0x59ee9e.Interface = {
            ...
            phoneConfirmation: (_0x16a8ed, _0x39aeae, _0x5d0910) => {
              return QPX.Interface.phoneConfirmation(
                _0x16a8ed,
                _0x39aeae,
                _0x5d0910
              )
            ...
            phoneNotification: (
              ...
              return QPX.Interface.phoneNotification(
                _0x57b989,
                _0x130f0e,
                _0x4d63f6,
                _0x1bc1b2
          ...
          _0x59ee9e.Hud = {
            createBlip: (_0xc4c11f, ..._0x515cbb) => {
              return QPX.Hud.createBlip(_0xc4c11f, ..._0x515cbb)
            },
            applyBlipSettings: (
              _0x210d13,
              _0x4d1009,
    ...
    !(function () {
      ...
      _0x38b1ca.Events.onNet(
        'qpixel-bulletclub:gameStarted',
        (_0x5ad20c, _0x4fdc60, _0x5884b1) => {
          return _0x278f2e(_0x5ad20c, _0x4fdc60, _0x5884b1)
        }
      )
      _0x38b1ca.Events.on('qpixel-bulletclub:startGame', () => {
        const _0x3c9078 = GetPlayerServerId(PlayerId())
        return _0x38b1ca.Events.emitNet('qpixel-bulletclub:startGame', _0x3c9078)
      })
      _0x38b1ca.Events.on('qpixel-bulletclub:modifySettings', () => {
        return _0x12898d()
      })
      _0x38b1ca.Events.on('qpixel-bulletclub:viewLeaderBoard', (_0x11fb49) => {
        _0x4890c3(_0x11fb49.type)
      })
      _0x38b1ca.Events.onNet('qpixel-bulletclub:getWeapon', () => {
        _0xc88e74()
      })
      _0x38b1ca.Events.on('qpixel-bulletclub:resetGameState', () => {
        _0x38b1ca.Events.emitNet('qpixel-bulletclub:resetGameState')
      })
      _0x38b1ca.Events.onNet('qpixel-bulletclub:gameReset', () => {
        _0x1ed868()
      })
      RegisterInterfaceCallback(
        'qpixel-bulletclub:purchaseWeapon',
        (_0x396fca, _0x3c4f20) => {
          const _0x4470e0 = {
              ok: true,
              message: 'done',
      ...
      onNet('qpixel-bulletclub:updateHud', (_0x21a871) => {
        ...
        _0x518d14.g.exports['qpixel-interface'].sendAppEvent('status-hud', _0x2caba9)
      })
      onNet('current-items', () => {
        if (_0x3d9643('bullet_club')) {
          return
      ...
      const _0x3af51e = [
          ...
          const _0x5a8970 = setInterval(() => {
            ...
            if (_0x2b4ee2 && IsEntityDead(_0x2b4ee2)) {
              if (GetPedSourceOfDeath(_0x2b4ee2) === PlayerPedId()) {
                _0x576290 += 1
                _0x38b1ca.Events.emitNet('qpixel-bulletclub:targetKilled')
              }
              ...
              _0x38b1ca.Events.emitNet(
                'qpixel-bulletclub:updateEnemiesRemaining',
                _0x4618e2.length
              )
            }
            ...
            if (
              ...
              _0x38b1ca.Events.emitNet(
                'qpixel-bulletclub:gameCompleted',
                _0x5743e6,
                _0x576290
              )
              _0x38b1ca.Events.emitNet(
        ...
        _0x12898d = async () => {
          ...
          const _0x39fa20 = {
            ...
            _0x42dcf0 = await _0x518d14.g.exports['qpixel-interface'].OpenInputMenu(
              _0x1253f2
            )
          if (!_0x42dcf0) {
            return
          ...
          _0x38b1ca.Events.emitNet('qpixel-bulletclub:updateSettings', _0x4090bb)
        },
        _0x4890c3 = async (_0x566cdf) => {
          const _0x24f0f5 = await _0x38b1ca.Procedures.execute(
              'qpixel-bulletclub:getLeaderBoard',
              _0x566cdf
            ),
          ...
          _0x518d14.g.exports['qpixel-interface'].showContextMenu(_0x3cbfda)
        },
        _0xc88e74 = () => {
          const _0x18d817 = [],
            _0x349ca3 = {
          ...
          for (const _0x1ba8b2 of _0xf2c705) {
            const _0xfe183a = {
              ...
              action: 'qpixel-bulletclub:purchaseWeapon',
              key: { weapon: _0x1ba8b2.item },
            }
            _0x18d817.push(_0xfe183a)
          }
          _0x518d14.g.exports['qpixel-interface'].showContextMenu(_0x18d817)
        },
        _0x450127 = () => {
          let _0x3110c1 = false
      ...
      on('qpixel-polyzone:enter', (_0x27dff7) => {
        _0x1b1ac3.add(_0x27dff7)
      })
      on('qpixel-polyzone:exit', (_0x40fc2) => {
        _0x1b1ac3.delete(_0x40fc2)
      })
      on('qpixel-polyzone:enter', (_0x38da11) => {
        if (_0x38da11 !== 'bullet_club') {
          return
        }
        _0x38b1ca.Events.emitNet('qpixel-bulletclub:enteredBuilding')
        SetPedInfiniteAmmoClip(PlayerPedId(), true)
      })
      on('qpixel-polyzone:exit', (_0x587634) => {
        if (_0x587634 !== 'bullet_club') {
          return
        }
        _0x518d14.g.exports['qpixel-interface'].sendAppEvent('status-hud', _0x208bee)
      ...
      const _0x17f261 = (_0x218b36, _0x336906) => {
        ...
        _0x1a5e7c = () => {
          ...
          const _0x3d9631 = {
            ...
            _0x20c227 = {
              ...
              minZ: 18.43,
              maxZ: 22.83,
              zoneEvents: 'qpixel-bulletclub:updateHud',
              data: { id: 'bullet_club' },
              debugPoly: false,
            }
          _0x518d14.g.exports['qpixel-polyzone'].AddBoxZone(
            'bullet_club',
            _0x3d9631,
            22.9,
            24.6,
          ...
          _0x518d14.g.exports['qpixel-polytarget'].AddBoxZone(
        ...
        _0x35dc5b = () => {
          ...
          const _0x4c168d = {
              APXEvent: 'qpixel-bulletclub:startGame',
              id: 'bullet_club_start',
              icon: 'play',
              label: 'Start Game ($500)',
            },
            _0x47f55f = { distance: { radius: 3.5 } }
          _0x518d14.g.exports['qpixel-interact'].AddPeekEntryByPolyTarget(
            'bullet_club_controls',
            [_0x4c168d],
            _0x47f55f
          )
          const _0x51840 = {
            APXEvent: 'qpixel-bulletclub:resetGameState',
          ...
          const _0x7be691 = {
            APXEvent: 'qpixel-bulletclub:modifySettings',
          ...
          const _0x4acabc = {
            APXEvent: 'qpixel-bulletclub:getWeapon',
          ...
          const _0x5b2891 = {
              APXEvent: 'qpixel-bulletclub:viewLeaderBoard',
