!(function () {
        ...
        804: function (_0x591532, _0x54e014, _0x380d09) {
          ...
          _0x54e014.Base = {
            getCharacter: async (_0x3c2235) =>
              await _0x380d09.g.exports['qpixel-lib'].getCharacter(_0x3c2235),
          }
        },
      },
      _0x1755d1 = {}
    ...
    ;(function () {
      ...
      let _0x1bfc13 = 'aimbot',
        ...
        _0x393dde = 0
      const _0x569c41 = () => {
        emitNet('qpixel-bulletclub:updateHud', -1, [
          'Status: ' +
      ...
      _0x3dbf5d.Events.onNet('qpixel-bulletclub:startGame', (_0x4201a8) => {
        if (!_0x4edbd8) {
      ...
      _0x3dbf5d.Events.onNet('qpixel-bulletclub:updateSettings', (_0x1c08fd) => {
        _0x4edbd8 ||
          ((_0x1bfc13 = _0x1c08fd.difficulty),
          (_0x7f00c5 = _0x1c08fd.strafeEnabled),
          _0x569c41())
      })
      _0x3dbf5d.Events.onNet('qpixel-bulletclub:targetKilled', () => {
      ...
      _0x3dbf5d.Events.onNet('qpixel-bulletclub:resetGameState', () => {
        _0x4edbd8 = false
        _0x334b61 = 0
        _0xa3dd03 = 0
        _0x569c41()
        _0x3dbf5d.Events.emitNet('qpixel-bulletclub:gameReset', -1)
      })
      _0x3dbf5d.Events.onNet('qpixel-bulletclub:enteredBuilding', () => {
        _0x569c41()
      })
