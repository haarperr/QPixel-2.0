...
RegisterNetEvent("qpixel-financials:cash")
AddEventHandler("qpixel-financials:cash", function(pCash, pChange)
    if not pCash then return false, "No cash" end
    exports["qpixel-ui"]:cashFlash(pCash, pChange)
end)


RegisterCommand("cashh", function()
    TriggerServerEvent("qpixel-financials:cash:get")
end)
