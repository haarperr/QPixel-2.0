...
function DPX.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        if new then TriggerEvent("qpixel-base:newCharacterSpawned") DoScreenFadeIn(500) end
...
-- RegisterNetEvent("qpixel-base:newCharacterSpawned")
-- AddEventHandler('qpixel-base:newCharacterSpawned', function()
--     DestroyAllCams(true)
