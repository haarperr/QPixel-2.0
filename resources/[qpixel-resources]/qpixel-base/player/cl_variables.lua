...
RegisterNetEvent("qpixel-base:setVar")
AddEventHandler("qpixel-base:setVar", setVar)

RegisterNetEvent("qpixel-base:setChar")
AddEventHandler("qpixel-base:setChar", setChar)

RegisterNetEvent("qpixel-base:resetVars")
AddEventHandler("qpixel-base:resetVars", resetVars)
