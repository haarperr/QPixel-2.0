...
function taskBarSkillCheck(difficulty, skillGapSent, cb, reverse, usePrev)
  ...
  local duration = difficulty * (math.min(exports["qpixel-buffs"]:getAlertLevelMultiplier(), 1.33))
  ...
  exports['qpixel-actionbar']:disableActionBar(true)
  ...
  SetTimeout(500, function()
    if not tbsListening then
      exports['qpixel-actionbar']:disableActionBar(false)
