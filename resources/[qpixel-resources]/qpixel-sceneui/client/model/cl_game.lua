...
AddEventHandler('qpixel-config:configReady', function()
    loadPublicData()
end)

function loadPublicData()
    local showWatermark = exports['qpixel-config']:GetMiscConfig('hud.watermark')
    local showroomPurchase = exports['qpixel-config']:GetMiscConfig('showrooms.catalog.purchase')
    local skipMdwProfileCheck = exports['qpixel-config']:GetMiscConfig('mdw.profiles.skip')
    local serverCode = exports["qpixel-config"]:GetServerCode()
...
-- AddEventHandler("qpixel-ui:hud:values", function(values)
--   -- sendAppEvent("hud", {
--   --     food = values["hunger"],
