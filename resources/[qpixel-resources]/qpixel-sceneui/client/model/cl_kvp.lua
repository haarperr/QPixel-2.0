...
RegisterNUICallback("qpixel-ui:setKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
  -- data.value = value
  ...
  TriggerEvent("qpixel-hud:settings", data.key, data.value)
...
RegisterNUICallback("qpixel-ui:getKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
...
function GetPreferences()
  local result = GetResourceKvpString('qpixel-preferences')
  return json.decode(result or "{}")
end
