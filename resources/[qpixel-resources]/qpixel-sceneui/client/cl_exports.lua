...
RegisterNetEvent("qpixel-sceneui:open-application")
AddEventHandler("qpixel-sceneui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("qpixel-sceneui:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("qpixel-ui:soundPlay")
AddEventHandler("qpixel-ui:soundPlay", function(name, volume, loop)
