...
AddEventHandler('speaktowean', function()
    if exports["qpixel-inventory"]:hasEnoughOfItem("vpnxja",1,false) then
        FreezeEntityPosition(GetPlayerPed(-1),true)
        local finished = exports["qpixel-taskbar"]:taskBar(2000,"Speaking to BJS")
...
AddEventHandler('FleecaShit', function()
	FreezeEntityPosition(GetPlayerPed(-1),true)
    if exports["qpixel-inventory"]:hasEnoughOfItem("heistusb4",1,false) then
		FreezeEntityPosition(GetPlayerPed(-1),false)
...
AddEventHandler('PaletoBank', function()
	FreezeEntityPosition(GetPlayerPed(-1),true)
    if exports["qpixel-inventory"]:hasEnoughOfItem("heistusb1",1,false) then
		FreezeEntityPosition(GetPlayerPed(-1),false)
...
AddEventHandler('BigBank', function()
	FreezeEntityPosition(GetPlayerPed(-1),true)
    if exports["qpixel-inventory"]:hasEnoughOfItem("heistusb2",1,false) then
		FreezeEntityPosition(GetPlayerPed(-1),false)
...
AddEventHandler('BigBank2', function()
	FreezeEntityPosition(GetPlayerPed(-1),true)
    if exports["qpixel-inventory"]:hasEnoughOfItem("heistusb3",1,false) then
		FreezeEntityPosition(GetPlayerPed(-1),false)
...
exports["qpixel-polytarget"]:AddBoxZone("wean_laptop", vector3(-1359.3, -760.39, 22.3), 1, 1, {
    heading=0
  })