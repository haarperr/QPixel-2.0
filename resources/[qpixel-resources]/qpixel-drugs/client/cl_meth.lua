...
AddEventHandler("meth:start", function()
	...
	if exports["qpixel-inventory"]:hasEnoughOfItem("chemicals",5,false) and ongoing == false then
		Cooking()
		FreezeEntityPosition(PlayerPedId(),true)
		SetEntityHeading(PlayerPedId(), 179.97245788574)
		local finished = exports["qpixel-taskbar"]:taskBar(115000,"Mixing Something Nice!")
...
AddEventHandler("meth:packing", function()
	...
	if exports["qpixel-inventory"]:hasEnoughOfItem("methlabbatch",1,false) and ongoing == false then
		Packing()
		FreezeEntityPosition(PlayerPedId(),true)
		SetEntityHeading(PlayerPedId(), 359.97235107422)
		local finished = exports["qpixel-taskbar"]:taskBar(30000,"Curing Meth!")
		if (finished == 100) then
			FreezeEntityPosition(PlayerPedId(),false)
...
AddEventHandler("meth:finish", function()
	...
	if exports["qpixel-inventory"]:hasEnoughOfItem("methlabcured",1,false) and exports["qpixel-inventory"]:hasEnoughOfItem("methlabbaggy",1,false) and ongoing == false then
		Scaling()
		FreezeEntityPosition(PlayerPedId(),true)
		SetEntityHeading(PlayerPedId(), 1.2570070028305)
		local finished = exports["qpixel-taskbar"]:taskBar(32000,"Packing meth!")
		if (finished == 100) then
			FreezeEntityPosition(PlayerPedId(),false)
...
AddEventHandler("meth:sell", function()
	if exports["qpixel-inventory"]:hasEnoughOfItem("1gmeth",1,false) then
		LoadDict('mp_safehouselost@')
		TaskPlayAnim(GetPlayerPed(-1), "mp_safehouselost@", "package_dropoff", 8.0, 1.0, -1, 16, 0, 0, 0, 0 )
		local finished = exports["qpixel-taskbar"]:taskBar(3000,"Handing Over Something")
		if (finished == 100) then
...
function Packing()
  ...
  exports["qpixel-polytarget"]:AddBoxZone("meth_start", vector3(1005.76, -3200.95, -38.99), 2.0, 1.8, {
    heading=0
  })
  
    exports["qpixel-polytarget"]:AddBoxZone("meth_packing", vector3(1016.42, -3194.11, -38.99), 1.0, 2.2, {
    heading=0
  })
  
      exports["qpixel-polytarget"]:AddBoxZone("meth_finish", vector3(1012.12, -3194.07, -38.99), 1.6, 2.2, {
    heading=0
  })