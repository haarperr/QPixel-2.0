...
AddEventHandler('qpixel-voice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('qpixel-voice:setTalkingMode', voiceMode)
	TriggerEvent("qpixel-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('qpixel-voice:toggleMute', toggleMute)
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('qpixel-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('qpixel-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('qpixel-voice_enableMicClicks', tostring(true))
	else
