...
function openGui(sentLength,taskID,namesent,keepWeapon)
    ...
    guiEnabled = true
    pTaskActive = 1
    exports["qpixel-interface"]:sendAppEvent("taskbar", {
        display = true,
        duration = sentLength,
        taskID = taskID,
        label = namesent,
...
function handheld() 
  ...
  function generalInventory()
    if not insidePrompt and not inventoryDisabled and not forceInventoryDisabled and not exports['qpixel-taskbar']:pInInv() then
  ...
  local function hasPhone()
    return exports["qpixel-inventory"]:hasEnoughOfItem("mobilephone", 1, false, true) or
        exports["qpixel-inventory"]:hasEnoughOfItem("stoleniphone", 1, false, true) or
        exports["qpixel-inventory"]:hasEnoughOfItem("stolens8", 1, false, true) or
        exports["qpixel-inventory"]:hasEnoughOfItem("stolennokia", 1, false, true) or
        exports["qpixel-inventory"]:hasEnoughOfItem("stolenpixel3", 1, false, true) or
        exports["qpixel-inventory"]:hasEnoughOfItem("boomerphone", 1, false, true)
  end
  ...
  function generalPhone()
    if not insidePrompt and hasPhone() and canUsePhone() then
      ...
      -- exports["qpixel-ui"]:openApplication("phone", {
...
Citizen.CreateThread(function()
    exports["qpixel-keybinds"]:registerKeyMapping("", "Radio", "Open", "+handheld", "-handheld", "I")
    RegisterCommand('+handheld', handheld, false)
    RegisterCommand('-handheld', function() end, false)
    
    exports["qpixel-keybinds"]:registerKeyMapping("", "Phone", "Open", "+generalPhone", "-generalPhone", "P")
    RegisterCommand('+generalPhone', generalPhone, false)
    RegisterCommand('-generalPhone', function() end, false)
    
    exports["qpixel-keybinds"]:registerKeyMapping("", "Inventory", "Open", "+generalInventory", "-generalInventory", "K")
    RegisterCommand('+generalInventory', generalInventory, false)
    RegisterCommand('-generalInventory', function() end, false)
    
    exports["qpixel-keybinds"]:registerKeyMapping("", "Player", "Escape menu", "+generalEscapeMenu", "-generalEscapeMenu", "ESCAPE")
