!(function () {
  ...
  onNet('qpixel-objects:requestObjects', async () => {
    ...
    emitNet('qpixel-objects:loadObjects', _0x3f784e, _0x2e66af)
  })
  onNet(
    ...
    async (
      ...
      emitNet('qpixel:objects:prepareNewObject', -1, _0x5aa71c)
    }
  )
  RPC.register(
    ...
    async (
      ...
      return emitNet('qpixel:objects:prepareNewObject', -1, _0x588249), true
    }
  )
  RPC.register('qpixel-objects:DeleteObject', async (_0x1d3045, _0x2078ee) => {
    ...
    return (
      !!(await SQL.execute('DELETE FROM __objects WHERE id = @id', {
        id: _0x2078ee,
      })) && (emitNet('qpixel-objects:clearObjects', -1, _0x1edca6), true)
    )
  })
  RPC.register(
    ...
    async (_0x2f99f7, _0x49819b, _0x25e634) => {
      ...
      return emitNet('qpixel-objects:updateObjects', -1, _0x201f32), true
    }
  )
})()
