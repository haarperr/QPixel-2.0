...
RegisterNetEvent('qpixel-dumpster')
AddEventHandler('qpixel-dumpster', function() 
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if (finished == 100) then 
                        ...
                        local finished = exports ['qpixel-taskbar']:taskBar(25000, 'Searching Dumpster')
                        if (finished ==100) then
...
RegisterNetEvent('qpixel-dumpster2')
AddEventHandler('qpixel-dumpster2', function() 
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
    local dumpsterFound = false
        ...
        if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, dumpPos.x, dumpPos.y, dumpPos.z, true) then
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    TaskPlayAnim(GetPlayerPed(-1), dict, 'base', 3.0, -8, -1, 63, 0, 0, 0, 0 )
                    ::skill::
                    local skillfinished = exports["qpixel-skillbar"]:taskBar(1)
...
RegisterNetEvent('qpixel-dumpster3')
AddEventHandler('qpixel-dumpster3', function() 
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
    local dumpsterFound = false
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if skillfinished then
                        ...
                        local finished = exports ['qpixel-taskbar']:taskBar(15000, 'Searching Dumpster')
                        if (finished ==100) then
                            TriggerServerEvent('qpixel:giveDumpsterReward')
