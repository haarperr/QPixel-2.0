...
local function returnBoat()
    ...
    local finished = exports["qpixel-taskbar"]:taskBar(1000, "Returning Boat")
    ...
    TriggerEvent("qpixel-fishing:currentlyRentedBoat", currentlyRentedBoat)
end

function rentBoat()
    boatsValeted = boatsValeted + 1
    FreezeEntityPosition(PlayerPedId(), true)
    local finished = exports["qpixel-taskbar"]:taskBar(1000, "Valeting Boat")
...
AddEventHandler("qpixel-fishing:rentBoat", function(name)
...
AddEventHandler("qpixel-fishing:returnBoat", function()
