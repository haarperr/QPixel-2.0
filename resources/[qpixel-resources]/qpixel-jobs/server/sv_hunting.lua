RegisterServerEvent('qpixel-hunting:skinReward')
AddEventHandler('qpixel-hunting:skinReward', function()
...
RegisterServerEvent('qpixel-hunting:removeBait')
AddEventHandler('qpixel-hunting:removeBait', function()
  local _source = source
  local user = exports["qpixel-base"]:getModule("Player"):GetUser(source)
...
AddEventHandler('complete:job', function(totalCash)
  ...
  TriggerEvent('qpixel-base:huntingLog', _source, totalCash)
end)