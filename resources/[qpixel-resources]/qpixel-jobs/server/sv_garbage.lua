...
RegisterNetEvent('qpixel-garbage:pay')
AddEventHandler('qpixel-garbage:pay', function(jobStatus)
    local _source = source
    local user = exports["qpixel-base"]:getModule("Player"):GetUser(_source)
...
RegisterNetEvent('qpixel-garbage:reward')
AddEventHandler('qpixel-garbage:reward', function(rewardStatus)
    local _source = source
