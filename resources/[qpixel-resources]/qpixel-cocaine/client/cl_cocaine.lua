...
RegisterNetEvent("qpixel-heists:cocaine:failure")
AddEventHandler("qpixel-heists:cocaine:failure", function ()
...
RegisterNetEvent("qpixel-heists:cocaine:begin_start")
AddEventHandler("qpixel-heists:cocaine:begin_start", function ()
    print('Here 3')
...
RegisterNetEvent("qpixel-heists:cocaine:success:2")
AddEventHandler("qpixel-heists:cocaine:success:2", function ()
    print('Here 2')
    if not enabled or not eventStarted then
        return
    end
...
RegisterNetEvent("qpixel-heists:cocaine:success:3")
AddEventHandler("qpixel-heists:cocaine:success:3", function ()
    print('Here 1')
    if not enabled or not eventStarted then
        return
    end
...
RegisterNetEvent("qpixel-heists:cocaine:success:4")
AddEventHandler("qpixel-heists:cocaine:success:4", function ()
...
Citizen.CreateThread(function()
    ...
    exports["qpixel-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
        event = "qpixel-heists:cocaine:failure",
    ...
    exports["qpixel-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
        event = "qpixel-heists:cocaine:begin_start",
    ...
    exports["qpixel-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_second', {{
        event = "qpixel-heists:cocaine:success:2",
    ...
    exports["qpixel-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_third', {{
        event = "qpixel-heists:cocaine:success:3",
    ...
    exports["qpixel-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{ -- THIS IS FUCKING SUCCESSSSSSSS
        event = "qpixel-heists:cocaine:success:4",
    ...
    exports["qpixel-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{
        event = "qpixel-heists:cocaine:success:4",
...
RegisterNetEvent("qpixel-heists:doVehicle", function(pVehicle, x,y,z)
    print(pVehicle)
...
RegisterCommand('cocaine', function()
    ...
    Wait(5500)
    TriggerEvent('qpixel-heists:cocaine:success:4')
end)