RegisterServerEvent("qpixel-npcs:location:fetch")
AddEventHandler("qpixel-npcs:location:fetch",function()
    local src = source
    ...
    TriggerClientEvent("qpixel-npcs:set:ped", src, Generic.NPCS)
end)