...
isEnabled = function(pEntity, pContext)
    return not IsDisabled() and IsPedInAnyVehicle(PlayerPedId(), false) and exports['qpixel-vehicles']:hasKey(GetVehicleNumberPlateText(GetVehiclePedIsIn(PlayerPedId()))) 
end
}
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      id = "qpixel-garages:pd_heli",
      title = "Vehicle List",
      icon = "#vehicle-vehicleList",
      event =  "qpixel-garages:pd_heli" 
  },
  isEnabled = function()
...
-- --         event = "qpixel-doors:doorKeyFob"
-- --     },
-- --     isEnabled = function(pEntity, pContext)
-- --         return not IsDisabled() and IsPedInAnyVehicle(PlayerPedId(), false) and exports["qpixel-inventory"]:hasEnoughOfItem("keyfob", 1, false)
-- --     end
-- -- }
...
--   },
--   isEnabled = function(pEntity, pContext)
--       return not IsDisabled() and polyChecks.vanillaUnicorn.isInside and not exports["qpixel-flags"]:HasPedFlag(PlayerPedId(), 'isPoledancing')
--   end
-- }
...
--   },
--   isEnabled = function(pEntity, pContext)
--       return not IsDisabled() and polyChecks.vanillaUnicorn.isInside and exports["qpixel-flags"]:HasPedFlag(PlayerPedId(), 'isPoledancing')
--   end
-- }
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
    ...
    event = "qpixel-garages:store"
},
isEnabled = function()
  return isAtGarage and exports["qpixel-garages"]:NearVehicle("Distance") and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
} 
...
isEnabled = function()
  return exports["qpixel-garages"]:atShared() and exports["qpixel-garages"]:NearVehicle("Distance") and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
...
isEnabled = function()
  return isAtHouseGarage and exports["qpixel-garages"]:NearVehicle("Distance") and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
}]]
 ...
 GeneralEntries[#GeneralEntries+1] = {
   data = {
     ...
     title = "Get up",
     icon = "#obj-chair",
     event = "qpixel-emotes:sitOnChair"
   },
   isEnabled = function(pEntity, pContext)
     return not isDead and exports["qpixel-flags"]:HasPedFlag(PlayerPedId(), 'isSittingOnChair')
   end
 }
...
--       event = "qpixel-housing:rent"
--   },
--   isEnabled = function(pEntity, pContext)
--       return not isDead and exports["qpixel-housing"]:canRent()
--   end
-- }
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      icon = "#property-enter",
      event = "qpixel-housing:enterBUILDINGCMON",
      parameters = false,
  },
  isEnabled = function(pEntity, pContext)
      local isNear, propertyId = exports["qpixel-housing"]:isNearProperty()
...
GeneralEntries[#GeneralEntries+1] = {
  ...
  isEnabled = function(pEntity, pContext)
      local isNear, propertyId = exports["qpixel-housing"]:isNearProperty()
      return not isDead and isNear and exports["qpixel-housing"]:isBeingRobbed(propertyId)
  end
}
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      event = "qpixel-dispatch:openFull"
  },
  isEnabled = function()
...
isEnabled = function()
 print(exports['qpixel-housing']:ownsThisHouseHmm())
  return isAtHouseGarage and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
}
...
-- -- end)
 ...
 AddEventHandler("vehicle:openRifleRack", function()
	...
	if exports["isPed"]:isPed("myJob") == 'police' or exports["isPed"]:isPed("myJob") == 'sheriff' or exports["isPed"]:isPed("myJob") == 'ranger' or exports["isPed"]:isPed("myJob") == 'state' then
		local finished = exports["qpixel-taskbar"]:taskBar(1000,"Unlocking...",false,true)
...
AddEventHandler("qpixel-menu:dashCamAttached", function(pVehicleNetId, pEnabled)
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      event = "qpixel-gopro:removeDashCam",
  },
  isEnabled = function()
    local veh = GetVehiclePedIsIn(PlayerPedId())
