...
--       return not IsDisabled() and exports['qpixel-vehicles']:HasVehicleKey(pEntity) and exports['qpixel-vehicles']:IsOnParkingSpot(pEntity, false) and not IsPedInAnyVehicle(PlayerPedId(), false)
--     end
-- }
-- VehicleEntries[#VehicleEntries+1] = {
--     data = {
...
--         title = "Grab goods",
--         icon = "#obj-box",
--         event = "qpixel-jobs:247delivery:takeGoods"
--     },
--     isEnabled = function(pEntity, pContext)
...
VehicleEntries[#VehicleEntries+1] = {
  data = {
      ...
      event = "qpixel-jobs:police_impound_menu", 
      parameters = {}
  },
  isEnabled = function(pEntity, pContext)
...
VehicleEntries[#VehicleEntries+1] = {
  data = {
      ...
      icon = "#vehicle-impound",
      event = "qpixel-jobs_tow_menu", 
      parameters = {}
  },
  isEnabled = function(pEntity, pContext)
    return pContext.distance <= 2.5 and exports['qpixel-jobs']:IsAbleImp()
  end
}
