...
AddEventHandler("qpixel-inventory:itemUsed", function(pItem)
  ...
  Citizen.CreateThread(function()
    ...
    Wait(200)
    TriggerEvent("qpixel-props:attachProp", "np_wingsuit_open", 24817, 0.1, -0.15, 0.0, 0.0, 90.0, 0.0, true, true, "np_wingsuit_open")
  end)
  Citizen.CreateThread(function()
  ...
  Citizen.CreateThread(function()
    ...
    TriggerEvent("qpixel-props:removePropByName", "np_wingsuit_open")
    wingsuiting = false
  end)
  Citizen.CreateThread(function()
    while not IsPedInParachuteFreeFall(playerPed) do
...
AddEventHandler("qpixel-inventory:itemUsed", function(pItem)
  ...
  Citizen.CreateThread(function()
    TriggerEvent("inventory:removeItem", pItem, 1)
    Wait(200)
    TriggerEvent("qpixel-props:attachProp", "np_wingsuit_b_open", 24817, 0.1, -0.15, 0.0, 0.0, 90.0, 0.0, true, true, "np_wingsuit_b_open")
  end)
  Citizen.CreateThread(function()
    SetPlayerParachuteModelOverride(PlayerId(), `p_parachute1_mp_s`)
    SetPedParachuteTintIndex(playerPed, 6)
  ...
  Citizen.CreateThread(function()
    ...
    TriggerEvent("qpixel-props:removePropByName", "np_wingsuit_b_open")
    wingsuiting = false
  end)
  Citizen.CreateThread(function()
    while not IsPedInParachuteFreeFall(playerPed) do
