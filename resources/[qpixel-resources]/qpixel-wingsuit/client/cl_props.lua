-- TriggerEvent("qpixel-props:attachProp", flagProp, 24818, -0.25, -0.25, 0.0, 180.0, 90.0, 0.0)
...
AddEventHandler("qpixel-props:attachProp", function(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex, name)
  attachProp(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex, name)
end)
AddEventHandler("qpixel-props:removeProp", function()
  removeAttachedProp()
end)
AddEventHandler("qpixel-props:removePropByName", function(pName)
