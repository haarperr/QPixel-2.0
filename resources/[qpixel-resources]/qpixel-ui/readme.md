...
exports['qpixel-ui']:openApplication('textbox', {
    callbackUrl = 'qpixel-ui:scenes:input', -> callbackUIName
    key = 1,
    items = {
        {
...
RegisterUICallback("qpixel-ui:scenes:input", function(data, cb)
    ...
    local data = {
        {
            ...
            key = true,
            children = {
				{ title = "Confirm Purchase", action = "qpixel-ui:wheelchairPurchase", key = true }, -> action is name of UICallback
			},
        },
    }
...
RegisterUICallback("qpixel-ui:wheelchairPurchase", function(data, cb)
...
####
exports["qpixel-ui"]:taskBarSkill(timer, skillGapSent)
####
...
###
exports["qpixel-ui"]:sendAppEvent("game", {
    modeDev = true / false,
