...
function outOfPins() {
  $.post('http://qpixel-lockpicking/failure', JSON.stringify({}));
  gameOver = true;
...
function unlock() {
  $.post('http://qpixel-lockpicking/complete', JSON.stringify({}));
...
document.onkeyup = function (data) {
  if (data.which == 27 ) {
    $.post('http://qpixel-lockpicking/close', JSON.stringify({}));
  }
};
