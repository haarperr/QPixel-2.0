...
Citizen.CreateThread(function()
  ...
  -- exports["qpixel-polyzone"]:AddBoxZone("casino_entrance", vector3(934.66, 46.54, 81.11), 4.4, 6.2, {
  --   heading=10,
  --   minZ=80.1,
  --   maxZ=82.9,
  --   data = {
  ...
  --   },
  -- })
  -- exports["qpixel-polyzone"]:AddBoxZone("casino_exit", vector3(1089.83, 206.84, -49.0), 4, 4, {
  --   heading=0,
  --   minZ=-50.2,
  --   maxZ=-47.2,
  --   data = {
  ...
  --   },
  -- })
  exports["qpixel-polyzone"]:AddBoxZone("casino_entrance", vector3(930.0, 43.48, 81.1), 12.2, 10, {
    heading=328,
    minZ=79.9,
    maxZ=83.9,
    data = {
  ...
  exports["qpixel-polyzone"]:AddBoxZone("casino_exit", vector3(921.06, 48.99, 81.1), 10.8, 10, {
    heading=328,
    minZ=79.7,
    maxZ=83.7,
    data = {
  ...
  exports["qpixel-polyzone"]:AddBoxZone("casino_post_gate", vector3(1122.36, 240.28, -50.44), 10.8, 5.0, {
    heading=42,
    minZ=-51.44,
    maxZ=-49.04,
    data = {
  ...
  exports["qpixel-polyzone"]:AddBoxZone("casino_betting_screen", vector3(1100.96, 256.81, -51.24), 20, 25.6, {
    heading=306,
    minZ=-52.04,
    maxZ=-48.04,
    data = {
  ...
  -- exports["qpixel-polytarget"]:AddBoxZone("wheel_of_fortune", vector3(988.26, 42.93, 73.265), 1.0, 1.0, {
  --   heading=199.95,
  --   minZ=72.265,
  --   maxZ=74.265,
  --   data = {
  ...
  --   },
  -- })
  exports["qpixel-polytarget"]:AddCircleZone("wheel_of_fortune", vector3(988.26, 42.93, 71.265), 2.0, { useZ=false })
  exports["qpixel-polytarget"]:AddBoxZone("casino_reception", vector3(989.98, 31.6, 71.47), 2.6, 0.8, {
    heading=330,
    minZ=70.265,
    maxZ=72.265,
    data = {
  ...
  exports['qpixel-interact']:AddPeekEntryByPolyTarget("wheel_of_fortune", {{
    event = "qpixel-casino:wheel:spinWheelTurbo",
    id = "wheelspinturbo",
    icon = "fas fa-play",
    label = "Turbo Spin!",
  }}, { distance = { radius = 2.5 } })
  exports['qpixel-interact']:AddPeekEntryByPolyTarget("wheel_of_fortune", {{
    event = "qpixel-casino:wheel:spinWheel",
    id = "wheelspin",
    icon = "fas fa-play",
    label = "Spin!",
  }}, { distance = { radius = 2.5 } })
  exports['qpixel-interact']:AddPeekEntryByPolyTarget("casino_reception", {{
    event = "qpixel-casino:purchaseMembership",
    id = "member",
    icon = "fas fa-dollar-sign",
    label = "Buy Membership Card",
  }}, { distance = { radius = 1.5 } })
  exports['qpixel-interact']:AddPeekEntryByPolyTarget("casino_reception", {{
    event = "qpixel-casino:purchaseChips",
    id = "chips",
    icon = "fas fa-dollar-sign",
    label = "Casino Chips",
  }}, { distance = { radius = 1.5 } })
  exports['qpixel-interact']:AddPeekEntryByPolyTarget("casino_reception", {{
    event = "qpixel-casino:purchaseVipMembership",
    id = "vipmember",
    icon = "fas fa-dollar-sign",
...
RegisterNetEvent("qpixel-casino:entitySetSwap")
AddEventHandler("qpixel-casino:entitySetSwap", function(set)
...
AddEventHandler("qpixel-casino:enterPenthouse", function()
  TriggerEvent("qpixel-casino:elevatorExitCasino")
  local interiorId = GetInteriorAtCoords(968.58,46.92,116.17)
  ActivateInteriorEntitySet(interiorId, "set_pent_creampie")
  RefreshInterior(interiorId)
end)

AddEventHandler("qpixel-casino:betting:interiorSwap", function(pArgs)
  ...
  TriggerServerEvent("qpixel-casino:interiorSwap", pArgs[1])
end)
