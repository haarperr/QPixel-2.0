...
function StartPeekin()
    ...
    UpdateRequired = true
    NearZones = {}
    nearbyZones = exports["qpixel-polytarget"]:GetZones(GetEntityCoords(PlayerPedId())) or {}
...
RegisterNetEvent("qpixel-target:changed", function(pTarget, pEntityType, pEntityOffset)
...
RegisterNetEvent('qpixel-polyzone:enter', function(zoneName, zoneData, zoneCenter)
...
RegisterNetEvent('qpixel-polyzone:exit', function(zoneName)
    if not PeekEntries['polytarget'][zoneName] then return end
