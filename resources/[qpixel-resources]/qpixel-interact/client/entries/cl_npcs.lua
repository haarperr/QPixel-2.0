    ...
    data = {
        {
            ...
            label = "Sign In/Out",
            icon = "fas fa-circle",
            event = "qpixel-chopshop:clock-in",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "fas fa-circle",
            event = "qpixel-license:purchaseBusinessLicense",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Package Goods",
            icon = "fas fa-user-secret",
            event = "qpixel-weed:preparePackage",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Open Shop",
            icon = "circle",
            event = "qpixel-npcs:ped:openDigitalDenShop",
        }
    },
    options = {
        distance = { radius = 2.5 },
    ...
    data = {
        {
            ...
            label = "Trade",
            icon = "recycle",
            event = "qpixel-npcs:ped:exchangeRecycleMaterial",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Sell Fish",
            icon = "fish",
            event = "qpixel-npcs:ped:sellFish",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(entity)
            return not IsPedAPlayer(entity) and exports["qpixel-polyzone"]:IsInsideEvent(entity)
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qpixel-houserobberies:sell_goods",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qpixel-heists:interactBobcatC4Npc",
            parameters = {},
        },
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qpixel-npcs:ped:giveStolenItems",
            parameters = {}
        },
        {
            id = "pawn_sell_items",
            ...
            icon = "circle",
            event = "qpixel-npcs:ped:sellStolenItems",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
      {
          ...
          label = "Buy Chips",
          icon = "fas fa-circle",
          event = "qpixel-casino:purchaseChipsAction",
          parameters = { "purchase" }
      },
      {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "qpixel-casino:wheel:toggleEnable",
    },
    {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "qpixel-casino:purchaseMembershipCard",
        parameters = {}
    },
  },
  options = {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "qpixel-casino:purchaseDrinks",
        parameters = {}
    },
  },
  options = {
    ...
    data = {
      {
          ...
          icon = "fas fa-clock",
          event = "qpixel-heists:checkAvailability",
          parameters = {}
      },
    },
    options = {
    ...
    data = {
      {
          ...
          event = "qpixel-heists:purchaseHeistEquipment",
          parameters = {}
      },
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Rent a Boat",
            icon = "circle",
            event = "qpixel-fishing:rentBoat",
        },
        {
            id = "fish_return",
            label = "Return the Boat",
            icon = "circle",
            event = "qpixel-fishing:returnBoat",
        }
    },
    options = {
        distance = { radius = 3.0 }
    ...
    data = {
        {
            ...
            label = "Get a Boat",
            icon = "circle",
            event = "qpixel-scuba:checkAndTakeDepo",
        }
    },
    options = {
        distance = { radius = 3.0 }
...
local validAnimalModels = {
    ...
    data = {
        {
            ...
            label = "Pet",
            icon = "fas fa-circle",
            event = "qpixel-interact:doPettingAnimal",
            parameters = "petting",
        },
    },
    options = {
  ...
  AddEventHandler("qpixel-interact:doPettingAnimal", function()
