...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return not exports['qpixel-fuel']:hasNozle()
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 1.7 },
        isEnabled = function(pEntity, pContext)
            return exports['qpixel-fuel']:hasNozle()
        end
    }
}
    ...
    data = {
        {
            ...
            label = "Weights",
            icon = "circle",
            event = "qpixel-healthcare:exercise",
            parameters = {}
        }
    },
    options = {
...
--             label = "Smoke Machine",
--             icon = "circle",
--             event = "qpixel-stripclub:smokemachine",
--             parameters = {}
--         }
--     },
--     options = {
    ...
    data = {
        {
            ...
            label = "Skin Animal",
            icon = "circle",
            event = "qpixel-hunting:skinAnimal",
            parameters = {}
        }
    },
    options = {
  ...
  data = {
      {
          ...
          icon = "archive",
          event = "qpixel-beekeeping:checkBeehive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          event = "qpixel-beekeeping:harvestHive",
          parameters = {}
      }
  },
  options = {
