    ...
    data = {
        {
            ...
            label = "Grab Drink",
            icon = "circle",
            event = "qpixel-stripclub:peekAction",
  ...
  data = {
      {
          ...
          icon = "dollar-sign",
          event = "qpixel-tavern:peekAction",
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qpixel-signin:peekAction",
    ...
    data = {
        {
            ...
            label = "Cook Patty",
            icon = "circle",
            event = "qpixel-burgershot:startprocess3",
            parameters = { name = "burger_shot"}
        }
    },
    job = {"burger_shot"},
    ...
    data = {
        {
            ...
            label = "Make Shakes",
            icon = "circle",
            event = "qpixel-burgershot:makeshake",
            parameters = { name = "burger_shot"}
        }
    },
    job = {"burger_shot"},
    ...
    data = {
        {
            ...
            label = "Make Cola's",
            icon = "circle",
            event = "qpixel-burgershot:getcola",
            parameters = { name = "burger_shot"}
        }
    },
    job = {"burger_shot"},
    ...
    data = {
        {
            ...
            label = "Clock In",
            icon = "circle",
            event = "qpixel-jobs:garbagestart:menu",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qpixel-jailbreak:services",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "car",
            event = "qpixel-showrooms:enterExperience",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle", 
            event = "qpixel-foodchain:cash:in",
            parameters = {}
        },
        {
            id = "paycheck_kosta",
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qpixel-jail:work-clean-1",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Clean this Mess",
            icon = "circle",
            event = "qpixel-jail:work-clean-2",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Clean this Mess",
            icon = "circle",
            event = "qpixel-jail:work-clean-3",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Clean this Mess",
            icon = "circle",
            event = "qpixel-jail:work-clean-4",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(entity)
            return exports['qpixel-boosting']:pCanUseLaptop()
        end
    }
}
    ...
    data = {
        {
            ...
            label = "Reset Garage",
            icon = "circle",
            event = "qpixel-garages:resetpdgarage",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "qpixel-interact:pickupPaycheck",
            parameters = {}
        },
        { 
...
exports["qpixel-polytarget"]:AddBoxZone("paycheck_collect", vector3(241.65, 226.2, 106.29), 1, 1, {
    heading=340,
    minZ=102.49,
    maxZ=106.49
})

exports["qpixel-polytarget"]:AddBoxZone("paycheck_recipt", vector3(241.65, 226.2, 106.29), 1, 1, {
    heading=340,
    minZ=102.49,
    maxZ=106.49
})

RegisterNetEvent('qpixel-interact:pickupPaycheck', function()
...
exports["qpixel-polytarget"]:AddBoxZone("pd_shared_garage_reset", vector3(443.01, -973.6, 25.7), 2, 2, { -- PD shared reset
    heading=0,
    minZ=25.7 - 1,
    maxZ=25.7 + 1,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("mdm_craft", vector3(-1582.822, -278.280, 55.09), 2.5, 1.35, { -- Mandem Craft
    heading=282.3,
    minZ=53,
    maxZ=56,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("mango_craft", vector3(849.383, -2881.550, 11.321), 0.5, 0.5, { -- Mango Craft
    heading=268.2,
    minZ=10,
    maxZ=12,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("mango_stash", vector3(844.55,-2880.81, 11.48), 2.5, 1.35, { -- Mango Stash
    heading=175.3,
    minZ=10,
    maxZ=12,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("mat_refine", vector3(-33.868, -1040.714, 28.399), 0.5, 0.5, { -- Material Refining
    heading=68.9,
    minZ=28,
    maxZ=29,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("vpn_spot", vector3(-218.552, -1333.907, 30.759), 1.0, 1.0, { -- VPN Purchasing
    heading=267.7,
    minZ=30,
    maxZ=31,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("guerro_craft", vector3(488.184, -1966.342, 24.888), 0.5, 0.5, { -- Guerro Craft
    heading=118.2,
    minZ=24,
    maxZ=26,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("guerro_stash", vector3(489.716, -1965.143, 25.299), 1.35, 1.35, { -- Guerro Stash
    heading=38.1,
    minZ=24,
    maxZ=26,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("strokers_stash", vector3(578.49, -1870.1, 25.27), 2.4, 1, { -- Guerro Stash
    heading=335.5,
    minZ=110,
    maxZ=112,
    debugPoly=false
...
exports["qpixel-polytarget"]:AddBoxZone("gang3_stash", vector3(1609.23, 3774.43, 34.87), 1, 1, { -- black family Stash
    heading=305,
    minZ=34.87-1,
    maxZ=34.87+1
    --debugPoly=false
