RegisterNetEvent("qpixel-racing:recieveCreateData")
AddEventHandler("qpixel-racing:recieveCreateData", function(pRaceName, pRaceType, pRaceThumbnail, pCheckpoints)
    local src = source
    ...
    TriggerClientEvent("qpixel-racing:addedRace", -1, {}, Races)
    TriggerClientEvent("DoLongHudText", src, "Race " .. pRaceName .. " created!")
end)

RPC.register("qpixel-racing:isRaceNameTaken", function(src, pRaceName)
