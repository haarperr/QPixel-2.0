...
function startRaceCreation(options)
    ...
    while raceName ~= nil and options.raceName == nil and RPC.execute("qpixel-racing:isRaceNameTaken", raceName) == true do
...
function finishRaceCreation()
    ...
    TriggerServerEvent("qpixel-racing:recieveCreateData", raceName, raceType, raceThumbnail, checkpoints)
...
RegisterNetEvent("qpixel-racing:cmd:racecreate")
AddEventHandler("qpixel-racing:cmd:racecreate", function(options)
    if GetVehiclePedIsIn(PlayerPedId(), false) ~= 0 then
        startRaceCreation(options)
    end
end)

RegisterNetEvent("qpixel-racing:cmd:racecreatedone")
AddEventHandler("qpixel-racing:cmd:racecreatedone", function()
    finishRaceCreation()
end)

RegisterNetEvent("qpixel-racing:cmd:racecreatecancel")
AddEventHandler("qpixel-racing:cmd:racecreatecancel", function()
    cancelRaceCreation()
end)
