RPC.register("qpixel-phone:submitNewEventDiamondSports", function(pSource, pEventName, pEventLocation, pTimeZone, pEventTimeHr, pEventTimeMin, pEventDate)
...
RPC.register("qpixel-phone:getDiamondSportsEvents", function(pSource)
...
RPC.register("qpixel-phone:deleteDiamondEvent", function(pSource, pID)
