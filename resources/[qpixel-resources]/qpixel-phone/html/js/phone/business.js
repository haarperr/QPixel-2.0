...
function manageGroups(id){
    $.post('http://qpixel-phone/manageGroup', JSON.stringify({
        GroupID: id
    }));
}
...
function addGroupManage(group,ranking) {
   ...
   $.post('http://qpixel-phone/retreiveGroupRanks', JSON.stringify({
       bID: globalGroup
   }));
...
$('#group-manage-fire-accept').click(function(e){
    ...
    setTimeout(() => {
        $.post('http://qpixel-phone/fireEmployee', JSON.stringify({
...
$(".group-submit-hire-rank").click(function (e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://qpixel-phone/addEmployee', JSON.stringify({
            business: business_id,
            rank: rank,
            state_id: state_id
        }));
...
$("#rankSet-submit-input").click(function (e) {
    ...
    setTimeout(() => {
        $.post('http://qpixel-phone/editEmployee', JSON.stringify({
            business: business_id,
            rank: rank,
            state_id: state_id
        }));
...
$(".payexternal-submit").click(function(e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://qpixel-phone/payExternal', JSON.stringify({
            pStateId: stateid,
            pAmount: amt,
...
$(".create-rank-submit-input").click(function(e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://qpixel-phone/createBusinessRole', JSON.stringify({
            pBusinessId: business_id, 
...
$(".edit-rank-submit-input").click(function(e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://qpixel-phone/editBusinessRole', JSON.stringify({
            pBusinessId:      business_id, 
            pCurRole:         currole, 
            pRoleName:        rolename, 
            pPermFire:        fire, 
...
$(".delete-rank-submit-input").click(function(e) {
    ...
    complateInput();
    setTimeout(() => {
        $.post('http://qpixel-phone/deleteRole', JSON.stringify({
            pBusinessID: business_id,
            pRole: rolename
        }))
        setTimeout(() => {
...
$(".btn-d-logs").click(function(e){
    $('.option-main').fadeOut()
    var business_id = $("#business-id").val();
    $.post('http://qpixel-phone/openBusinessLogs', JSON.stringify({
        business: business_id
    }))
})
...
$("#paycheck-submit-input").click(function (e) {
    ...
    // console.log("SUBMIT SHIT")
    setTimeout(() => {
        $.post('http://qpixel-phone/payCheckEmployee', JSON.stringify({
            business: business_id,
            amount: amount,
            state_id: state_id
        }));
...
$("#add-cash-submit-input").click(function(e){
    ...
    $('.group-manage-add-cash').fadeOut()
    complateInput();
    $.post('http://qpixel-phone/addCashBank', JSON.stringify({
            bid: bId,
            amount: amount,
    }));
    setTimeout(() => {
...
$(".groupbill-submit").click(function(e) {
    ...
    $.post('http://qpixel-phone/chargeCustomer', JSON.stringify({
        GroupID: business_id,
        stateID: stateID,
        amount: amount,
        reason: comment,
