'use strict';function addDebtCars(a){0==Object.keys(a).length&&$(".asset-fee").css("display","none");1<=Object.keys(a).length&&$(".asset-fee").css("display","block");for(let b of Object.keys(a)){var c=0;let d="";null!==a[b].price&&(c=a[b].price);d=0===a[b].days_left?"Payments Overdue":a[b].days_left+" Day(s) left";c=`<div class="DebtPaper" id="debt-${a[b].id}">
     ...
     </div>`;$(".cars-entries").append(c)}$(".c-pawynow-button").click(function(){plate=$(this).attr("plate");payment=$(this).attr("cPayment");$.post("https://qpixel-phone/car_paid",JSON.stringify({plate,payment}));complateInput();setTimeout(()=>{$.post("https://qpixel-phone/btnDebt",JSON.stringify({}))},2E3)});$(".debtContainer").parent(".DebtPaper").children(".debtDrawer").css("display","none")}
function addDebtHouse(a){0==Object.keys(a).length&&$(".h-loan").css("display","none");1<=Object.keys(a).length&&$(".h-loan").css("display","block");for(let d of Object.keys(a)){var c="",b=Math.ceil(7-parseFloat(a[d].last_payment));c=0==b?"Payments Overdue":`${b} Day(s) left`;b=Math.ceil(a[d].price/b);c=`
        ...
        </div>`;$(".debt-house-entries").append(c)}$(".h-pawynow-button").click(function(){hid=$(this).attr("hId");payment=$(this).attr("h-payment");$.post("https://qpixel-phone/h_paid",JSON.stringify({hid,payment}));complateInputJustGreen();setTimeout(()=>{$.post("https://qpixel-phone/btnDebt",JSON.stringify({}))},2E3)});$(".debtContainer").parent(".DebtPaper").children(".debtDrawer").css("display","none")}
function addDebtPlayer(a){0==Object.keys(a).length&&$(".player-debt").css("display","none");1<=Object.keys(a).length&&$(".player-debt").css("display","block");for(let b of Object.keys(a)){var c=a[b].price;c=`
        ...
        </div>`;$(".player-entries").append(c);tippy(".tippy-debt",{theme:"nopixel"})}$(".p-pawynow-button").click(function(){pid=$(this).attr("pId");did=$(this).attr("dId");payment=$(this).attr("p-payment");$.post("https://qpixel-phone/p_paid",JSON.stringify({pid,did,payment}));complateInput();setTimeout(()=>{$.post("https://qpixel-phone/btnDebt",JSON.stringify({}))},2E3)});$("#call-debt").click(function(b){$.post("http://qpixel-phone/callContact",JSON.stringify({name:$(this).data("name"),number:$(this).attr("phone_number")}))});
