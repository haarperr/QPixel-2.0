...
function addIdleGroup(IdleGroup){
    ...
    $('.g-join').click(function(){
        ...
        $.post("https://qpixel-phone/j_group", JSON.stringify({
            gId: gid,
            members: members
        }))
        tippy('.tippy-groups', {
...
$('.b-g-ready').click(function(){
    ...
    if (ready == 0){
        ...
        $.post("https://qpixel-phone/group_status", JSON.stringify({
            status: true,
            gId: gId
        }))
    }else{
...
$('#create-Group').click(function(){
    ...
    $.post("https://qpixel-phone/c_group", JSON.stringify({}))
    complateInput();
        setTimeout(() => {
...
$('.g-disband').click(function(){
    ...
    $.post("https://qpixel-phone/leave_group", JSON.stringify({
        gid: gId
    }))
    complateInput();
        setTimeout(() => {
