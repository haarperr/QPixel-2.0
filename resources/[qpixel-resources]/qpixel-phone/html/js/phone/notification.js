...
btnGasAccept = () => {
	...
	if (gasType == "gas") { 
        ...
        $.post("https://qpixel-phone/accept_delivery_job", JSON.stringify({}))
    } else if (gasType == "jobofferdodo") {
        $.post("https://qpixel-phone/accept_dodo_job", JSON.stringify({}))
    } else if (gasType == "house_robbery") {
        $.post("https://qpixel-phone/accept_house_robbery", JSON.stringify({}))
    } else if (gasType == "jobofferoxy") {
        $.post("https://qpixel-phone/accept_oxy_run", JSON.stringify({}))
	} else if (gasType == "jobofferchop") {
        $.post("https://qpixel-phone/accept_chop_shop", JSON.stringify({}))
	} else if (gasType == "documents") {
		$.post("https://qpixel-phone/acceptDocumentReceiveRequest", JSON.stringify({
		...
		$.post("https://qpixel-phone/onPlayerJoinBankBusters", JSON.stringify({
...
btnJobAccept = () => {
	...
	$.post("https://qpixel-phone/jobOfferAccepted", JSON.stringify({
	}))
}
