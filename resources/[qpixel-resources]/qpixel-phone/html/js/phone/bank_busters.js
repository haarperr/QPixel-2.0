function createBankBustersDev() {
    ...
    $(".eye-camera").click(function () {
        ...
        $.post('https://qpixel-phone/tryClaimBank', JSON.stringify({
            bbid: bbid
        }));
    })
...
$("#createBankBusterGroup").on('click', function() {
    $.post('https://qpixel-phone/createBankbusterGroup', JSON.stringify({}))
    refreshBankBusters()
})
...
$("#leaveBankBusterGroup").on('click', function() {
    ...
    $.post('https://qpixel-phone/leaveBankbusterGroup', JSON.stringify({
        cid: insertedCid,
...
$("#bankbuster-submit-cid").on('click', function() {
    ...
    complateInputQuick()
    setTimeout(() => {
        $.post('https://qpixel-phone/addBankbusterGroup', JSON.stringify({
            cid: insertedCid,
            groupID: insertedGroupID
        }));
        $("#bankbustercid").val("");
