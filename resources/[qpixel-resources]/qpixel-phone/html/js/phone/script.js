...
$(document).ready(function () {
    ...
    $.post('http://qpixel-phone/getWeather', JSON.stringify({}));
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) {
            ...
            $.post('http://qpixel-phone/close', JSON.stringify({}));
        }
    }
    ...
    $(".phone-screen").on('click', '#wifi', function (e) {
        if (wifizone){
            if (enablePassword) {
                ...
                $.post('https://qpixel-phone/connectWifi', JSON.stringify({}));
            }
        }
    });
    setInterval(function () {
        ...
        if (actionButton !== undefined) {
            switch (actionButton) {
                case "home":
                    ...
                    $.post('https://qpixel-phone/refreshMySMS', JSON.stringify({status: false}));
                    $.post('https://qpixel-phone/closeTwat', JSON.stringify({}));
                    $.post('https://qpixel-phone/checkNotify', JSON.stringify({}));
        ...
        if (action !== undefined) {
            switch (action) {
                case "yellow-pages-delete":
                    $.post('http://qpixel-phone/deleteYP', JSON.stringify({}));
                    break;
                case "racing-create":
                ...
                case "newPostSubmit":
                    e.preventDefault();
                    $.post('http://qpixel-phone/newPostSubmit', JSON.stringify({
                    ...
                    break;
                case "group-manage":
                    $.post('http://qpixel-phone/manageGroup', JSON.stringify({ GroupID: $(this).data('action-data') }));
                    break;
                case "btnTaskGang":
                    manageGroup = $(this).data('action-data');
                    $.post('http://qpixel-phone/btnTaskGang', JSON.stringify({}));
                    break;
                ...
                case "getCallHistory":
                    if (callStates[currentCallState] === "isCallInProgress" && currentContainer !== "incoming-call")
                        ...
                        if (!isBurnah) {
                            $.post('http://qpixel-phone/' + action, JSON.stringify({}));
                        } else if (isBurnah) {
                            $.post('http://qpixel-phone/getRecentCallsByCid', JSON.stringify({
                                cid: burnahCid
                            }));
                        }
                    break;
                ...
                case "doj-app":
                    ...
                    $.post('https://qpixel-phone/getActiveDOJ', JSON.stringify({}))
                    break;
                case "camera-app":
                    $(".camera-inside").empty();
                    openContainer('camera')
                    $.post('https://qpixel-phone/getCurrentCameras', JSON.stringify({}))
                    break;
                case "lsbn":
                    openContainer('lsbn');
                    break;
                ...
                case "btnBankBusters":
                    ...
                    $.post('https://qpixel-phone/getCurrentBanks', JSON.stringify({}))
                    setTimeout(() => {
                        $.post('https://qpixel-phone/inBankBusterGroup', JSON.stringify({}))
                    }, 1500)
//                    $.post('https://qpixel-phone/getCurrentBanks', JSON.stringify({}))
                 //   $.post('https://qpixel-phone/sendNotifAlert', JSON.stringify({
                 //       type: "alert"
                 //   }))
                    break;
                case "documents":
                    ...
                    $.post('https://qpixel-phone/getDocuments', JSON.stringify({
                        pType: txt
                    }))
                    break;
                case "diamond":
                    ...
                    $.post('https://qpixel-phone/getDiamondSportsEvents', JSON.stringify({}))
                    break;
                default:
                    $.post('http://qpixel-phone/' + action, JSON.stringify({}));
                    break;
    ...
    $(".document-submit-cid").click(function (e) {
        ...
        setTimeout(() => {
            ...
            $.post('https://qpixel-phone/shareDocumentPermanent', JSON.stringify({
                documentID: pDocID,
                targetCID: ptCID
            }))        
        })
    ...
    $('.btn-share-local').click(function() {
        ...
        setTimeout(() => {
            let pDocID = document.getElementById("document-id").value;
            $.post('https://qpixel-phone/shareDocumentLocal', JSON.stringify({
                documentID: pDocID,
            }))        
        })
    })
    ...
    $('.btn-drop-qr-code').click(function() {
        ...
        setTimeout(() => {
            let pDocID = document.getElementById("document-id").value;
            $.post('https://qpixel-phone/dropQRCode', JSON.stringify({
                documentID: pDocID,
            }))        
        })
    })
    ...
    $('.btn-delete-document').click(function(){
        ...
        setTimeout(() => {
            ...
            $.post('https://qpixel-phone/deleteDocument', JSON.stringify({
...
function createDiamond(events, isEmployed) {
    $.each(events, function (__, event) {
        ...
        $('#delete-diamondEvent').click(function(){
            ...
            $.post('http://qpixel-phone/deleteDiamondEvent', JSON.stringify({
...
function createDOJDepartments(doj) {
    $.each(doj, function (__, dojs) {
        ...
        $('.dojAction-div').click(function () {
            ...
            $.post('http://qpixel-phone/callContact', JSON.stringify({
                name: '',
                number: number
            }));
        })
    ...
    window.addEventListener('message', function (event) {
        ...
        if (item.openPhone === true) {
            ...
            $.post('http://qpixel-phone/checkModel', JSON.stringify({}));

            $.post('http://qpixel-phone/retreivePhoneContacts', JSON.stringify({}));
...
//                $(".send-message").show();
        ...
        switch (item.openSection) {
            ...
            case "messageRead":
                ...
                $.post('https://qpixel-phone/refreshMySMS', JSON.stringify({status: true}));
            ...
            case "racing:hud:update":
                switch (item.hudState) {
                    ...
                    case "finished":
                        ...
                        drawRaceStats();
                        $.post('http://qpixel-phone/race:completed', JSON.stringify({
...
function burnahMessages() {
    $.post('https://qpixel-phone/burnahMessages', JSON.stringify({
        cid: burnahCid
    }))
}
...
$('.btn-racing-clear').click(function() {
    $.post('http://qpixel-phone/racing:map:removeBlips', JSON.stringify({}));
});
...
$('.racing-entries').on('click', '.racing-entries-join', function () {
    $.post('http://qpixel-phone/racing:event:join', JSON.stringify({ identifier: $(this).data('id') }));
});
...
function gpsJobCenter(data) {
    $.post(
      'https://qpixel-phone/jobcenter-setgps',
...
">${moment.utc(emails[email].time).local().fromNow()}
    ...
    $.post('http://qpixel-phone/emailReads', JSON.stringify({}));
}
...
$('.diamondsports-createevent').on('click', '#submit-input', function(){ 
    ...
    $.post('http://qpixel-phone/submitNewEventDiamondSports', JSON.stringify({
...
function openBrowser(url) {
    ...
    $.post('http://qpixel-phone/btnCamera', JSON.stringify({}));
    $("#browser").fadeIn(300);
}
...
function purchaseDarkMarket(data) {
    itemamount = 1
    $.post("https://qpixel-phone/purchase-darkMarket", JSON.stringify({item:data,itemamount}))
}
function trackvehicle(vehplate) {
    // console.log("VEH PLATE",vehplate)
    $.post("https://qpixel-phone/vehtrack", JSON.stringify({vehplate}))
}

function spawnVehicle(vehplate) {
    // console.log("VEH PLATE",vehplate)
    $.post("https://qpixel-phone/vehspawn", JSON.stringify({vehplate}))
}
...
$('.sellingvehicle').on('click', '#submit-input', function(){
    ...
    complateInput();
    setTimeout(() => {
        $.post("https://qpixel-phone/sellVeh", JSON.stringify({
            plate: vplate,
            paypal: paypal,
            amount: amount
        }))
...
$("#selfieclose").click(function () {
    $('.selfieBox').hide();
    $.post('http://qpixel-phone/closeSelfi', JSON.stringify({}));
})

$("#settings").click(function () {

  $.post('http://qpixel-phone/openSettings', JSON.stringify({}));
})
...
$('#submit-input-the-pm').on('click', function() {
    ...
    setTimeout(() => {
        $('#the-pm-input').val("")
        $.post("https://qpixel-phone/sendThePM", JSON.stringify({
            thePM: misinput
        }))
    }, 1900)
})
...
$("#contact-submit-input").click(function (e) {
    ...
    setTimeout(() => {
        ...
        $.post('http://qpixel-phone/newContactSubmit', JSON.stringify({
            name: clean,
...
$(document).ready(function () {
    ...
    $('.send-ping').click(function () {
        ...
        // $.post('http://qpixel-phone/btnCamera', JSON.stringify({}));
        $.post('http://qpixel-phone/qpixel-ui:pingSend', JSON.stringify({
            number: targetId
        }));
        $('.send-value').val('');
    });
...
function updateSettings()
{
    switch (currentSettingWindow) {
        case "tokovoip":
            ...
            break;
        case "control":
            $.post('http://qpixel-phone/settingsUpdateToko', JSON.stringify({tag: "controlUpdate", controls: currentBinds}));
            break;
        case "browser":
            break;
        default:
...
function ResetSettings()
{
    switch (currentSettingWindow) {
        case "tokovoip":
            $.post('http://qpixel-phone/settingsResetToko', JSON.stringify());
            break;
        case "control":
            $.post('http://qpixel-phone/settingsResetControls', JSON.stringify());
            break;
        case "browser":
            break;
        default:
...
async function updateTokoSettings()
{
    ...
    await delayedLog();
    $.post('http://qpixel-phone/settingsUpdateToko', JSON.stringify({
        tag: "settings",
...
$("#real-estate-sell-form").submit(function (e) {
    e.preventDefault();
    $.post('http://qpixel-phone/btnAttemptHouseSale', JSON.stringify({
...
$('#real-estate-transfer-form').submit(function (e) {
    e.preventDefault();
    $.post('http://qpixel-phone/btnTransferHouse', JSON.stringify({
...
$("#group-manage-pay-form").submit(function (e) {
    ...
    $.post('http://qpixel-phone/payGroup', JSON.stringify({
...
$("#group-manage-rank-form").submit(function (e) {
    e.preventDefault();
    $.post('http://qpixel-phone/promoteGroup', JSON.stringify({
        gangid: escapeHtml($(".group-manage-company-name").data('group-id')),
...
$("#group-manage-bank-form").submit(function (e) {
    ...
    $.post('http://qpixel-phone/bankGroup', JSON.stringify({
        gangid: escapeHtml($(".group-manage-company-name").data('group-id')),
...
$("#group-tasks-assign-modal-form").submit(function (e) {
    ...
    $.post('http://qpixel-phone/btnGiveTaskToPlayer', JSON.stringify({
...
$("#contacts-edit-submit").click(function (e) {
    ...
    $.post('http://qpixel-phone/editContactSubmit', JSON.stringify({
        name: clean,
    ...
    setTimeout(() => {
        $.post('http://qpixel-phone/refreshContacts', JSON.stringify({}));
    }, 2000);
...
$("#wallpaper-form").submit(function (e) {
    ...
    $.post('http://qpixel-phone/updateMyWallpaper', JSON.stringify({
        name: escapedName,
    }));
...
$("#stock-form").submit(function (event) {
    event.preventDefault();
    $.post('https://qpixel-phone/stocksTradeToPlayer', JSON.stringify({
...
$('#stock-transfer').click(function(){
    ...
    complateInput()
    setTimeout(() => {
        $.post('https://qpixel-phone/exchangeCrypto', JSON.stringify({
...
$('#stock-submit').click(function(){
    ...
    complateInput()
    setTimeout(() => {
        $.post('https://qpixel-phone/buyCrypto', JSON.stringify({
            stockID: escapeHtml(stockID),
            amount: escapeHtml(amount),
        }));
    }, 1000);
...
$(".submit-bg").click(function (event){
    if ($('#bg-set-body').val() == '') {
        ...
        $.post('http://qpixel-phone/submitBg', JSON.stringify({
            bg: bg
        }));
...
$('#message-submit').click(function (event){
    ...
    $.post('http://qpixel-phone/newMessageSubmit', JSON.stringify({
    ...
    switch (currentContainer) {
        case "message":
            setTimeout(function () {
                ...
                $.post('http://qpixel-phone/messageRead', JSON.stringify({ sender: sender, receiver: receiver, displayName: displayName }));
            }, 300);
            break;
        case "messages":
            console.log('5543')
            ...
            setTimeout(function () {
                if (!isBurnah) {
                    $.post('http://qpixel-phone/messages', JSON.stringify({}));     
                } else if (isBurnah) {
                    $.post('http://qpixel-phone/getTextsByCid', JSON.stringify({
                        cid: burnahCid
                    }))
                }
            }, 300);
...
$('#real-estate-evict-modal-accept').click(function () {
    $.post('http://qpixel-phone/btnEvictHouse', JSON.stringify({}));
...
$('#racing-create-form').on('reset', function (e) {
    $.post('http://qpixel-phone/racing:map:cancel', JSON.stringify({}));
});
...
$('#racing-start-tracks').on('change', function (e) {
    ...
    if(maps[selectedMap] !== undefined) {
        $.post('http://qpixel-phone/racing:map:removeBlips', JSON.stringify({}));
        $.post('http://qpixel-phone/racing:map:load', JSON.stringify({ id: selectedMap}));
...
//     $.post('http://qpixel-phone/racing:event:start', JSON.stringify({
...
$('#racing-create-form').submit(function (e) {
    e.preventDefault();
    $.post('http://qpixel-phone/racing:map:save', JSON.stringify({
...
$('.racing-map-delete-confirm').click(function () {  
    ...
    $.post('http://qpixel-phone/racing:map:delete', JSON.stringify({ id: raceMap }));
    $('.racing-delete-confirm').fadeOut(150)
...
$("#phone-submit-number").click(function () {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            $.post("https://qpixel-phone/getCallHistory", JSON.stringify({}))
        }, 300)
    }, 900)
})
...
$('.twatter-toggle-notification').click(function () {
    ...
    $.post('http://qpixel-phone/btnNotifyToggle', JSON.stringify({}));
});



$('.account-information-toggle-pager').click(function () {
    $.post('http://qpixel-phone/btnPagerToggle', JSON.stringify({}));
...
function clickImage(img) {
    $('.selfieBox').click(function(){
        copyToClipboard(img);
        $.post('http://qpixel-phone/closeSelfieBox', JSON.stringify({}));
    });
}

$('.keys-entries').on('click', '.manage-keys', function () {
    $.post('http://qpixel-phone/retrieveHouseKeys', JSON.stringify({}));
});

$('.keys-entries').on('click', '.remove-shared-key', function(e) {
    $.post('http://qpixel-phone/removeSharedKey', JSON.stringify({
...
$('.manage-keys-entries').on('click', '.manage-keys-remove', function () {
    $.post('http://qpixel-phone/removeHouseKey', JSON.stringify({
...
$('.group-manage-entries').on('click', '.group-manage-fire', function () {
    ...
    $.post('http://qpixel-phone/qpixel-phone:fireEmp', JSON.stringify({ id: $(this).data('id'), group: $(this).data('group'), name: $(this).data('name') }));
});

$('.group-tasks-entries').on('click', '.group-tasks-track', function () {
    $.post('http://qpixel-phone/trackTaskLocation', JSON.stringify({ TaskIdentifier: $(this).data('id') }));
});

$('.delivery-job-entries').on('click', '.delivery-job-accept', function (e) {
    $.post('http://qpixel-phone/selectedJob', JSON.stringify({ jobType: $(this).data('job-type'), jobId: $(this).data('job-id') }));
});
...
$('.garage-entries').on('click', '.garage-spawn', function (e) {
    e.preventDefault();
    $.post('http://qpixel-phone/vehspawn', JSON.stringify({ vehplate: $(this).data('plate') }));
    $.post('http://qpixel-phone/btnGarage', JSON.stringify({}));
});

$('.garage-entries').on('click', '.garage-track', function () {
    $.post('http://qpixel-phone/vehtrack', JSON.stringify({ vehplate: $(this).data('plate') }));
});

$('.garage-entries').on('click', '.garage-pay', function (e) {
    $.post('http://qpixel-phone/vehiclePay', JSON.stringify({ vehiclePlate: $(this).data('plate') }));
    setTimeout(function () {
        $.post('http://qpixel-phone/btnGarage', JSON.stringify({}));
    }, 1500);
});
...
$('.gps-entries, .keys-entries').on('click', '.gps-location-click', function () {
    $.post('http://qpixel-phone/loadUserGPS', JSON.stringify({ house_id: $(this).data('house-id'), house_type: $(this).data('house-type') }));
})

$('.jss1481, .calls-container').on('click', '.btn-contacts-call', function () {
    $.post('http://qpixel-phone/callContact', JSON.stringify({ name: $(this).data('name'), number: $(this).data('number') }));
...
$('#contacts-delete-submit').click(function (event) {
    ...
    complateInputQuick();
    setTimeout(() => {
        $.post('http://qpixel-phone/removeContact', JSON.stringify({ name: $(this).data('name'), number: $(this).data('number') }));
    }, 1500)
});
...
$('.delete-yp').click(function (event) {
    ...
    setTimeout(() => {
        ...
        $('#youradhere').hide();
        hasPostedYP = false;
        $.post('http://qpixel-phone/deleteYP', JSON.stringify({ name: $(this).data('name'), number: $(this).data('number') }));
    }, 1500)
});
...
$("#h-check").click(function () {
    ...
    $.post('http://qpixel-phone/checkHouse', JSON.stringify({}))
})

$("#edit-h").click(function () {
    // console.log("CHECK PROPERTY")
    // $.post('http://qpixel-phone/editHouse', JSON.stringify({}))
    //noPropty()
})

$("#sell-h").click(function () {
    // console.log("CHECK PROPERTY")
    $.post('http://qpixel-phone/sellsHouse', JSON.stringify({}))
})
...
$('.h-found').on('click', '.h-found-purchase', function (event) {
    ...
    complateInput();
    $('#twat-modal').modal('close');
    $.post('http://qpixel-phone/purchaseHouse', JSON.stringify({
...
$('.sell-house-own').on('click', '.confirm-sellHouse', function (event) {
    ...
    $.post('http://qpixel-phone/sellOwnHouse', JSON.stringify({
        hid: $('#h-p-id').val()
    }))
})
...
$('#submit-h-price').click(function(){
    ...
    $.post('http://qpixel-phone/editHousePrice', JSON.stringify({
        hid: hid,
        price: price
    }))
    $('.housing-edit-price').css('display', 'none');
...
function closePhoneShell() {
    ...
    $.post('https://qpixel-phone/refreshMySMS', JSON.stringify({ status: false }))
    $.post('http://qpixel-phone/closeTwat')
    $('#twat-modal').modal('close')
    $('#contacts-container').css('display', 'none')
    $('#contacts-container').css('display', 'none')
    $('#calculator-container').css('display', 'none')
...
$('.phone-selfie').click(function(){
    $.post('http://qpixel-phone/phone:selfie', JSON.stringify({}));
    closePhoneShell()
})
...
$(document).on('click', '#twat-sendimg', function (e) {
    ...
    $.post('http://qpixel-phone/phone:selfie', JSON.stringify({}));
    e.preventDefault();
    $.post('http://qpixel-phone/PostNewImage', JSON.stringify({}),
        function (url) {
...
//                 $.post('http://qpixel-phone/btnAnswer', JSON.stringify({}));
//             }
//         });
...
//                             setTimeout(() => {
//                                 Notif.addClass('notification-container-fade-out')
//                                 $.post('http://qpixel-phone/btnHangup', JSON.stringify({}));
//                             }, 1000)
//                         }, 200)
//                     }
//                     // Notif.addClass('notification-container-fade-out')
...
//             }
//             Notif.addClass('notification-container-fade-out')
//             $.post('http://qpixel-phone/pingEnded', JSON.stringify({}));
//             setTimeout(() => {
//                 Notif.remove()
//                 var count = 0
...
//             $.post('http://qpixel-phone/qpixel-ui:pingAccept', JSON.stringify({}));
//             const Notif = $(".notification-container").filter(`[data-id="${Id}-ping"]`)
//                 if (Notif) {
//                     var count = 0
...
//             activePing = false
//             $.post('http://qpixel-phone/qpixel-ui:pingReject', JSON.stringify({}));
//             const Notif = $(".notification-container").filter(`[data-id="${Id}-ping"]`)
//                 if (Notif) {
//                     var count = 0
...
$(".house-entries, .access-house-entries").on('click', '.h-setgps', function (e) {
    ...
    $.post('http://qpixel-phone/sethGps', JSON.stringify({hid: overid}));
})
...
$(".house-key-entries").on('click', '.h-removeKey', function (e) {
    ...
    $.post('http://qpixel-phone/whatthefuckdoesthisshitwork', JSON.stringify({cid: overid, hid: overid2}));
})
//a-signin
...
$('.a-signin').click(function(){
    if (cuunt <= 0) {
     ...
     $.post('http://qpixel-phone/abdulSignIn', JSON.stringify({status: taxiOn}));
 })
...
$(".house-entries, .access-house-entries").on('click', '.h-unlock', function (e) {
    ...
    $.post('http://qpixel-phone/unlockHouses', JSON.stringify({hid: overid, penisfuck: hstatus}));
 })
 ...
 $(".house-entries").on('click', '.h-edit-s', function (e) {
    ...
    $("#house-keys").hide();
    $("#house-2").hide();
    $.post('http://qpixel-phone/editHousingOwn', JSON.stringify({}));
 })
 ...
 $(".house-entries").on('click', '.h-access-keys', function (e) {
    ...
    $("#house-2").hide();
    $('.access-house-entries').css('display', 'none');
    $.post('http://qpixel-phone/btnKeyHolders', JSON.stringify({
        hid: overid
    }));
 ...
 $('.h-leaveedit').click(function(){
    editingHouse = false;
    $.post('http://qpixel-phone/leaveEditMode', JSON.stringify({}))
    $("#house-2").show();
    $("#house-3").hide();
    $("#house-keys").hide();
    $(".btn-2").show();
 ...
 $('.h-openfurniture').click(function(){
    $.post('http://qpixel-phone/openFurnitureUI', JSON.stringify({}))
 })

 $('.h-setbackdoor').click(function(){
    $.post('http://qpixel-phone/setBackdoorUI', JSON.stringify({}))
 })

 $('.h-setwardrobe').click(function(){
    $.post('http://qpixel-phone/setWardrobeUI', JSON.stringify({}))
 })

 $('.h-setcrafting').click(function(){
    $.post('http://qpixel-phone/setCraftingUI', JSON.stringify({}))
 })

 $('.h-setgarage').click(function(){
    $.post('http://qpixel-phone/setGarageUI', JSON.stringify({}))
 })

 $('.h-setstash').click(function(){
    $.post('http://qpixel-phone/setStashUI', JSON.stringify({}))
 })
 ...
 $('.submit-h-acess').click(function(){
    ...
    $('.phone-acces-house').hide()
    $.post('http://qpixel-phone/giveAccess', JSON.stringify({
        hid: hid,
        cid: cid
    }));
})
    ...
    $(document).ready(function () {
        $('.submit-settings').click(function(){
            ...
            $('.settings').hide()
                ...
                complateInput();
                $.post('http://qpixel-phone/submitSettings', JSON.stringify({
                    bg: bg,
                    model: model,
                    twat: twat,
                    call: call
