...
RegisterNUICallback('wenmoSubmit', function(data)
    ...
    TriggerServerEvent('qpixel-phone:transferWenmo',num,amount,comment)
end)

RegisterNUICallback("qpixel-phone:getWenmo", function(data, cb)
    local success, message = RPC.execute("qpixel-phone:getWenmo")
    local wenmo = {}
