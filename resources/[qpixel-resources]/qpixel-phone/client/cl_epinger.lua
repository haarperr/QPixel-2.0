...
RegisterNUICallback("qpixel-ui:pingSend", function(data, cb)
...
RegisterNUICallback("qpixel-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("qpixel-ui:pingReject", function(data, cb)
