...
RegisterNUICallback("qpixel-healthcare:handler", function(data, cb)
  ...
  local location = string.match(currentPrompt, "(.-)_")
	...
	elseif eventData == EVENTS.CLOTHING then
		TriggerEvent("qpixel-clothing:openClothing", true, true, false)
		exports["qpixel-interface"]:hideContextMenu()
	elseif eventData == EVENTS.SWITCHER then
		TriggerServerEvent('qpixel-base:ResetPlayerInfo')
		Citizen.Wait(1000)
		...
		menuData = {
			{
				...
				action = "qpixel-healthcare:handler",
				key = EVENTS.LOCKERS
			},
			{
				title = "Clothing",
		...
		while listening do
			if IsControlJustReleased(0, 38) then
				...
				elseif pZone == "pillbox_checkin" or pZone == "viceroy_checkin" then
                    ...
                    local finished = exports["qpixel-taskbar"]:taskBar(1500,string, false, true, false, false, nil, 5.0, PlayerPedId())
                    if finished == 100 then
							if pDoctors then
								TriggerEvent("DoLongHudText","A doctor has been paged. Please take a seat and wait.",2)
								TriggerEvent("qpixel-jobs:EMS:doctorpaged", hospital)
							else
...
RegisterNetEvent("qpixel-healthcare:yoga")
AddEventHandler("qpixel-healthcare:yoga", function(pArgs, pEntity, pContext)
	local waitTime = 0
	Wait(200)
	...
	until waitTime == 100 do
		...
		TriggerEvent("qpixel-hud:updateStress", false, math.random(2,10))	
	end
end)
...
CreateThread(function()
	-- Checkin, pillbox
	exports["qpixel-polyzone"]:AddCircleZone("pillbox_checkin", vector3(306.9, -595.03, 43.28), 0.7, {
		useZ=true,
	})

	exports["qpixel-polyzone"]:AddCircleZone("viceroy_checkin", vector3(-817.44, -1236.69, 7.34), 0.7, {
		useZ=true,
	})
	-- Armory, pillbox
	exports["qpixel-polyzone"]:AddCircleZone("hospital_armory", vector3(306.28, -601.58, 43.28), 0.7, {
		useZ=true,
	})

	exports["qpixel-polyzone"]:AddCircleZone("hospital_armory", vector3(-820.22, -1242.72, 7.34), 0.7, {
		useZ=true,
	})

	-- Clothing / Personal Lockers, Staff room, pillbox
	exports["qpixel-polyzone"]:AddBoxZone("hospital_clothing_lockers_staff", vector3(300.28, -598.83, 43.28), 3.2, 4.2, {
		heading=340,
		minZ=42.28,
		maxZ=45.68
	})

	exports["qpixel-polyzone"]:AddBoxZone("hospital_clothing_lockers_staff", vector3(-824.44, -1237.3, 7.34), 5.0, 3.8, {
		heading=320,
		minZ=6.34,
		maxZ=9.34
	})
	-- Character Switcher, Staff room, pillbox
	exports["qpixel-polyzone"]:AddBoxZone("hospital_character_switcher_staff", vector3(296.16, -598.31, 43.28), 2.4, 1.2, {
		heading=250,
		minZ=42.28,
		maxZ=45.68
	})

	exports["qpixel-polyzone"]:AddBoxZone("hospital_character_switcher_staff", vector3(-828.56, -1236.19, 7.38), 1.6, 2.4, {
		heading=321,
		minZ=6.38,
		maxZ=9.18
	})
	-- Character Switcher, Backroom pillbox
	exports["qpixel-polyzone"]:AddBoxZone("pillbox_character_switcher_backroom", vector3(340.82, -596.46, 43.28), 2.4, 1.2, {
		heading=160,
		minZ=42.28,
		maxZ=45.68
	})
	-- Character Switcher, Morgue
	exports["qpixel-polyzone"]:AddBoxZone("morgue_character_switcher_backroom", vector3(296.61, -1352.36, 24.53), 1.8, 2.0, {
		heading=50,
		minZ=23.53,
		maxZ=26.53
	})
	-- Character Switcher, Parsons
	exports["qpixel-polyzone"]:AddBoxZone("parsons_character_switcher_backroom", vector3(-1501.62, 857.45, 181.59), 1.8, 2.0, {
		heading=25,
		minZ=180.59,
		maxZ=184.59
	})
	-- Character Switcher, Infirmirary
	exports["qpixel-polyzone"]:AddBoxZone("infirm_char_switcher_backroom", vector3(1771.78, 2509.0, 45.83), 1.0, 1.6, {
		heading=301,
		minZ=44.88,
		maxZ=47.68
	})
