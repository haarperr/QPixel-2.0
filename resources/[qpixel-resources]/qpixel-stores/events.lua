...
RegisterNetEvent("qpixel-stores:PedLoop", function(ped, spawn, store)
...
RegisterNetEvent('qpixel-inventory:general', function()
    TriggerEvent('OpenInventory', 'store', "general")
end)

RegisterNetEvent('qpixel-inventory:vendingMachine', function(pParams, pEntity, pContext)
    TriggerEvent("OpenInventory", 'store', "vending")
end)

RegisterNetEvent('qpixel-inventory:weap', function()
    if exports["qpixel-license"]:HasLicense("weapons") then
        if exports["qpixel-license"]:GetLicensePoints("weapons") < 30 then
...
RegisterNetEvent('qpixel-inventory:hunting', function()
    TriggerEvent('OpenInventory', 'store', "hunting")
end)

RegisterNetEvent('qpixel-inventory:mall', function()
    TriggerEvent("OpenInventory", 'store', "mall")
end)

RegisterNetEvent('qpixel-inventory:youtool', function()
    TriggerEvent("OpenInventory", 'store', "youtool")
end)

RegisterNetEvent('qpixel-inventory:pdlocker', function()
    TriggerEvent("OpenInventory", 'store', "cop")
end)

RegisterNetEvent('qpixel-inventory:doclocker', function()
    TriggerEvent("OpenInventory", 'store', "doc")
end)

RegisterNetEvent('qpixel-inventory:emslocker', function()
    TriggerEvent("OpenInventory", 'store', "ems")
end)

RegisterNetEvent('qpixel-inventory:bar', function()
