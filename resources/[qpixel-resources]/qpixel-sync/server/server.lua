...
RegisterServerEvent("qpixel-sync:executeSyncNative")
AddEventHandler("qpixel-sync:executeSyncNative", function(native, netEntity, options, args)
    TriggerClientEvent("qpixel-sync:clientExecuteSyncNative", -1, native, netEntity, options, args)
end)