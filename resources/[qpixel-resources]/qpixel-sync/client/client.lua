...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("qpixel-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("qpixel-sync:clientExecuteSyncNative")
AddEventHandler("qpixel-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
