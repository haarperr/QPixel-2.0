...
AddEventHandler("mech:tools", function(material, amount)
    ...
    if exports["qpixel-inventory"]:hasEnoughOfItem(material, amount,false) then
...
AddEventHandler("mech:tools:cl2", function(input, input2)
    local isEmployedTuner = exports["qpixel-business"]:IsEmployedAt("tuner_shop")
    local isEmployedHayes = exports["qpixel-business"]:IsEmployedAt("hayes_autos")
    local isEmployedOttos = exports["qpixel-business"]:IsEmployedAt("ottos_autos")
    local isEmployedHarmony = exports["qpixel-business"]:IsEmployedAt("harmony_repairs")
    ...
    if isEmployedTuner or isEmployedHayes or isEmployedOttos or isEmployedHarmony then
        if tuner_internalz or hayes_internalz or ottos_internalz or harmony_internalz  then
            ...
            if amount <= 10 then
                ...
                if exports['qpixel-inventory']:hasEnoughOfItem(itemname, amount) then
                    ...
                    local finished = exports["qpixel-taskbar"]:taskBar(5000, "Repairing...")
    ...
    if isEmployedTuner or isEmployedHayes or isEmployedOttos or isEmployedHarmony then
        if tuner_internalz or hayes_internalz or ottos_internalz or harmony_internalz  then
            exports['qpixel-interface']:openApplication('textbox', {
                callbackUrl = 'qpixel-vehicles:repair:part',
                key = 1,
                items = {
                    {
                        icon = "toolbox",
...
RegisterInterfaceCallback('qpixel-vehicles:repair:part', function(data, cb)
...
Citizen.CreateThread(function()
    -- Tuner --
    exports["qpixel-polyzone"]:AddBoxZone("tuner_shop_zone", vector3(138.56, -3033.86, 7.03), 30, 30, {
    ...
    exports["qpixel-polyzone"]:AddBoxZone("hayes_autos_zone", vector3(-1419.09, -446.42, 35.9), 15, 23.2, {
    ...
    exports["qpixel-polyzone"]:AddBoxZone("ottos_autos_zone", vector3(829.81, -813.39, 26.33), 15, 20.0, {
    ...
    exports["qpixel-polyzone"]:AddBoxZone("harmony_repairs_zone", vector3(1177.6, 2639.84, 37.75), 10, 13.0, {
