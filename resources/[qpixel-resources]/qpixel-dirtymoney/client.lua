...
RegisterNetEvent("qpixel-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("qpixel-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("qpixel-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("qpixel-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('qpixel-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("qpixel-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("qpixel-dirtymoney:alterDirtyMoney","ItemDrop",amount)
