  ...
  officer_sign_in = {
    {
      ...
      key = "police",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "police" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } }
      }
    },
    {
      title = "DOC",
      ...
      key = "doc",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "doc" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } }
      }
    }
  },
  ems_sign_in = {
    {
      ...
      key = "ems",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "ems" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } },
      }
    },
    {
      ...
      key = "doctor",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "doctor" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } },
      }
    },
    {
      ...
      key = "therapist",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "therapist" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } },
      }
    }
  },
  ems_volunteer_sign_in = {
    {
      ...
      children = {
          ...
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } },
          {
            ...
            children = {
              { title = "Ambulance", action = "qpixel-signin:spawnVehicle", key = VOLUNTEER_VEHICLES.STANDARD },
            }
         },
      }
    }
  ...
  fire_dept_sign_in = {
    {
      ...
      children = {
          ...
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } },
          {
            ...
            children = {
              { title = "Firetruck", action = "qpixel-signin:spawnVehicle", key = VOLUNTEER_VEHICLES.FIRETRUCK },
            }
         },
      }
    }
  ...
  phone_doj_sign_in = {
    {
      ...
      key = "lawyer",
      children = {
          { title = "Sign In", action = "qpixel-phone:signInHandler", key = { sign_in = true, job = "lawyer" } },
          { title = "Sign Out", action = "qpixel-phone:signInHandler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "public_defender",
      children = {
          { title = "Sign In", action = "qpixel-phone:signInHandler", key = { sign_in = true, job = "public_defender" } },
          { title = "Sign Out", action = "qpixel-phone:signInHandler", key = { sign_off = true } }
      }
    },
    {
      ...
      children = {
          { title = "Sign In", action = "qpixel-phone:signInHandler", key = { sign_in = true, job = "district_attorney" } },
          { title = "Sign Out", action = "qpixel-phone:signInHandler", key = { sign_off = true } }
      }
    },
  },
  ...
  public_services_sign_in = {
    {
      ...
      key = "mayor",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "mayor" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "deputy_mayor",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "deputy_mayor" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "county_clerk",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "county_clerk" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "judge",
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "judge" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      key = "defender",
      children = {
        { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "defender" } },
        { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } }
      }
    },
    {
      ...
      children = {
        { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "district attorney" } },
        { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } }
      }
    }
  },
  driving_instructor_sign_in = {
    {
      ...
      children = {
          { title = "Sign In", action = "qpixel-signin:handler", key = { sign_in = true, job = "driving instructor" } },
          { title = "Sign Out", action = "qpixel-signin:handler", key = { sign_off = true } },
      }
    }
  }
