...
RegisterServerEvent("qpixel-signin:duty")
AddEventHandler("qpixel-signin:duty", function(pJobType, pSrc)
...
RegisterServerEvent("qpixel-signoff:duty")
AddEventHandler("qpixel-signoff:duty", function(job)
	local src = source
    if job == 'police' then
