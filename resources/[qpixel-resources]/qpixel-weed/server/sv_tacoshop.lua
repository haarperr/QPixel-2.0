...
RPC.register("qpixel-weed:currentlyProcessing", function(pSource)
    return IsWeedProcessing
end)    

RPC.register("qpixel-weed:readyForPickup", function(pSource)
    return IsWeedProcessingFinished
end)    

RPC.register("qpixel-weed:collectpackage", function(pSource)
    TriggerClientEvent("player:receiveItem", -1, "weedpackage", 1)
    return true
end)    

RPC.register("qpixel-weed:deliverpackage", function(pSource)
...
RPC.register("qpixel-weed:processWeed", function(pSource)
...
RPC.register("qpixel-weed:buyDelivery", function(pSource)
    local user = exports["qpixel-base"]:getModule("Player"):GetUser(pSource)
