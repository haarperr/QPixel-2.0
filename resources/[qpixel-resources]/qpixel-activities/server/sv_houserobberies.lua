...
Citizen.CreateThread(function()
	...
	RPC.register('qpixel-houserobbery:enter_property', function(source, ...)
		local cb = {x,y,z,num}
		return cb
	end)	
...
RegisterServerEvent('qpixel-activities:givePayout')
AddEventHandler('qpixel-activities:givePayout', function(amount, pType, text)
    local src = source
