...
RegisterNetEvent('qpixel-rpc:cl_request')
AddEventHandler('qpixel-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('qpixel-rpc:cl_response', src, origin, callId, response)
end)