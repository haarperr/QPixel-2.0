...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('qpixel-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('qpixel-rpc:cl_response')
AddEventHandler('qpixel-rpc:cl_response', function(origin, callId, response)
