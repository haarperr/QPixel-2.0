...
function SetEngineSound(pVehicle)
    local sound = exports['qpixel-vehicles']:GetVehicleAfterMarket(pVehicle, 'engineSound')
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('qpixel-vehicleSync:updateSyncState', netId, syncState)
    end)
end
...
RegisterNetEvent('qpixel-vehicleSync:updateSyncState')
AddEventHandler('qpixel-vehicleSync:updateSyncState', function(pNetId, pSyncState)
...
RegisterNetEvent('qpixel-vehicles:spawnedGarageVehicle')
AddEventHandler('qpixel-vehicles:spawnedGarageVehicle', function(pNetId, pModel)
    Citizen.Wait(1000)
    ...
    local afterMarkets = exports['qpixel-vehicles']:GetVehicleAfterMarket(vehicle)
...
Citizen.CreateThread(function()
    exports["qpixel-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights", "-toggleNeonLights")
    exports["qpixel-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator", "-toggleRightIndicator")
    exports["qpixel-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator", "-toggleLeftIndicator")
    exports["qpixel-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights", "-toggleHazardLights")
end)