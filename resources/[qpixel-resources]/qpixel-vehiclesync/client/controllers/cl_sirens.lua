...
function RequestSirenStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('qpixel-vehicleSync:updateSirenState', netId, sirenState, sirenPreset)
    end)
end
...
RegisterNetEvent('qpixel-vehicleSync:updateSirenState')
AddEventHandler('qpixel-vehicleSync:updateSirenState', function(pNetId, pSirenState, pSirenPreset)
...
Citizen.CreateThread(function()
    exports["qpixel-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Lights", "+toggleSirenLights", "-toggleSirenLights", "Q")
    exports["qpixel-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Sound", "+toggleSiren", "-toggleSiren", "LMENU")
    exports["qpixel-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Cycle Sound", "+cycleSiren", "-cycleSiren", "R")
    exports["qpixel-keybinds"]:registerKeyMapping("", "Vehicle", "Siren AirHorn", "+sirenAirHorn", "-sirenAirHorn", "E")
end)