...
RegisterNetEvent('qpixel-paleto:box')
AddEventHandler('qpixel-paleto:box', function()
    ...
    if distance < 1.5 then
        if exports["qpixel-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
            ...
            PaletoStep1()
            exports["qpixel-dispatch"]:dispatchadd('10-90', "Paleto Bank Robbery", "108")
...
RegisterNetEvent('qpixel-paleto:startpaleto')
AddEventHandler('qpixel-paleto:startpaleto', function()
    local player = GetEntityCoords(PlayerPedId())
...
function OnHackSuccess()
    ...
    TriggerEvent("inventory:removeItem", "heistlaptop2", 1)
    TriggerServerEvent('qpixel-paleto:startCoolDown')
    loadDicts()
    ...
    TriggerServerEvent('qpixel-doors:change-lock-state', 45, false) 
    CreateMoney()
end

RegisterNetEvent('qpixel-paletogold')
AddEventHandler('qpixel-paletogold', function()
    print('called 2?')
    TriggerServerEvent('qpixel-paleto:tut_tut')
end)

AddEventHandler("qpixel-inventory:itemUsed", function(pItem)
    if pItem == "thermitecharge" then
        TriggerEvent('qpixel-paleto:box')
    elseif pItem == "heistlaptop2" then
        TriggerServerEvent("qpixel-paleto:hacklaptop")
    end
end)