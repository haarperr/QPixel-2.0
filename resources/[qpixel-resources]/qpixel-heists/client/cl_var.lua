RegisterNetEvent('qpixel-heists:door_thermite')
AddEventHandler('qpixel-heists:door_thermite', function()
    TriggerServerEvent('qpixel-heists:thermite_var')
end)

RegisterNetEvent('qpixel-heists:var_door_to_lobby')
AddEventHandler('qpixel-heists:var_door_to_lobby', function()
    local player = GetEntityCoords(PlayerPedId())
    local distance = #(vector3(-209.2301, -303.5382, 74.482246) - player)
    if distance < 1.5 then
        if exports["qpixel-inventory"]:hasEnoughOfItem("thermal_charge", 1) then
            TriggerEvent('qpixel-hud:show_hackerman')
            LobbyDoor()
            exports['qpixel-thermite']:OpenThermiteGame(function(success)
                if success then
                    TriggerServerEvent('qpixel-heists:var_thermite')
                    TriggerEvent('qpixel-hud:hide_hackerman')
                    TriggerEvent("inventory:removeItem", "thermal_charge", 1)
                    TriggerServerEvent('qpixel-doors:change-lock-state', 573, false) 
                    Citizen.Wait(3000)
...
exports["qpixel-polytarget"]:AddCircleZone("var_computer_1",  vector3(-212.7, -298.21, 74.49), 0.35, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_computer_1", {
    {
        event = "qpixel-heists:var_event_1",
        id = "var_computer_1",
        icon = "user-secret",
...
RegisterNetEvent('qpixel-heists:var_event_1')
AddEventHandler('qpixel-heists:var_event_1', function()
    TriggerServerEvent('qpixel-heists:in_var_1_srv')
end)

RegisterNetEvent('qpixel-heists:enter_var_location_1')
AddEventHandler('qpixel-heists:enter_var_location_1', function()
    if exports['qpixel-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
...
exports["qpixel-polytarget"]:AddCircleZone("var_computer_2",  vector3(-211.2, -301.14, 74.49), 0.45, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_computer_2", {
    {
        event = "qpixel-heists:var_event_2",
        id = "var_computer_2",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('qpixel-heists:var_event_2')
AddEventHandler('qpixel-heists:var_event_2', function()
    TriggerServerEvent('qpixel-heists:in_var_2_srv')
end)

RegisterNetEvent('qpixel-heists:enter_var_location_2')
AddEventHandler('qpixel-heists:enter_var_location_2', function()
    if exports['qpixel-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["qpixel-polytarget"]:AddCircleZone("var_computer_3",  vector3(-206.6, -297.19, 74.49), 0.45, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_computer_3", {
    {
        event = "qpixel-heists:var_event_3",
        id = "var_computer_3",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('qpixel-heists:var_event_3')
AddEventHandler('qpixel-heists:var_event_3', function()
    TriggerServerEvent('qpixel-heists:in_var_3_srv')
end)

RegisterNetEvent('qpixel-heists:enter_var_location_3')
AddEventHandler('qpixel-heists:enter_var_location_3', function()
    if exports['qpixel-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["qpixel-polytarget"]:AddCircleZone("var_computer_4",  vector3(-207.02, -294.14, 74.49), 0.5, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_computer_4", {
    {
        event = "qpixel-heists:var_event_4",
        id = "var_computer_4",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('qpixel-heists:var_event_4')
AddEventHandler('qpixel-heists:var_event_4', function()
    TriggerServerEvent('qpixel-heists:in_var_4_srv')
end)

RegisterNetEvent('qpixel-heists:enter_var_location_4')
AddEventHandler('qpixel-heists:enter_var_location_4', function()
    if exports['qpixel-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["qpixel-polytarget"]:AddCircleZone("var_computer_5",  vector3(-209.4, -293.28, 74.49), 0.4, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_computer_5", {
    {
        event = "qpixel-heists:var_event_5",
        id = "var_computer_5",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('qpixel-heists:var_event_5')
AddEventHandler('qpixel-heists:var_event_5', function()
    TriggerServerEvent('qpixel-heists:in_var_5_srv')
end)

RegisterNetEvent('qpixel-heists:enter_var_location_5')
AddEventHandler('qpixel-heists:enter_var_location_5', function()
    if exports['qpixel-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
AddEventHandler('varhack:1', function()
    exports['qpixel-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('qpixel-heists:hackfalse')
        else
...
TriggerServerEvent('qpixel-heists:hack1')
end)


exports["qpixel-polytarget"]:AddCircleZone("var_hack1",  vector3(2167.94, 2925.92, -81.38), 0.5, {
    useZ = true
})


exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_hack1", {
    {
...
AddEventHandler('varhack:2', function()
    exports['qpixel-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('qpixel-heists:hackfalse2')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail1')
          print("lol")
...
TriggerServerEvent('qpixel-heists:hack2')
end)

exports["qpixel-polytarget"]:AddCircleZone("var_hack2",  vector3(2135.66, 2901.72, -84.27), 0.53, {
    useZ = true
})


exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_hack2", {
    {
...
AddEventHandler('varhack:3', function()
    exports['qpixel-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('qpixel-heists:hackfalse3')
          print("working?")
        else
...
TriggerServerEvent('qpixel-heists:hack3')
end)

exports["qpixel-polytarget"]:AddCircleZone("var_hack3",  vector3(2171.24, 2927.76, -81.38), 0.41, {
    useZ = true
})


exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_hack3", {
    {
...
AddEventHandler('varhack:4', function()
    exports['qpixel-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped')
            TriggerServerEvent('qpixel-heists:hackfalse4')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail2')
          print("basarisiz")
...
TriggerServerEvent('qpixel-heists:hack4')
end)

exports["qpixel-polytarget"]:AddCircleZone("var_hack4",  vector3(2087.82, 2946.72, -84.22), 0.53, {
    useZ = true
})


exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_hack4", {
    {
...
AddEventHandler('varhack:5', function()
    exports['qpixel-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped2')
            TriggerServerEvent('qpixel-heists:hackfalse5')
          print("working?")
        else
...
TriggerServerEvent('qpixel-heists:hack5')
end)

exports["qpixel-polytarget"]:AddCircleZone("var_hack5",  vector3(2174.89, 2927.76, -81.38), 0.4, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_hack5", {
    {
...
AddEventHandler('varhack:6', function()
    exports['qpixel-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('qpixel-heists:hackfalse6')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail')
          print("basarisiz")
...
TriggerServerEvent('qpixel-heists:hack6')
end)

exports["qpixel-polytarget"]:AddCircleZone("var_hack6",  vector3(2327.77, 2945.95, -84.47), 0.55, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_hack6", {
    {
...
AddEventHandler('varhack:7', function()
    exports['qpixel-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped2')
            TriggerServerEvent('qpixel-heists:hackfalse7')
...
if exports["qpixel-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('qpixel-heists:hack7')
end 
end)

exports["qpixel-polytarget"]:AddCircleZone("var_hack7",  vector3(2185.9, 2913.24, -84.8), 0.5, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_hack7", {
    {
...
AddEventHandler('varhack:8', function()
    exports['qpixel-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped')
            TriggerServerEvent('qpixel-heists:hackfalse8')
            TriggerEvent("inventory:removeItem", "varusb", 1)
...
if exports["qpixel-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('qpixel-heists:hack8')
end 
end)

exports["qpixel-polytarget"]:AddCircleZone("var_hack8",  vector3(2185.94, 2928.69, -84.8), 0.5, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("var_hack8", {
    {
...
exports["qpixel-polytarget"]:AddCircleZone("leave",  vector3(2156.4, 2922.22, -81.08), 0.5, {
    useZ = true
})

exports["qpixel-interact"]:AddPeekEntryByPolyTarget("leave", {
    {
...
TriggerServerEvent('qpixel-leavevar2')
end)
...
RegisterNetEvent('qpixel-heists:loot_peds')
AddEventHandler('qpixel-heists:loot_peds', function()
...
RegisterNetEvent('qpixel-heists:var_loot_ped')
AddEventHandler('qpixel-heists:var_loot_ped', function()
    if isPlayerInVar == 1 then
        TriggerEvent('qpixel-heists:loot_peds')
        TriggerServerEvent('qpixel-var:lootcooldown')
    else
        print('cooldown')
    end
end)

RegisterNetEvent('qpixel-heists:svclientloot')
AddEventHandler('qpixel-heists:svclientloot', function()
    TriggerServerEvent('qpixel-evannicxvar:varlootcooldown')
end)

function removevarmedkits()
    local qty = exports["qpixel-inventory"]:getQuantity("varmedkit")
  ...
  function removevpistolammo()
    local qty = exports["qpixel-inventory"]:getQuantity("pistolammo")
    if qty and qty > 0 then
  ...
  function removevsubammo()
    local qty = exports["qpixel-inventory"]:getQuantity("subammo")
    if qty and qty > 0 then
  ...
  function removevrifleammo()
    local qty = exports["qpixel-inventory"]:getQuantity("rifleammo")
    if qty and qty > 0 then
