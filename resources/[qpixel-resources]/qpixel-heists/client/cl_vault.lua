...
AddEventHandler("qpixel-inventory:itemUsed", function(pItem)
    if pItem == "thermitecharge" then
        TriggerEvent('qpixel-vault:firstdoor')
        TriggerEvent('qpixel-vault:seconddoor')
        TriggerEvent('qpixel-vault:lowerfirstdoor')
        TriggerEvent('qpixel-vault:lowerseconddoor')
    elseif pItem == "heistlaptop4" then
        TriggerEvent('qpixel-vault:startlowervault')
        TriggerEvent('qpixel-vault:startvault')
    end
end)

RegisterNetEvent('qpixel-vault:firstdoor')
AddEventHandler('qpixel-vault:firstdoor', function()
    ...
    if pd >= 4 then
        if distance < 1.5 then
            if exports["qpixel-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                TriggerServerEvent('qpixel-heists:vaultRobberyLog')
                exports["qpixel-dispatch"]:dispatchadd('10-90', "Pacific Bank Robbery", "429")
                TriggerEvent("client:newStress",true, 150)
                frontdoorvault()
                TriggerEvent('qpixel-dispatch:bankrobbery')
                exports['qpixel-thermite']:OpenThermiteGame(function(success)
                    if success then
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('qpixel-doors:change-lock-state', 46, false) 
                        Citizen.Wait(3000)
...
RegisterNetEvent('qpixel-vault:seconddoor')
AddEventHandler('qpixel-vault:seconddoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["qpixel-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['qpixel-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('qpixel-doors:change-lock-state', 48, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent('qpixel-vault:startvault')
AddEventHandler('qpixel-vault:startvault', function()
    local player = GetEntityCoords(PlayerPedId())
    local distance = #(vector3(253.25254, 228.45343, 101.68377) - player)
    local pd = RPC.execute("qpixel-police:getActiveUnits")
    if pd >= 4 then
        if distance < 1.5 then
            if exports["qpixel-inventory"]:hasEnoughOfItem("heistlaptop4", 1) then
                exports["qpixel-dispatch"]:dispatchadd('10-90', "Pacific Bank Robbery", "429")
                StartVaultKid()
                TriggerEvent('qpixel-dispatch:bankrobbery')
                TriggerEvent("client:newStress",true, 150)
                exports['qpixel-hacking']:hacking(
                function()
                    ClearPedTasksImmediately(PlayerPedId())
                    TriggerEvent('qpixel-heists:vault_door')
                    DeleteObject(bag)
                    DeleteObject(laptop)
...
RegisterNetEvent('qpixel-heists:vault_door')
AddEventHandler('qpixel-heists:vault_door', function()
    TriggerEvent('vault:success:panel', closestBank, true)
    CreatenBrakeCrates()
end)

RegisterNetEvent('qpixel-vault:lowerfirstdoor')
AddEventHandler('qpixel-vault:lowerfirstdoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["qpixel-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['qpixel-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('qpixel-doors:change-lock-state', 49, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent('qpixel-vault:lowerseconddoor')
AddEventHandler('qpixel-vault:lowerseconddoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["qpixel-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['qpixel-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('qpixel-doors:change-lock-state', 50, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent("qpixel-vault:grab", function()
...
exports["qpixel-polytarget"]:AddCircleZone("qpixel_vault_lower_interact_1",  vector3(289.29, 227.55, 98.24), 0.25, {
    useZ = true
})

exports["qpixel-polytarget"]:AddCircleZone("qpixel_vault_lower_interact_2",  vector3(286.92, 227.39, 98.29), 0.2, {
    useZ = true
})

exports["qpixel-polytarget"]:AddCircleZone("qpixel_vault_lower_interact_3", vector3(284.69, 221.64, 98.24), 0.2, {
    useZ = true
})

exports["qpixel-polytarget"]:AddCircleZone("qpixel_vault_lower_interact_4", vector3(286.52, 220.06, 98.29), 0.25, {
    useZ = true
})


exports["qpixel-interact"]:AddPeekEntryByPolyTarget("qpixel_vault_lower_interact_1", {{
    event = "qpixel-vaultrob:lower:firstpindoor",
...
exports["qpixel-interact"]:AddPeekEntryByPolyTarget("qpixel_vault_lower_interact_2", {{
    event = "qpixel-vaultrob:lower:secpindoor",
...
exports["qpixel-interact"]:AddPeekEntryByPolyTarget("qpixel_vault_lower_interact_3", {{
    event = "qpixel-vaultrob:lower:thirdpindoor",
...
exports["qpixel-interact"]:AddPeekEntryByPolyTarget("qpixel_vault_lower_interact_4", {{
    event = "qpixel-vaultrob:lower:fourthpindoor",
...
RegisterNetEvent('qpixel-loot_gold_tray')
AddEventHandler('qpixel-loot_gold_tray', function()
    TriggerServerEvent('qpixel-heists:loot_tray')
end)

RegisterNetEvent('qpixel-loot_cash_tray')
AddEventHandler('qpixel-loot_cash_tray', function()
    TriggerServerEvent('qpixel-heists:cash_tray')
end)

RegisterNetEvent("qpixel-heists:grab_from_tray")
AddEventHandler("qpixel-heists:grab_from_tray", function()
    local chance = math.random(120)
    Loot()
    if chance < 25 then
