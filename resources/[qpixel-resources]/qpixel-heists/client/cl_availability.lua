RegisterNetEvent('qpixel-heists:checkAvailability')
AddEventHandler('qpixel-heists:checkAvailability', function() 
    ...
    exports["qpixel-interface"]:showContextMenu(FatCunt)
end)

RegisterNetEvent('qpixel-heists:purchaseHeistEquipment')
AddEventHandler('qpixel-heists:purchaseHeistEquipment', function()
    local HeistEquipment = {
		{
            ...
            children = {
                ...
                action = "qpixel-heists:purchaseGreenLaptop",
            },
        },
        {
            title = "Paleto Laptop",
            ...
            children = {
                ...
                action = "qpixel-heists:purchaseBlueLaptop",
            },
        },
    }
...
RegisterInterfaceCallback('qpixel-heists:purchaseGreenLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['qpixel-inventory']:hasEnoughOfItem('heistusb5', 1) then
        TriggerEvent('inventory:removeItem', 'heistusb5', 1)
        TriggerEvent("player:receiveItem", "heistlaptop3", 1)
    end
end)

RegisterInterfaceCallback('qpixel-heists:purchaseBlueLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['qpixel-inventory']:hasEnoughOfItem('heistusb1', 1) then
