...
RegisterServerEvent('qpixel-heists:check_if_robbed')
AddEventHandler('qpixel-heists:check_if_robbed', function(license)
...
RegisterServerEvent('qpixel-heists:bankTruckLog')
AddEventHandler('qpixel-heists:bankTruckLog', function()
    local src = source
