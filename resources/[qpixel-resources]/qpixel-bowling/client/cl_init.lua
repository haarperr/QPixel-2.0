...
AddEventHandler("bp-bowling:RemoveItem" , function()
    if not exports["qpixel-inventory"]:hasEnoughOfItem("bowlingball",1,false) then return end
    if exports['qpixel-inventory']:hasEnoughOfItem('bowlingball', 1) then
        TriggerEvent("inventory:removeItem", "bowlingball", 1)
        Citizen.Wait(3000)
    end
    if not exports["qpixel-inventory"]:hasEnoughOfItem("bowlingreceipt",1,false) then return end
    if exports['qpixel-inventory']:hasEnoughOfItem('bowlingreceipt', 1) then
