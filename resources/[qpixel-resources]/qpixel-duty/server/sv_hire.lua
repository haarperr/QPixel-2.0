RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedPD")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedPD", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedPD")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedPD", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
                if result2[1].job ~= 'police' then
                    TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = 'The person you are trying firing does not work for you!'})
                else
...
-- DOJ -----------------------------------------------------------------------------------------------------------------------------------
--Judge----
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedJudge")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedJudge", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedJudge")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedJudge", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
                if result2[1].job ~= 'judge' then
                    TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = 'You are no longer a Judge!'})
                else
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedDA")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedDA", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedDA")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedDA", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
                if result2[1].job ~= 'da' then
                    TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = 'You are no longer a DA!'})
                else
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedADA")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedADA", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedADA")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedADA", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
                if result2[1].job ~= 'ada' then
                    TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = 'You are no longer a ADA!'})
                else
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedDefender")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedDefender", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedDefender")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedDefender", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
                if result2[1].job ~= 'defender' then
                    TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = 'You are no longer a Defender!'})
                else
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassHeat")
AddEventHandler("qpixel-jobsystem:addCharacterPassHeat", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassHeat")
AddEventHandler("qpixel-jobsystem:removeCharacterPassHeat", function(cid)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassBondi")
AddEventHandler("qpixel-jobsystem:addCharacterPassBondi", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassBondi")
AddEventHandler("qpixel-jobsystem:removeCharacterPassBondi", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassCasino")
AddEventHandler("qpixel-jobsystem:addCharacterPassCasino", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassCasino")
AddEventHandler("qpixel-jobsystem:removeCharacterPassCasino", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassRe")
AddEventHandler("qpixel-jobsystem:addCharacterPassRe", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassRe")
AddEventHandler("qpixel-jobsystem:removeCharacterPassRe", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassrr")
AddEventHandler("qpixel-jobsystem:addCharacterPassrr", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassrr")
AddEventHandler("qpixel-jobsystem:removeCharacterPassrr", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassYakuza")
AddEventHandler("qpixel-jobsystem:addCharacterPassYakuza", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassYakuza")
AddEventHandler("qpixel-jobsystem:removeCharacterPassYakuza", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassWinery")
AddEventHandler("qpixel-jobsystem:addCharacterPassWinery", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassWinery")
AddEventHandler("qpixel-jobsystem:removeCharacterPassWinery", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassSuits")
AddEventHandler("qpixel-jobsystem:addCharacterPassSuits", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassSuits")
AddEventHandler("qpixel-jobsystem:removeCharacterPassSuits", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassAk_customs")
AddEventHandler("qpixel-jobsystem:addCharacterPassAk_customs", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassAk_customs")
AddEventHandler("qpixel-jobsystem:removeCharacterPassAk_customs", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassRadical")
AddEventHandler("qpixel-jobsystem:addCharacterPassRadical", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassRadical")
AddEventHandler("qpixel-jobsystem:removeCharacterPassRadical", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassAod")
AddEventHandler("qpixel-jobsystem:addCharacterPassAod", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassAod")
AddEventHandler("qpixel-jobsystem:removeCharacterPassAod", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassPearls")
AddEventHandler("qpixel-jobsystem:addCharacterPassPearls", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassPearls")
AddEventHandler("qpixel-jobsystem:removeCharacterPassPearls", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassVU")
AddEventHandler("qpixel-jobsystem:addCharacterPassVU", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassVU")
AddEventHandler("qpixel-jobsystem:removeCharacterPassVU", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedEMS")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedEMS", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedEMS")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedEMS", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedPDM")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedPDM", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedPDM")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedPDM", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedNoodle")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedNoodle", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedNoodle")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedNoodle", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
...
RegisterServerEvent("qpixel-jobsystem:addCharacterPassBS")
AddEventHandler("qpixel-jobsystem:addCharacterPassBS", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:removeCharacterPassBS")
AddEventHandler("qpixel-jobsystem:removeCharacterPassBS", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedSanders")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedSanders", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedSanders")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedSanders", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedTow")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedTow", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedTow")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedTow", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM jobs_whitelist WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedWeed")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedWeed", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedWeed")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedWeed", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedGal")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedGal", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedGal")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedGal", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedLost")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedLost", function(cid, rank)
    local src = source
    ...
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        if result[1] ~= nil then
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'info', duration = 3000, message = 'You recruited '.. result[1].first_name ..' '.. result[1].last_name})
        end
    end)
end)

RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedLost")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedLost", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
                if result2[1].name ~= 'lostmc' then
                    ...
                    TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = 'You removed '.. result[1].first_name ..' '.. result[1].last_name})
                end
            end
        end) 
    end)
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedRed")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedRed", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedRed")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedRed", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
...
RegisterServerEvent("qpixel-jobsystem:addJobWhitelsitedUG")
AddEventHandler("qpixel-jobsystem:addJobWhitelsitedUG", function(cid, rank)
    local src = source
...
RegisterServerEvent("qpixel-jobsystem:fireJobWhitelsitedUG")
AddEventHandler("qpixel-jobsystem:fireJobWhitelsitedUG", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result2)
            if result[1] ~= nil and result2[1] ~= nil then
...
-- 			TriggerClientEvent('qpixel-jobsystem:PoliceJobMenu', src)
-- 		else
-- 			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not a police officer!"})
-- 		end
-- 	end)
-- end)
...
RegisterCommand('firepd', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'police' and result[1].rank >= 6 then
            TriggerClientEvent('qpixel-jobsystem:PoliceJobMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not a police officer!"})
		end
	end)
...
RegisterCommand('hireems', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'ems' and result[1].rank >= 7 then
			TriggerClientEvent('qpixel-jobsystem:EMSJobMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not ems!"})
		end
	end)
end)
...
RegisterCommand('fireems', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'ems' and result[1].rank >= 7 then
            TriggerClientEvent('qpixel-jobsystem:EMSJobMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not ems!"})
		end
	end)
...
RegisterCommand('hirepdm', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'pdm' and result[1].rank >= 7 then
			TriggerClientEvent('qpixel-jobsystem:PDMJobMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not a pdm worker!"})
		end
	end)
end)
...
RegisterCommand('firepdm', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'pdm' and result[1].rank >= 7 then
            TriggerClientEvent('qpixel-jobsystem:PDMJobMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not a pdm worker!"})
		end
	end)
...
RegisterCommand('hiresanders', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'sanders' and result[1].rank >= 7 then
			TriggerClientEvent('qpixel-jobsystem:SandersJobMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not a sanders worker!"})
		end
	end)
end)
...
RegisterCommand('firesanders', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'sanders' and result[1].rank >= 7 then
            TriggerClientEvent('qpixel-jobsystem:SandersJobMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not a sanders worker!"})
		end
	end)
...
RegisterCommand('hirenoodle', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'noodle_exchange' and result[1].rank >= 7 then
			TriggerClientEvent('qpixel-jobsystem:NoodleJobMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not an employee of Noodle Exchange!"})
		end
	end)
end)
...
RegisterCommand('firenoodle', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'noodle_exchange' and result[1].rank >= 7 then
            TriggerClientEvent('qpixel-jobsystem:NoodleJobMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not an employee of Noodle Exchange!"})
		end
	end)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "burger_shot" and v.rank >= 5 then
				TriggerClientEvent('qpixel-jobsystem:BSJobMenuHire', src)
			end
		end
	end)
end)
...
RegisterCommand("firebs", function(source)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "burger_shot" and v.rank >= 5 then
				TriggerClientEvent('qpixel-jobsystem:BSJobMenuFire', src)
			end
		end
	end)
end)
...
RegisterCommand('releaseveh', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'towunion' and result[1].rank >= 7 then
            TriggerClientEvent('qpixel-jobsystem:releaseVehicle', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not a tow worker!"})
		end
	end)
end)
...
RegisterCommand('hireweed', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'cosmic_cannabis' and result[1].rank >= 4 then
			TriggerClientEvent('qpixel-jobsystem:WeedMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You do not work for cosmic cannabis!"})
		end
	end)
end)
...
RegisterCommand('fireweed', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'cosmic_cannabis' and result[1].rank >= 4 then
            TriggerClientEvent('qpixel-jobsystem:WeedMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You do not work for cosmic cannabis!"})
		end
	end)
...
RegisterCommand('hiregallery', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'art_gallery' and result[1].rank >= 4 then
			TriggerClientEvent('qpixel-jobsystem:GalMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You do not work for the art gallery!"})
		end
	end)
end)
...
RegisterCommand('firegallery', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'art_gallery' and result[1].rank >= 4 then
            TriggerClientEvent('qpixel-jobsystem:GalMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You do not work for the art gallery!"})
		end
	end)
...
RegisterCommand('hirelost', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'lostmc' and result[1].rank >= 4 then
			TriggerClientEvent('qpixel-jobsystem:LostMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not part of the lost mc!"})
		end
	end)
end)
...
RegisterCommand('firelost', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'lostmc' and result[1].rank >= 4 then
            TriggerClientEvent('qpixel-jobsystem:LostMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not part of the lost mc!"})
		end
	end)
...
RegisterCommand('hirered', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'redcircle' and result[1].rank >= 4 then
			TriggerClientEvent('qpixel-jobsystem:RedMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not part of the redcircle!"})
		end
	end)
end)
...
RegisterCommand('firered', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'redcircle' and result[1].rank >= 4 then
            TriggerClientEvent('qpixel-jobsystem:RedMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not part of the redcircle!"})
		end
	end)
...
RegisterCommand('hireug', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'ug_casino' and result[1].rank >= 4 then
			TriggerClientEvent('qpixel-jobsystem:UGMenu', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not part of the ug!"})
		end
	end)
end)
...
RegisterCommand('fireug', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		if result[1].name == 'ug_casino' and result[1].rank >= 4 then
            TriggerClientEvent('qpixel-jobsystem:UGMenu2', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not part of the ug!"})
		end
	end)
...
RegisterCommand('hirejudge', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'judge' or 'da'  and result[1].rank >= 6 then
			TriggerClientEvent('qpixel-jobsystem:JudgeJobMenuHire', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are now a Judge!"})
		end
	end)
end)
...
RegisterCommand('firejudge', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'judge' or 'da'  and result[1].rank >= 6 then
            TriggerClientEvent('qpixel-jobsystem:JudgeJobMenuFire', src) 
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are no longer a Judge!"})
		end
	end)
...
RegisterCommand('hireda', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'da' and result[1].rank >= 7 then
			TriggerClientEvent('qpixel-jobsystem:DAJobMenuHire', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are now a DA!"})
		end
	end)
end)
...
RegisterCommand('fireda', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'da' and result[1].rank >= 6 then
            TriggerClientEvent('qpixel-jobsystem:DAJobMenuFire', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are no longer a DA!"})
		end
	end)
...
RegisterCommand('hireada', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'ada' or 'da' and result[1].rank >= 7 then
			TriggerClientEvent('qpixel-jobsystem:ADAJobMenuHire', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are now a ADA!"})
		end
	end)
end)
...
RegisterCommand('fireada', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'ada' or 'da' and result[1].rank >= 6 then
            TriggerClientEvent('qpixel-jobsystem:ADAJobMenuFire', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are no longer a ADA!"})
		end
	end)
...
RegisterCommand('hiredefender', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'defender' or 'da' and result[1].rank >= 7 then
			TriggerClientEvent('qpixel-jobsystem:DefenderJobMenuHire', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are now a Public Defender!"})
		end
	end)
end)
...
RegisterCommand('firedefender', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'defender' or 'da' and result[1].rank >= 6 then
            TriggerClientEvent('qpixel-jobsystem:DefenderJobMenuFire', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are no longer a Pulic Defender!"})
		end
	end)
end)
...
RegisterCommand('hiretow', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'towunion' and result[1].rank >= 7 then
			TriggerClientEvent('qpixel-jobsystem:TowJobMenuHire', src)
		else
			TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are now a Union member!"})
		end
	end)
end)
...
RegisterCommand('firetow', function(source, args)
	...
	exports.ghmattimysql:execute('SELECT * FROM jobs_whitelist WHERE cid = ?', {cid}, function(result)
		if result[1].job == 'towunion' and result[1].rank >= 6 then
            TriggerClientEvent('qpixel-jobsystem:TowJobMenuFire', src)
		else
            TriggerClientEvent('qpixel-notification:client:Alert', src, {style = 'error', duration = 3000, message = "You are not Union member!"})
		end
	end)
end)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "vanilla_unicorn" and v.rank >= 5 then
				TriggerClientEvent('qpixel-jobsystem:VUJobMenuHire', src)
			end
		end
	end)
end)
...
RegisterCommand("firevu", function(source)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "vanilla_unicorn" and v.rank >= 5 then
				TriggerClientEvent('qpixel-jobsystem:VUJobMenuFire', src)
			end
		end
	end)
end)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "ug_casino" and v.rank >= 5 then
				TriggerClientEvent('qpixel-jobsystem:ugCasinoJobMenuHire', src)
			end
		end
	end)
end)

RegisterServerEvent("qpixel-jobsystem:addCharacterPassUgCasino")
AddEventHandler("qpixel-jobsystem:addCharacterPassUgCasino", function(cid, rank)
    local src = source
    exports.ghmattimysql:execute("INSERT INTO character_passes (cid, name, rank) VALUES (@cid, @name, @rank)", {['@cid'] = cid, ['@name'] = 'ug_casino', ['@rank'] = rank})
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
        if result[1] ~= nil then
...
RegisterCommand("fireugcasino", function(source)
	...
	exports.ghmattimysql:execute('SELECT * FROM character_passes WHERE cid = ?', {cid}, function(result)
		for i, v in pairs(result) do
			if v.name == "ug_casino" and v.rank >= 5 then
				TriggerClientEvent('qpixel-jobsystem:ugCasinoJobMenuFire', src)
			end
		end
	end)
end)

RegisterServerEvent("qpixel-jobsystem:removeCharacterPassUgCasino")
AddEventHandler("qpixel-jobsystem:removeCharacterPassUgCasino", function(cid)
    local src = source
    exports['ghmattimysql']:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result2)
        exports['ghmattimysql']:execute('SELECT * FROM character_passes WHERE cid = @cid', {['@cid'] = cid}, function(result)
                if result ~= nil then                
