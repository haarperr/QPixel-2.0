...
RegisterNetEvent("qpixel-slotmachines-sv:sitDownAtSlotMachine",function(slot)
    activeSlots = slot
    print(slot)
    local coinValue = 1
    TriggerClientEvent("qpixel-slotmachines-cl:sitDownAtSlotMachine",source, slot)
end)

RegisterNetEvent("qpixel-slotmachines-sv:spinMachine",function(currentSlotMachinePos,currentSlotMachineModel,currentBet,cid)
    ...
    TriggerClientEvent('qpixel-slotmachines-cl:startSpin', source, w)
end)

RegisterNetEvent('qpixel-slotmachines-sv:slotsCheckWin')
AddEventHandler('qpixel-slotmachines-sv:slotsCheckWin',function(win, dt)
	CheckForWin(win, dt)
end)
...
function CheckForWin(w, data)
    ...
    TriggerClientEvent("qpixel-slotmachines-cl:spinFinished", source, total)
end