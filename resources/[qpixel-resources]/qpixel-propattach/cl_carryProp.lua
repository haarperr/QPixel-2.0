...
Citizen.CreateThread(function()
  exports["qpixel-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('qpixel-propattach:attach')
AddEventHandler('qpixel-propattach:attach', function(pPropItem, pTargetFunction)
