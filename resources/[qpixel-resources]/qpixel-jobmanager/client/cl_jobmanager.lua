...
AddEventHandler("qpixel-jobmanager:playerBecameJob", function(job, name, notify)
   ...
   -- TriggerServerEvent("qpixel-items:updateID",job,exports["isPed"]:retreiveBusinesses())
end)

RegisterNetEvent("qpixel-base:characterLoaded")
AddEventHandler("qpixel-base:characterLoaded", function(character)
    local LocalPlayer = exports["qpixel-base"]:getModule("LocalPlayer")
