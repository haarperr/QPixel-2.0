...
Citizen.CreateThread(function()
    ...
    while(true) do
		...
		if addedPolyZone == false then
			    exports["qpixel-polyzone"]:AddBoxZone("carrent", vector3(110.4619140625, -1090.6267089844, 29.302474975586), 0.8, 0.9, {
				name="carrent",
				heading=331.47,
				debugPoly=false,
				minZ=22.37,
...
--RegisterNetEvent('qpixel-carrent:menu')
--AddEventHandler('qpixel-carrent:menu', function()   
...
AddEventHandler('qpixel-carrent:menu', function()                           
  TriggerEvent('qpixel-context:sendMenu', {
        ...
        },
        {
			...
			params = {
                event = "qpixel-carrent:checkmoney",
                args = {
                    car = Config.Car1,
...
RegisterNetEvent('qpixel-carrent:checkmoney')
AddEventHandler('qpixel-carrent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("qpixel-carrent:hasmoney", price, vehicle)

end)

RegisterNetEvent('qpixel-carrent:spawncar')
AddEventHandler('qpixel-carrent:spawncar', function(vehicleName)                            
