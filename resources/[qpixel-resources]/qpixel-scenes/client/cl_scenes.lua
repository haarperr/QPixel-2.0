...
RegisterNetEvent("qpixel-scenes:allScenes")
AddEventHandler("qpixel-scenes:allScenes", function(scenes)
  activeScenes = scenes
end)

RegisterNetEvent("qpixel-scenes:refreshScenes")
AddEventHandler("qpixel-scenes:refreshScenes", function(sceneId, scene)
...
RegisterNetEvent("qpixel-scenes:deleteScene")
AddEventHandler("qpixel-scenes:deleteScene", function(removeId)
  if removeId then
...
function calculateScenesToDraw()
  ...
  local isPeekActive = exports['qpixel-interact']:IsPeeking()
...
RegisterInterfaceCallback("qpixel-ui:scenes:input", function(data, cb)
...
RegisterCommand("+startScene", function()
  if sceneStarted then
    ...
    exports['qpixel-interface']:openApplication('textbox', {
      callbackUrl = 'qpixel-ui:scenes:input',
      key = 1,
      items = {
        {
          icon = "pencil-alt",
...
RegisterCommand("+deleteScene", function()
  ...
  TriggerServerEvent("qpixel-scenes:deleteScene", GetEntityCoords(PlayerPedId()))
end, false)
RegisterCommand("-deleteScene", function() end, false)

Citizen.CreateThread(function()
  exports["qpixel-keybinds"]:registerKeyMapping("", "Scenes", "Start / Place Scene", "+startScene", "-startScene")
  exports["qpixel-keybinds"]:registerKeyMapping("", "Scenes", "Enable / Disable", "+enableScene", "-enableScene")
  exports["qpixel-keybinds"]:registerKeyMapping("", "Scenes", "Delete Closest Scene", "+deleteScene", "-deleteScene")
  RequestStreamedTextureDict('commonmenu', true)
  Wait(5000)
  TriggerServerEvent("qpixel-scenes:getScenes")
end)