...
local function returnBoat()
    ...
    local finished = exports["desirerp-taskbar"]:taskBar(1000, "Returning Boat")
    ...
    TriggerEvent("desirerp-fishing:currentlyRentedBoat", currentlyRentedBoat)
end

function rentBoat()
    boatsValeted = boatsValeted + 1
    FreezeEntityPosition(PlayerPedId(), true)
    local finished = exports["desirerp-taskbar"]:taskBar(1000, "Valeting Boat")
...
AddEventHandler("desirerp-fishing:rentBoat", function(name)
...
AddEventHandler("desirerp-fishing:returnBoat", function()
