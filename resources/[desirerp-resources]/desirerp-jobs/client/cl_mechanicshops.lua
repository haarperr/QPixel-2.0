...
AddEventHandler('desirerp-polyzone:enter', function(name)
    if name == "tuner_shop_craft" then
        ...
        TunerCraft()
        local isEmployed = exports["desirerp-business"]:IsEmployedAt("tuner_shop")
        if isEmployed then
...
AddEventHandler('desirerp-polyzone:enter', function(name)
    if name == "harmony_repairs_craft" then
        Harmony_Craft = true     
        HarmonyCraft()
        local isEmployed = exports["desirerp-business"]:IsEmployedAt("harmony_repairs")
        if isEmployed then
            exports['desirerp-interface']:showInteraction("[E] Craft")
        end
...
AddEventHandler('desirerp-polyzone:enter', function(name)
    if name == "hayes_autos_craft" then
        Hayes_Craft = true     
        HayesCraft()
        local isEmployed = exports["desirerp-business"]:IsEmployedAt("hayes_autos")
        if isEmployed then
            exports['desirerp-interface']:showInteraction("[E] Craft")
        end
...
AddEventHandler('desirerp-polyzone:enter', function(name)
    if name == "ottos_autos_craft" then
        ...
        OttosCraft()
        local isEmployed = exports["desirerp-business"]:IsEmployedAt("ottos_autos")
        if isEmployed then
            exports['desirerp-interface']:showInteraction("[E] Craft")
        end
...
Citizen.CreateThread(function()
    -- Tuner Shop | Start --
    exports["desirerp-polyzone"]:AddBoxZone("tuner_shop_stash", vector3(128.46, -3014.08, 7.04), 2.5, 2.5, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("tuner_shop_craft", vector3(143.96, -3051.26, 7.04), 1, 5, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("harmony_repairs_stash", vector3(1187.12, 2635.81, 38.4), 1, 1.4, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("harmony_repairs_craft", vector3(1176.23, 2635.29, 37.75), 3, 2, {
    ...
    -- Hayes Autos | Start --
    exports["desirerp-polyzone"]:AddBoxZone("hayes_autos_stash", vector3(-1418.49, -454.77, 35.91), 1, 3.0, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("hayes_autos_craft", vector3(-1408.17, -447.34, 35.91), 1, 5.0, {
    ...
    -- Ottos Autos | Start --
    exports["desirerp-polyzone"]:AddBoxZone("ottos_autos_stash", vector3(837.15, -814.76, 26.33), 2, 3.0, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("ottos_autos_craft", vector3(840.33, -827.5, 26.33), 2, 3.6, {
