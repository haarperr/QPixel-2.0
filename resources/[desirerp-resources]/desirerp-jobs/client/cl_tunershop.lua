...
Citizen.CreateThread(function()
    exports["desirerp-polyzone"]:AddBoxZone("tuner_shop_docs_stash", vector3(128.46, -3014.08, 7.04), 2.5, 2.5, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("tuner_shop_docs_stash2", vector3(128.45, -3008.05, 7.04), 2, 3.2, {
...
RegisterNetEvent('desirerp-civjobs:craft-lockpick')
AddEventHandler('desirerp-civjobs:craft-lockpick', function()
    local job = exports["isPed"]:GroupRank('tuner')
    if job >= 1 and exports['desirerp-inventory']:hasEnoughOfItem('steel', 2) then
...
RegisterNetEvent('desirerp-civjobs:craft-advlockpick')
AddEventHandler('desirerp-civjobs:craft-advlockpick', function()
    local job = exports["isPed"]:GroupRank('tuner')
    if job >= 1 and exports['desirerp-inventory']:hasEnoughOfItem('refinedaluminium', 15) and exports['desirerp-inventory']:hasEnoughOfItem('refinedplastic', 12) and exports['desirerp-inventory']:hasEnoughOfItem('refinedrubber', 15) then
...
RegisterNetEvent('desirerp-civjobs:craft-repairkit')
AddEventHandler('desirerp-civjobs:craft-repairkit', function()
    local job = exports["isPed"]:GroupRank('tuner')
    if job >= 1 and exports['desirerp-inventory']:hasEnoughOfItem('electronics', 25) then
...
RegisterNetEvent('desirerp-civjobs:tuner_craft')
AddEventHandler('desirerp-civjobs:tuner_craft', function()
    TriggerEvent('desirerp-context:sendMenu', {
        ...
        },
        {
            ...
            params = {
                event = "desirerp-civjobs:craft-lockpick"
            }
        },
        {
            id = 3,
            ...
            params = {
                event = "desirerp-civjobs:craft-advlockpick"
            }
        },
        {
            id = 4,
            ...
            params = {
                event = "desirerp-civjobs:craft-repairkit"
            }
        },
        {
            id = 5,
...
Citizen.CreateThread(function()
    exports["desirerp-polyzone"]:AddBoxZone("tuner_shop_docs_craft", vector3(144.39, -3050.88, 7.04), 4, 1.4, {
	...
	Citizen.CreateThread(function()
        while DreamsCraftDocs do
			...
			if IsControlJustReleased(0, 38) then
                    local rank = exports["isPed"]:GroupRank("tuner")
                    if rank > 0 then 
                    TriggerEvent('desirerp-civjobs:tuner_craft')
                end
			end
		end
	end)
