    ...
    {['@license_plate'] = plate}, function(pValues)
        if pValues[1].vin == "1" then
            ...
            local connect = {
              ...
              PerformHttpRequest("https://discord.com/api/webhooks/1012082431773388820/96MoH8laPVGfI_vJTWySg3hFDpXfIuw4BcOQECs7gpPOlOBf0AqYGbP0R0b0cGtEUemj", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
    ...
    {['@license_plate'] = plate}, function(pValues)
        if pValues[1].vin == "1" then
            ...
            local connect = {
              ...
              PerformHttpRequest("https://discord.com/api/webhooks/1012082407526125600/cc8qwHIT92E4rdgm6OTfJj30P1wUdlQLlmcDu0sRhJ1rgk3pbcZAMmB3XMqzWS2rVq-k", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
