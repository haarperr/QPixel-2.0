...
AddEventHandler('desirerp-jobs:galleryPayout', function(amount)
    ...
    local connect = {
      ...
      PerformHttpRequest("https://discord.com/api/webhooks/1012082878152192011/LWs9LAtXdH1a9UxFp9VDubp7RVmgAJopKuG1AIovHhsYNEbQI53dormyk2mM9XRRj-3C", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)