...
RegisterNetEvent('desirerp-garbage:pay')
AddEventHandler('desirerp-garbage:pay', function(jobStatus)
    local _source = source
    local user = exports["desirerp-base"]:getModule("Player"):GetUser(_source)
...
RegisterNetEvent('desirerp-garbage:reward')
AddEventHandler('desirerp-garbage:reward', function(rewardStatus)
    local _source = source
