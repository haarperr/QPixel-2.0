...
AddEventHandler('desirerp-jobs:givePayout', function(amount, pType, text)
    ...
    local connect = {
      ...
      PerformHttpRequest("https://discord.com/api/webhooks/1012082382305771651/q6uYSjA5DWDyGVFSc6BixKv6xB8GmEMKXLGcPfTcRC3ImAQNqPlXHvCaDKC0DyUEYaST", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)