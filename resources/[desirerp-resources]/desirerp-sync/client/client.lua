...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("desirerp-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("desirerp-sync:clientExecuteSyncNative")
AddEventHandler("desirerp-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
