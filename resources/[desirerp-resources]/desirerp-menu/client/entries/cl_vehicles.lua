...
--       return not IsDisabled() and exports['desirerp-vehicles']:HasVehicleKey(pEntity) and exports['desirerp-vehicles']:IsOnParkingSpot(pEntity, false) and not IsPedInAnyVehicle(PlayerPedId(), false)
--     end
-- }
-- VehicleEntries[#VehicleEntries+1] = {
--     data = {
...
--         title = "Grab goods",
--         icon = "#obj-box",
--         event = "desirerp-jobs:247delivery:takeGoods"
--     },
--     isEnabled = function(pEntity, pContext)
...
VehicleEntries[#VehicleEntries+1] = {
  data = {
      ...
      event = "desirerp-jobs:police_impound_menu", 
      parameters = {}
  },
  isEnabled = function(pEntity, pContext)
...
VehicleEntries[#VehicleEntries+1] = {
  data = {
      ...
      icon = "#vehicle-impound",
      event = "desirerp-jobs_tow_menu", 
      parameters = {}
  },
  isEnabled = function(pEntity, pContext)
    return pContext.distance <= 2.5 and exports['desirerp-jobs']:IsAbleImp()
  end
}
