...
PedEntries[#PedEntries+1] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and ((exports["desirerp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
    end
}
...
MenuItems['peds:cuff'] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not isDead and ((exports["desirerp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
        --return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and not pContext.flags['isCuffed'] and ((exports["desirerp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc))) and pContext.distance <= 1.2
    end
}
...
MenuItems['peds:uncuff'] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not isDead and ((exports["desirerp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
        --return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and pContext.flags['isCuffed'] and ((exports["desirerp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
    end
}
...
MenuItems['cuffs:blindfold'] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not isDead and ((exports["desirerp-inventory"]:hasEnoughOfItem("blindfold",1,false)))
        --return not IsDisabled() and pEntity and pContext.flags['isCuffed'] and pContext.flags['isPlayer'] and not pContext.flags['isBlindfolded'] and ((exports["desirerp-inventory"]:hasEnoughOfItem("blindfold",1,false)))
    end
}
...
MenuItems['cuffs:gag'] = {
  ...
  isEnabled = function(pEntity, pContext)
      return not isDead and ((exports["desirerp-inventory"]:hasEnoughOfItem("gag_sock",1,false)))
      --return not IsDisabled() and pEntity and pContext.flags['isCuffed'] and pContext.flags['isPlayer'] and not pContext.flags['isGagged'] and ((exports["desirerp-inventory"]:hasEnoughOfItem("gag_sock",1,false)))
  end
}
...
RegisterNetEvent('desirerp-mdw:open-mdw')
AddEventHandler('desirerp-mdw:open-mdw', function()
    ExecuteCommand('+mdw')
end)