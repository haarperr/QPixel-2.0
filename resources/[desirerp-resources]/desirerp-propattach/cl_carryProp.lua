...
Citizen.CreateThread(function()
  exports["desirerp-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('desirerp-propattach:attach')
AddEventHandler('desirerp-propattach:attach', function(pPropItem, pTargetFunction)
