...
function outOfPins() {
  $.post('http://desirerp-lockpicking/failure', JSON.stringify({}));
  gameOver = true;
...
function unlock() {
  $.post('http://desirerp-lockpicking/complete', JSON.stringify({}));
...
document.onkeyup = function (data) {
  if (data.which == 27 ) {
    $.post('http://desirerp-lockpicking/close', JSON.stringify({}));
  }
};
