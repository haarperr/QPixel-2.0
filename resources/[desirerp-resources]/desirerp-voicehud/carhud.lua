...
AddEventHandler("desirerp-jobmanager:playerBecameJob", function(job, name)
...
--v_med_bed2=2117668672
  ...
  if DoesEntityExist(objFound) then
    -- TriggerEvent("DoLongHudText","Press [E] to leave the bed at any time.",1)
      ...
      exports["desirerp-interface"]:showInteraction("[E] Leave Bed")
...
RegisterNetEvent("desirerp-hud:changeRange")
AddEventHandler("desirerp-hud:changeRange", function(pRange)
	if pRange == 1 then 
