...
function openGui(sentLength,taskID,namesent,keepWeapon)
    ...
    guiEnabled = true
    pTaskActive = 1
    exports["desirerp-interface"]:sendAppEvent("taskbar", {
        display = true,
        duration = sentLength,
        taskID = taskID,
        label = namesent,
...
function handheld() 
  ...
  function generalInventory()
    if not insidePrompt and not inventoryDisabled and not forceInventoryDisabled and not exports['desirerp-taskbar']:pInInv() then
  ...
  local function hasPhone()
    return exports["desirerp-inventory"]:hasEnoughOfItem("mobilephone", 1, false, true) or
        exports["desirerp-inventory"]:hasEnoughOfItem("stoleniphone", 1, false, true) or
        exports["desirerp-inventory"]:hasEnoughOfItem("stolens8", 1, false, true) or
        exports["desirerp-inventory"]:hasEnoughOfItem("stolennokia", 1, false, true) or
        exports["desirerp-inventory"]:hasEnoughOfItem("stolenpixel3", 1, false, true) or
        exports["desirerp-inventory"]:hasEnoughOfItem("boomerphone", 1, false, true)
  end
...
Citizen.CreateThread(function()
    exports["desirerp-keybinds"]:registerKeyMapping("", "Radio", "Open", "+handheld", "-handheld", "I")
    RegisterCommand('+handheld', handheld, false)
    RegisterCommand('-handheld', function() end, false)
    
    exports["desirerp-keybinds"]:registerKeyMapping("", "Phone", "Open", "+generalPhone", "-generalPhone", "P")
    RegisterCommand('+generalPhone', generalPhone, false)
    RegisterCommand('-generalPhone', function() end, false)
    
    exports["desirerp-keybinds"]:registerKeyMapping("", "Inventory", "Open", "+generalInventory", "-generalInventory", "K")
    RegisterCommand('+generalInventory', generalInventory, false)
    RegisterCommand('-generalInventory', function() end, false)
    
    exports["desirerp-keybinds"]:registerKeyMapping("", "Player", "Escape menu", "+generalEscapeMenu", "-generalEscapeMenu", "ESCAPE")
