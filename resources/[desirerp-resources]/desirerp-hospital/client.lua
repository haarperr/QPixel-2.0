...
RegisterNetEvent("desirerp-hospitalization:checkin")
AddEventHandler("desirerp-hospitalization:checkin", function(allowed)
	if allowed then
		loadAnimDict('anim@narcotics@trash')
		TaskPlayAnim(PlayerPedId(),'anim@narcotics@trash', 'drop_front',1.0, 1.0, -1, 1, 0, 0, 0, 0)
		local finished = exports["desirerp-taskbar"]:taskBar(2500,"Checking Credentials")
...
RegisterNetEvent("desirerp-hospitalization:page")
AddEventHandler("desirerp-hospitalization:page", function()
	if exports["isPed"]:isPed("countems") >= 1 then 
		loadAnimDict('anim@narcotics@trash')
		TaskPlayAnim(PlayerPedId(),'anim@narcotics@trash', 'drop_front',1.0, 1.0, -1, 1, 0, 0, 0, 0)
		local finished = exports["desirerp-taskbar"]:taskBar(2500,"Paging a Doctor")
		if finished == 100 then
...
Citizen.CreateThread(function()
exports["desirerp-polytarget"]:AddCircleZone("pillbox_checkin", vector3(307.59, -595.3, 43.08), 0.35, {
...
Citizen.CreateThread(function()
    exports["desirerp-polyzone"]:AddBoxZone("pillbox_ems_equipment", vector3(306.72, -602.02, 43.28), 1, 2.4, {
...
AddEventHandler('desirerp-polyzone:enter', function(name)
    if name == "pillbox_ems_equipment" then
        ...
        EMSEquipment()
        if exports['isPed']:isPed('myjob') == "ems" then
            exports['desirerp-interface']:showInteraction("[E] Equipment")
        end
    end
end)
