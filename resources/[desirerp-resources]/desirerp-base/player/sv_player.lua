...
AddEventHandler('playerConnecting', function()
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1012082873366478899/TCBibQ8muuWsWwXo5lXqFa8_b7Y4f9GmjAQktfTKfuv6iIH3TyzLPrs8suJLuR8bQpqv", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1012082965360164924/1MT9Rjjua9Qw4hbRWrD1d5nvgQJrcj5KIyjVTHgcjVCF2LXSwWaqK9qKQ9q88xGv8A8k", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)
...
AddEventHandler('desirerp-base:logDeath', function(killer, reason)
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1012083032762630226/qWHlaYrj4jHv9e12H4pjFJ82R2i4sI5nV-DYOzDoI8veOf9krMTl1UFS3zfEJetF8los", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)