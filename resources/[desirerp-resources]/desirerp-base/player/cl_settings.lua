...
function DPX.SpawnManager.Initialize(self)
    Citizen.CreateThread(function()
        ...
        TriggerEvent("desirerp-base:spawnInitialized")
        TriggerServerEvent("desirerp-base:spawnInitialized")
...
AddEventHandler("desirerp-base:firstSpawn", function()
...
RegisterNetEvent('desirerp-base:clearStates')
AddEventHandler('desirerp-base:clearStates', function()
...
function DPX.SettingsData.setSettingsTable(settingsTable, shouldSend)
  if settingsTable == nil then
    ...
    TriggerServerEvent('desirerp-base:sv:player_settings_set',DPX.Settings.Current)
...
RegisterNetEvent("desirerp-base:cl:player_settings")
AddEventHandler("desirerp-base:cl:player_settings", function(settingsTable)
  DPX.SettingsData.setSettingsTable(settingsTable,false)
end)


RegisterNetEvent("desirerp-base:cl:player_reset")
AddEventHandler("desirerp-base:cl:player_reset", function(tableName)
