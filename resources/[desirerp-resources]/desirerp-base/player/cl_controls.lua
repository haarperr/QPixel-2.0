...
function DPX.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('desirerp-base:sv:player_control_set',DPX.Controls.Current)
...
RegisterNetEvent("desirerp-base:cl:player_control")
AddEventHandler("desirerp-base:cl:player_control", function(controlTable)
...
RegisterNetEvent('desirerp-base:setcontrols')
AddEventHandler('desirerp-base:setcontrols', function()
	TriggerServerEvent('desirerp-base:sv:player_controls')
end)
