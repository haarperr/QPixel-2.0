...
RegisterNetEvent("desirerp-base:setVar")
AddEventHandler("desirerp-base:setVar", setVar)

RegisterNetEvent("desirerp-base:setChar")
AddEventHandler("desirerp-base:setChar", setChar)

RegisterNetEvent("desirerp-base:resetVars")
AddEventHandler("desirerp-base:resetVars", resetVars)
