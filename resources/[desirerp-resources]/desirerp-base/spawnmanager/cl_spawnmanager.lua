...
function DPX.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        if new then TriggerEvent("desirerp-base:newCharacterSpawned") DoScreenFadeIn(500) end
...
-- RegisterNetEvent("desirerp-base:newCharacterSpawned")
-- AddEventHandler('desirerp-base:newCharacterSpawned', function()
--     DestroyAllCams(true)
--     TriggerEvent("raid_clothes:defaultReset")
--     FreezeEntityPosition(PlayerPedId(), false)
-- end)

RegisterNetEvent("desirerp-base:firstSpawn")
