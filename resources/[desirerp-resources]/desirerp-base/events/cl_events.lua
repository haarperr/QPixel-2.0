...
function DPX.Events.Trigger(self, event, args, callback)
    ...
    TriggerServerEvent("desirerp-events:listenEvent", id, event, args)
end

RegisterNetEvent("desirerp-events:listenEvent")
AddEventHandler("desirerp-events:listenEvent", function(id, data)
