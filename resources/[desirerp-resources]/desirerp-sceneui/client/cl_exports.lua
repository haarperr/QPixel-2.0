...
RegisterNetEvent("desirerp-sceneui:open-application")
AddEventHandler("desirerp-sceneui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("desirerp-sceneui:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("desirerp-ui:soundPlay")
AddEventHandler("desirerp-ui:soundPlay", function(name, volume, loop)
