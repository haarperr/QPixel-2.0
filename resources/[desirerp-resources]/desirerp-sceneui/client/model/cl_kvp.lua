...
RegisterNUICallback("desirerp-ui:setKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
  -- data.value = value
  ...
  TriggerEvent("desirerp-hud:settings", data.key, data.value)
...
RegisterNUICallback("desirerp-ui:getKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
...
function GetPreferences()
  local result = GetResourceKvpString('desirerp-preferences')
  return json.decode(result or "{}")
end
