...
function taskBarSkillCheck(difficulty, skillGapSent, cb, reverse, usePrev)
  ...
  local duration = difficulty * (math.min(exports["desirerp-buffs"]:getAlertLevelMultiplier(), 1.33))
  ...
  exports['desirerp-actionbar']:disableActionBar(true)
  ...
  SetTimeout(500, function()
    if not tbsListening then
      exports['desirerp-actionbar']:disableActionBar(false)
