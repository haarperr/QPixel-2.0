;(function () {
    ...
    !(function () {
      ...
      setImmediate(async () => {
        ...
        Number(_0x36aece.length) === 0 && emitNet('desirerp-objects:requestObjects')
      })
      onNet('desirerp-objects:loadObjects', async (_0xe9ddb4) => {
      ...
      on('desirerp-polyzone:enter', async (_0x46614c, _0x2b0f68) => {
      ...
      on('desirerp-polyzone:exit', (_0x329570, _0x2b3c55) => {
      ...
      onNet('desirerp-objects:clearObjects', (_0x469f66) => {
      ...
      onNet('desirerp-objects:updateObjects', (_0xacd038) => {
      ...
      async function _0x491670(_0x2d06c6) {
        console.log('[desirerp-objects] Adding object: ', _0x2d06c6)
        let _0x1194f7 = {
      ...
      function _0x3712a8(_0x4b77ba) {
        let _0x5f588f = RPC.execute('desirerp-objects:DeleteObject', _0x4b77ba)
        return _0x5f588f
      }
      _0x2df2bb.g.exports('DelObject', _0x3712a8)
      function _0x3fc7e3(_0x45e806, _0x4befc3) {
        RPC.execute('desirerp-objects:UpdateObject', _0x45e806, _0x4befc3)
      }
      ...
      RegisterCommand(
        ...
        (_0x37a992, _0x4114dc, _0x5d60b5) => {
          ...
          console.log('[desirerp-objects] getObject return: ', _0x51a571)
        },
        false
      )
      RegisterCommand(
