...
AddEventHandler('desirerp-voice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('desirerp-voice:setTalkingMode', voiceMode)
	TriggerEvent("desirerp-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
...
RegisterNetEvent('desirerp-voice:toggleMute', toggleMute)
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('desirerp-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('desirerp-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('desirerp-voice_enableMicClicks', tostring(true))
	else
