...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    if exports['desirerp-menu']:houseGarageCoords() ~= nil and exports['desirerp-menu']:NearHouseGarage() and exports['desirerp-menu']:NearHouseGarage2() then
	...
	Citizen.CreateThread(function()			
        ...
        --RPC.execute("desirerp-wheelfitment_sv:getfuckingdata",veh, plate)
