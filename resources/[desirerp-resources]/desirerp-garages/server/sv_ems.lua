RegisterServerEvent('desirerp-garages:FinalizedPur2')
AddEventHandler('desirerp-garages:FinalizedPur2', function(plate, name, vehicle, price, personalvehicle, financed)
    local src = source
