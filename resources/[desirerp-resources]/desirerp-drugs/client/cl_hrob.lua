...
AddEventHandler('sell_goods1', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("rolexwatch",25,false) then
...
AddEventHandler('sell_goods2', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("oxy",20,false) then
...
AddEventHandler('sell_goods3', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolentv",1,false) then
...
AddEventHandler('sell_goods4', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolenart",1,false) then
...
AddEventHandler('sell_goods5', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolencoffee",1,false) then
...
AddEventHandler('sell_goods6', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolenmusic",1,false) then
...
AddEventHandler('sell_goods7', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolencasinowatch",3,false) then
...
AddEventHandler('sell_goods8', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolengameboy",2,false) then
...
AddEventHandler('sell_goods9', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stoleniphone",1,false) then
...
AddEventHandler('sell_goods10', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolennokia",1,false) then
...
AddEventHandler('sell_goods11', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolenpsp",1,false) then
...
AddEventHandler('sell_goods12', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolenoakleys",1,false) then
...
AddEventHandler('sell_goods13', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolens8",1,false) then
...
AddEventHandler('sell_goods14', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolenraybans",1,false) then
...
AddEventHandler('sell_goods15', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolenmicrowave",1,false) then
...
AddEventHandler('sell_goods16', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("stolencomputer",1,false) then
...
AddEventHandler('sell_goods17', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("goldbar",1,false) then
...
RegisterNetEvent('desirerp-pawnshop:sell', function()
  ...
  exports["desirerp-polytarget"]:AddBoxZone("sell_goods", vector3(-278.78, 2205.87, 129.82), 0.8, 0.6, {
    heading=0
  })