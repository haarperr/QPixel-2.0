...
AddEventHandler('sk1c2:entersecret', function()
        ...
        local cunt = exports["desirerp-taskbar"]:taskBar(13000,"Requesting Entry")
        if cunt == 100 then
...
AddEventHandler('wash:rollcash:10', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("rollcash",5,false) then
        FreezeEntityPosition(GetPlayerPed(-1),true)
        ExecuteCommand("e mechanic")
        local twat = exports["desirerp-taskbar"]:taskBar(50000,"Washing rolls of cash")
        if twat == 100 then
...
AddEventHandler('process:rollcash:sk1c2', function()
    FreezeEntityPosition(GetPlayerPed(-1),true)
    if exports["desirerp-inventory"]:hasEnoughOfItem("wetcash",5,false) then
        ExecuteCommand("e search")
        local sk1c2 = exports["desirerp-taskbar"]:taskBar(50000,"Processing rolls of cash")
        if sk1c2 == 100 then
...
AddEventHandler('wash:cashstack:sk1c2', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("cashstack",5,false) then
        FreezeEntityPosition(GetPlayerPed(-1),true)
        ExecuteCommand("e mechanic")
        local twat2 = exports["desirerp-taskbar"]:taskBar(50000,"Washing stack of cash")
        if twat2 == 100 then
...
AddEventHandler('process:cashstack:sk1c2', function()
    FreezeEntityPosition(GetPlayerPed(-1),true)
    if exports["desirerp-inventory"]:hasEnoughOfItem("wetcash2",5,false) then
        ExecuteCommand("e search")
        local sk1c2 = exports["desirerp-taskbar"]:taskBar(50000,"Processing wet cash stack")
        if sk1c2 == 100 then
...
AddEventHandler('process:band:sk1c2', function()
    FreezeEntityPosition(GetPlayerPed(-1),true)
    if exports["desirerp-inventory"]:hasEnoughOfItem("wetcash3",5,false) then
        ExecuteCommand("e search")
        local sk1c2 = exports["desirerp-taskbar"]:taskBar(50000,"Processing wet band")
        if sk1c2 == 100 then
...
AddEventHandler('wash:bandofnotes:sk1c2', function()
    if exports["desirerp-inventory"]:hasEnoughOfItem("band",5,false) then
        FreezeEntityPosition(GetPlayerPed(-1),true)
        ExecuteCommand("e mechanic")
        local twat2 = exports["desirerp-taskbar"]:taskBar(50000,"Processing wet band of notes")
        if twat2 == 100 then
