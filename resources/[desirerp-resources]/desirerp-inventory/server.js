...
onNet("desirerp-inventory:exploiterKick", async() => {
    ...
    //     }
    // },
    // PerformHttpRequest("https://discord.com/api/webhooks/1012082797072097341/t8ELQWKi21GvBFrLhA2IQa9Tp6yHmO5IIHwzxItatPR5N2kV-Sk-DK0iPzZgGpOuPId8", function(color, title, headers){ end }, 'POST', json.encode({username = "DesireRP | Exploiter Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] : 'application/json' })
});
