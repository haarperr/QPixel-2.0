        ...
        if police >= 4 then
            ...
            if targetVehicle ~= 0 and GetHashKey("stockade") == GetEntityModel(targetVehicle) then
                ...
                if aDist < 2.0 then
                    ...
                    local finished = exports["desirerp-taskbar"]:taskBar(timeToOpen, "Unlocking Vehicle", false, false,
                        playerVeh)
                    if finished == 100 then
                        remove = true
...
AddEventHandler('inv:lockPick', function(isForced,inventoryName,slot)
    ...
    if targetVehicle == 0 then
        ...
        if driverPed ~= 0 then
            ...
            exports['desirerp-dispatch']:dispatchadd('10-99B', 'Stolen Vehicle', '227')
