...
-- -105.12893676758, 6471.46484375, 31.626705169678 Heading: 40.885322570801
            if exports["desirerp-inventory"]:hasEnoughOfItem("thermite",1,false) then
                FreezeEntityPosition(PlayerPedId(),true)
                local FirstDoorBigBank = exports["desirerp-taskbar"]:taskBar(9000,"Preparing For Hack")
                if FirstDoorBigBank == 100 then
                    ...
                    function() -- Success
                        ...
                        TriggerEvent('desirerp-vaultDoor3', -1, method)
                        --TriggerEvent('desirerp-ffs2:startheist')
                    ...
                    --     function() -- success
                    --         StopAnimTask(PlayerPedId(), hackAnimDict, "hack_loop", 1.0)
                    --         TriggerEvent('desirerp-vaultDoor2', -1, method)
                    --         TriggerEvent('desirerp-ffs2:startheist')
    ...
    if distance < 1.5 then
        if exports["desirerp-inventory"]:hasEnoughOfItem("thermite",1,false) then
            ...
            if FirstDoorBigBank == 100 then
                ...
                exports["memorygame"]:thermiteminigame(1, 3, 4, 10,
                function() -- Success
                    TriggerEvent("desirerp-BayCityTriggerSecondDoor")
                    TriggerEvent("inventory:removeItem","thermite",1)
                    TriggerEvent('DoLongHudText', 'Well done dumbass please cry more!', 2)
                end,
                function() -- failure
...
RegisterNetEvent('desirerp-BayCityTriggerSecondDoor')
AddEventHandler('desirerp-BayCityTriggerSecondDoor', function()
	anim66()
	Citizen.Wait(3500)
end)

RegisterNetEvent('desirerp-Seconddoorsbaycity') 
AddEventHandler('desirerp-Seconddoorsbaycity', function()
    TriggerServerEvent("desirerp-doors:change-lock-state", 524, false)
end)
    ...
    if distance < 1.5 then
        if exports["desirerp-inventory"]:hasEnoughOfItem("thermite",1,false) then
            ...
            if FirstDoorBigBank == 100 then
                ...
                exports["memorygame"]:thermiteminigame(1, 3, 4, 10,
                function() -- Success
                    TriggerEvent("desirerp-BayCityTriggerFirstDoor")
                    TriggerEvent("inventory:removeItem","thermite",1)
                    TriggerEvent('DoLongHudText', 'Well done dumbass please cry more!', 2)
...
RegisterNetEvent('desirerp-BayCityTriggerFirstDoor')
AddEventHandler('desirerp-BayCityTriggerFirstDoor', function()
	anim69()
	Citizen.Wait(3500)
end)

RegisterNetEvent('desirerp-firstdoorsbaycity') 
AddEventHandler('desirerp-firstdoorsbaycity', function()
    TriggerServerEvent("desirerp-doors:change-lock-state", 525, false)
end)
...
RegisterNetEvent('desirerp-vaultDoor3')
AddEventHandler('desirerp-vaultDoor3', function(method)
...
RegisterNetEvent("desirerp-baycity:getDoorCheckCL")
AddEventHandler("desirerp-baycity:getDoorCheckCL", function(result)
...
Citizen.CreateThread(function()
    ...
    while true do 
        ...
        if isNear then
            TriggerServerEvent('desirerp-baycity:getGetDoorStateSV')
...
RegisterNetEvent("desirerp-ptfxparticlebaycity")
AddEventHandler("desirerp-ptfxparticlebaycity", function(method)
    local ptfx
...
-- 252.99769592285, 220.96379089355, 101.68360137939 Heading: 166.93214416504
    ...
    TriggerServerEvent("desirerp-particleserverbaycity", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomba)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("desirerp-Seconddoorsbaycity")
end

RegisterNetEvent("desirerp-ptfxparticlebaycity1")
AddEventHandler("desirerp-ptfxparticlebaycity1", function(method)
    local ptfx
...
-- 252.99769592285, 220.96379089355, 101.68360137939 Heading: 166.93214416504
    ...
    DetachEntity(bomba, 1, 1)
    FreezeEntityPosition(bomba, true)
    TriggerServerEvent("desirerp-particleserverbaycity1", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomba)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("desirerp-firstdoorsbaycity")
end