...
RegisterNetEvent("desirerp-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("desirerp-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("desirerp-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("desirerp-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('desirerp-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("desirerp-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("desirerp-dirtymoney:alterDirtyMoney","ItemDrop",amount)
