...
function canRent()
    ...
    if isComplete and dist <= 3.0 then
        ...
        local canRent = RPC.execute("desirerp-housing:canRent", propertyId)
...
AddEventHandler("desirerp-housing:handler", function(data, cb)
...
Citizen.CreateThread(function()
    exports["desirerp-keybinds"]:registerKeyMapping("","Housing", "Interact", "+propertyInteract", "-propertyInteract", "E")
