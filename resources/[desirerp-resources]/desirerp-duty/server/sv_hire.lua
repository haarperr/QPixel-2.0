...
RegisterServerEvent("desirerp-duty:HireLaw")
AddEventHandler("desirerp-duty:HireLaw", function(cid, job, rank)
    local src = source
...
RegisterServerEvent("desirerp-duty:FireLaw")
AddEventHandler("desirerp-duty:FireLaw", function(cid)
    local src = source
    exports.oxmysql:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
...
RegisterServerEvent("desirerp-duty:HireEMS")
AddEventHandler("desirerp-duty:HireEMS", function(cid, rank)
    local src = source
...
RegisterServerEvent("desirerp-duty:FireEMS")
AddEventHandler("desirerp-duty:FireEMS", function(cid)
    local src = source
    exports.oxmysql:execute('SELECT * FROM characters WHERE id = @cid', {['@cid'] = cid}, function(result)
