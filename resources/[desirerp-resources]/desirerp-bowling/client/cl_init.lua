...
AddEventHandler("bp-bowling:RemoveItem" , function()
    if not exports["desirerp-inventory"]:hasEnoughOfItem("bowlingball",1,false) then return end
    if exports['desirerp-inventory']:hasEnoughOfItem('bowlingball', 1) then
        TriggerEvent("inventory:removeItem", "bowlingball", 1)
        Citizen.Wait(3000)
    end
    if not exports["desirerp-inventory"]:hasEnoughOfItem("bowlingreceipt",1,false) then return end
    if exports['desirerp-inventory']:hasEnoughOfItem('bowlingreceipt', 1) then
