...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("desirerp-fx:setSteamId")
end)
RegisterNetEvent("desirerp-fix:setSteamIdClient")
AddEventHandler("desirerp-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["desirerp-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
