$(document).ready(function(){
  ...
  $(".btnClose").click(function(){
      closeMain()
      $.post('http://desirerp-furniture/close', JSON.stringify({}));
  });
  ...
  $(".btnMove").click(function(){
      ...
      $(".SelectObject").css("display", "none");
      $.post('http://desirerp-furniture/scanObject', JSON.stringify({}));
  });

  $(".btnFree").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://desirerp-furniture/FreeCam', JSON.stringify({}));
  });
  ...
  $(".btnModify").click(function(){
      $(".wrapSelectObjects").css("display", "none");
      $(".SelectObject").css("display", "none");
      $.post('http://desirerp-furniture/newObject', JSON.stringify({}));
  ...
  $(".btnDelObj").click(function(){
    $.post('http://desirerp-furniture/DelSelectedObj', JSON.stringify({}));
  });
  ...
  $(".btnDel").click(function(){
      ...
      $.post('http://desirerp-furniture/DelObj', JSON.stringify({}));
  });

  $(".btnNextObj").click(function(){
    $.post('http://desirerp-furniture/NextObj', JSON.stringify({}));
  });
  $(".btnPrevObj").click(function(){
    $.post('http://desirerp-furniture/PrevObj', JSON.stringify({}));
  });
    ...
    if(item.redoCSS === true) {
      $('select').each(function(){
          ...
          $listItems.click(function(e) {
              ...
              $.post('http://desirerp-furniture/selectObject', JSON.stringify({selectObject: $this.val()}));
          });
