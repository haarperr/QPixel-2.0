...
exports["desirerp-polytarget"]:AddBoxZone("aspect_electrical_job_1", vector3(1695.93,2536.057,45.55283), 1, 1.8, {
    heading=270,
    minZ=41.77,
    maxZ=45.77
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("aspect_electrical_job_1", {
{
    event = "desirerp-jail:work-box-1",
...
RegisterNetEvent('desirerp-jail:work-box-1')
AddEventHandler('desirerp-jail:work-box-1', function()
    TriggerEvent("animation:PlayAnimation","welding")
    FreezeEntityPosition(PlayerPedId(), true)
    ElectricalJob1 = false
    local finished = exports['desirerp-taskbar']:taskBar(7500, 'Repairing Electrical Box')
    if finished == 100 then
        ElectricalJobInProgress = false
        FreezeEntityPosition(PlayerPedId(), false)
        TriggerServerEvent('desirerp-jail:removeTime', math.random(1, 3))
...
-- Electrical Job 2 
exports["desirerp-polytarget"]:AddBoxZone("aspect_electrical_job_2", vector3(1652.62, 2565.13, 45.56), 2, 3.4, {
    heading=0,
    minZ=42.96,
    maxZ=46.96
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("aspect_electrical_job_2", {
{
    event = "desirerp-jail:work-box-2",
...
RegisterNetEvent('desirerp-jail:work-box-2')
AddEventHandler('desirerp-jail:work-box-2', function()
    TriggerEvent("animation:PlayAnimation","welding")
    FreezeEntityPosition(PlayerPedId(), true)
...
-- Electrical Job 3 
exports["desirerp-polytarget"]:AddBoxZone("aspect_electrical_job_3", vector3(1630.0, 2565.25, 45.56), 2, 3.8, {
    heading=0,
    minZ=43.16,
    maxZ=47.16
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("aspect_electrical_job_3", {
{
    event = "desirerp-jail:work-box-3",
...
RegisterNetEvent('desirerp-jail:work-box-3')
AddEventHandler('desirerp-jail:work-box-3', function()
    TriggerEvent("animation:PlayAnimation","welding")
    FreezeEntityPosition(PlayerPedId(), true)
...
-- Electrical Job 4 
exports["desirerp-polytarget"]:AddBoxZone("aspect_electrical_job_4", vector3(1617.3387, 2578.6164, 45.552791), 2, 2.2, {  
    heading=270,
    minZ=43.36,
    maxZ=47.36
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("aspect_electrical_job_4", {
{
    event = "desirerp-jail:work-box-4",
...
RegisterNetEvent('desirerp-jail:work-box-4')
AddEventHandler('desirerp-jail:work-box-4', function()
    TriggerEvent("animation:PlayAnimation","welding")
    FreezeEntityPosition(PlayerPedId(), true)
...
-- Electrical Job 5 
exports["desirerp-polytarget"]:AddBoxZone("aspect_electrical_job_5", vector3(1630.5155, 2527.2539, 45.552795), 1, 1, {
    heading=315,
    minZ=42.77,
    maxZ=46.77
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("aspect_electrical_job_5", {
{
    event = "desirerp-jail:work-box-5",
...
RegisterNetEvent('desirerp-jail:work-box-5')
AddEventHandler('desirerp-jail:work-box-5', function()
    TriggerEvent("animation:PlayAnimation","welding")
    FreezeEntityPosition(PlayerPedId(), true)
...
-- Electrical Job 6 
exports["desirerp-polytarget"]:AddBoxZone("aspect_electrical_job_6", vector3(1655.8526, 2489.7385, 45.552795), 1, 1, {
    heading=315,
    minZ=42.77,
    maxZ=46.77
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("aspect_electrical_job_6", {
{
    event = "desirerp-jail:work-box-6",
...
RegisterNetEvent('desirerp-jail:work-box-6')
AddEventHandler('desirerp-jail:work-box-6', function()
    TriggerEvent("animation:PlayAnimation","welding")
    FreezeEntityPosition(PlayerPedId(), true)
...
-- Electrical Job 7 
exports["desirerp-polytarget"]:AddBoxZone("aspect_electrical_job_7", vector3(1657.6341, 2489.0827, 45.552795), 1, 1, {
    heading=315,
    minZ=42.76,
    maxZ=46.76
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("aspect_electrical_job_7", {
{
    event = "desirerp-jail:work-box-7",
...
RegisterNetEvent('desirerp-jail:work-box-7')
AddEventHandler('desirerp-jail:work-box-7', function()
    TriggerEvent("animation:PlayAnimation","welding")
    FreezeEntityPosition(PlayerPedId(), true)
...
-- Electrical Job 8 
exports["desirerp-polytarget"]:AddBoxZone("aspect_electrical_job_8", vector3(1666.4895, 2487.8957, 45.552833), 2, 2.2, {
    heading=275,
    minZ=43.36,
    maxZ=47.36
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("aspect_electrical_job_8", {
{
    event = "desirerp-jail:work-box-8",
...
RegisterNetEvent('desirerp-jail:work-box-8')
AddEventHandler('desirerp-jail:work-box-8', function()
    TriggerEvent("animation:PlayAnimation","welding")
    FreezeEntityPosition(PlayerPedId(), true)
...
RegisterNetEvent('desirerp-jail:electrical-get-job')
AddEventHandler('desirerp-jail:electrical-get-job', function()
...
RegisterNetEvent('desirerp-jail:startWatering')
AddEventHandler('desirerp-jail:startWatering', function()
    FreezeEntityPosition(PlayerPedId(), true)
    TriggerEvent('attachItem', 'wateringcan2')
    playPourAnimation(PlayerPedId())
    exports['desirerp-interface']:hideInteraction()
    local finished = exports['desirerp-taskbar']:taskBar(15000, 'Watering...')
    if finished == 100 then
        TriggerEvent('propattach:destroyCurrent')
        FreezeEntityPosition(PlayerPedId(), false)

        TriggerServerEvent('desirerp-jail:removeTime', math.random(1, 5))
        TriggerServerEvent("checkJailTime",true)
    else
        TriggerEvent('propattach:destroyCurrent')
        FreezeEntityPosition(PlayerPedId(), false)
...
RegisterNetEvent('desirerp-jail:getGardeningJob')
AddEventHandler('desirerp-jail:getGardeningJob', function()
...
Citizen.CreateThread(function()
    exports["desirerp-polyzone"]:AddBoxZone("gardening_zone_1", vector3(1707.39, 2482.55, 45.55), 5, 5, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("gardening_zone_2", vector3(1720.26, 2497.27, 45.55), 5, 5, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("gardening_zone_3", vector3(1734.79, 2506.41, 45.55), 5, 5, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("gardening_zone_4", vector3(1756.29, 2508.69, 45.55), 8, 5, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("gardening_zone_5", vector3(1707.99, 2550.01, 45.55), 10, 10, {
...
AddEventHandler('desirerp-polyzone:enter', function(name)
    if name == "gardening_zone_1" then
        ...
        if pGarden1 then
            CanWater()
            exports['desirerp-interface']:showInteraction('[E] Begin Watering.')
        end
        ...
        while pInZone1 or pInZone2 or pInZone3 or pInZone4 or pInZone5 do
            ...
            if IsControlJustReleased(0, 38) then
                if pGarden1 or pGarden2 or pGarden3 or pGarden4 or pGarden5 then
                    ...
                    TriggerEvent('desirerp-jail:startWatering')
                end
            end
		end
	end)
...
RegisterNetEvent('desirerp-jobs:jail-jobs:menu')
AddEventHandler('desirerp-jobs:jail-jobs:menu', function()
    local JailJobs = {
        {
            title = "Jail Jobs",
            key = "EVENTS.JAIL",
            children = {
                { title = "Start Electrical Job", action = "desirerp-jail:electrical", key = "EVENTS.JAIL" },
                { title = "Start Gardening Job", action = "desirerp-jail:getGardeningJob", key = "EVENTS.JAIL" },
            },
        },
    }
    exports["desirerp-interface"]:showContextMenu(JailJobs)
end)

RegisterInterfaceCallback('desirerp-jail:getGardeningJob', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' }})
    TriggerEvent('desirerp-jail:getGardeningJob')
end)

RegisterInterfaceCallback('desirerp-jail:electrical', function(data, cb)
	cb({ data = {}, meta = { ok = true, message = '' } })
    TriggerEvent('desirerp-jail:electrical-get-job')
end)
...
exports["desirerp-polytarget"]:AddCircleZone("start_jail_jobs",  vector3(1775.71, 2553.75, 45.55), 1.0, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("start_jail_jobs", {{
    event = "desirerp-jobs:jail-jobs:menu",
    id = "start_jail_jobs",
    icon = "circle",
    label = "Jail Jobs",
    parameters = {},
