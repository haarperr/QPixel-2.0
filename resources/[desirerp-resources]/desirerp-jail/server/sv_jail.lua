...
AddEventHandler('desirerp-jail:pBilledLog', function(pFineAmount, fined_player)
    ...
    local connect = {
      ...
      PerformHttpRequest("https://discord.com/api/webhooks/1012082458130383039/saKe3jMeCWz_Mwbh13U2oHywvlbf43E8uwHznsTyF75SYICNcvuAOX2ZGH4J-lR-Pd7p", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)