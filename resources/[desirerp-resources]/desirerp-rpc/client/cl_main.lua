...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('desirerp-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('desirerp-rpc:cl_response')
AddEventHandler('desirerp-rpc:cl_response', function(origin, callId, response)
