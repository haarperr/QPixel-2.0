...
RegisterNetEvent('desirerp-rpc:cl_request')
AddEventHandler('desirerp-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('desirerp-rpc:cl_response', src, origin, callId, response)
end)