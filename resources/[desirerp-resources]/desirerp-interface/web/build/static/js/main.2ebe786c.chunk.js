        ...
        var FT = function (SU) {
            ...
            return (
              Fl('uiMessage', function (ch) {
                ...
                'badge' === ch.app &&
                  ...
                  SQ(true),
                  setTimeout(function () {
                    Fd('desirerp-interface:closeApp', {}).then(function (cM) {
                      true === cM.meta.ok &&
                        Fd('desirerp-interface:applicationClosed', {
                          name: 'badge',
                          fromEscape: true,
                        }).then(function (cb) {
            ...
            Object(F4.useEffect)(
              function () {
                var cm = function (cs) {
                  Fg.includes(cs.code) &&
                    ('eye' === cv
                      ? Fd('desirerp-interface:closeApp', {}).then(function (cR) {
                          true === cR.meta.ok &&
                            Fd('desirerp-interface:applicationClosed', {
                              name: 'eye',
                              fromEscape: true,
                      ...
                      : 'clothing' === cv && Fd('desirerp-clothing:attemptClose'))
                }
                return (
          ...
          Fp = function (SU) {
            ...
            var cr = function (cB, ch, cO, cP, cN, cJ) {
              ...
              void 0 !== cB
                ? (void 0 !== cO && false !== cO) ||
                  Fd('desirerp-interface:closeApp', {}).then(function (cb) {
                    true === cb.meta.ok &&
                                    ...
                                    Object(FG.jsx)(Ff.a, {
                                      ...
                                      onClick: function () {
                                        return (
                                          ...
                                          (co = ct.parameters),
                                          void Fd(
                                            'desirerp-interface:targetSelectOption',
                                            {
                                              entity: cB,
                                              option: {
                                                event: cU,
                                      ...
                                      children: Object(FG.jsx)(S0.a, {
                                        onClick: function () {
                                          cM(true),
                                            cv(true),
                                            Fd(
                                              'desirerp-interface:getBankAccountsByStateID',
                                              { stateid: cR }
                                            ).then(function (cp) {
                                              cd('')
                                              cM(false)
                ...
                'range-picker' === c4.app &&
                  (true === c5.show
                    ? (Sx(true),
                      ...
                      void 0 !== c5.submitUrl
                        ? c3(c5.submitUrl)
                        : c3('desirerp-interface:rangePickerValues'))
                      ...
                      children: Object(FG.jsx)('div', {
                        children: Object(FG.jsx)(S0.a, {
                          onClick: function () {
                            ...
                            Fd('desirerp-interface:closeApp', {}).then(function (cw) {
                              true === cw.meta.ok &&
                                Fd(''.concat(c7), {
                                  key: cS,
                                  values: cZ,
                ...
                var cC = Object(Fs.a)(
                  FR.a.mark(function cQ(cx) {
                    var cA = {
                      ...
                      NmIgd: 'desirerp-interface:fetchContracts',
                      nChUi: 'Kanjo',
                      DfKlA: 'coquettec',
                                    ...
                                    Object(FG.jsxs)('div', {
                                      ...
                                      children: [
                                        Object(FG.jsx)('div', {
                                          children: Object(FG.jsx)(S0.a, {
                                            onClick: function () {
                                              Fd('desirerp-interface:saveSettings', {
                                                bg: cp,
                                              })
                                            },
                                            color: 'success',
          ...
          SV = function (SU) {
            ...
            var ak = function (aN) {
              Fd('desirerp-clothing:switchCameraMode', { name: aN })
            }
            Object(F4.useEffect)(function () {
              var aJ = function (aM) {
                'ArrowLeft' === aM.key &&
                  Fd('desirerp-clothing:rotateCamera', { direction: 'left' })
                'ArrowRight' === aM.key &&
                  Fd('desirerp-clothing:rotateCamera', { direction: 'right' })
                'a' === aM.key &&
                  Fd('desirerp-clothing:rotateCamera', { direction: 'left' })
                'd' === aM.key &&
                  Fd('desirerp-clothing:rotateCamera', { direction: 'right' })
            ...
            var aZ = function (aN) {
                aN > cw ||
                  (ck(aN),
                  Fd('desirerp-clothing:updateClothing', {
                    id: aN,
                    type: 'hair',
                  }))
              },
                              ...
                              children: Object(FG.jsxs)(SZ.a, {
                                ...
                                children: [
                                  ...
                                  Object(FG.jsx)(S0.a, {
                                    onClick: function () {
                                      c4(false)
                                      Fd('desirerp-interface:closeApp', {}).then(
                                        function (aJ) {
                                          true === aJ.meta.ok &&
                                            Fd(
                                              'desirerp-interface:applicationClosed',
                                              {
                                                name: 'clothing',
                                                fromEscape: true,
                                              }
