...
RegisterNetEvent("desirerp-interface:open-application")
AddEventHandler("desirerp-interface:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("desirerp-interface:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("desirerp-interface:soundPlay")
AddEventHandler("desirerp-interface:soundPlay", function(name, volume, loop)
