...
function RequestSirenStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('desirerp-vehicleSync:updateSirenState', netId, sirenState, sirenPreset)
    end)
end
...
RegisterNetEvent('desirerp-vehicleSync:updateSirenState')
AddEventHandler('desirerp-vehicleSync:updateSirenState', function(pNetId, pSirenState, pSirenPreset)
...
Citizen.CreateThread(function()
    exports["desirerp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Lights", "+toggleSirenLights", "-toggleSirenLights", "Q")
    exports["desirerp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Turn On/Off Sound", "+toggleSiren", "-toggleSiren", "LMENU")
    exports["desirerp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren Cycle Sound", "+cycleSiren", "-cycleSiren", "R")
    exports["desirerp-keybinds"]:registerKeyMapping("", "Vehicle", "Siren AirHorn", "+sirenAirHorn", "-sirenAirHorn", "E")
end)