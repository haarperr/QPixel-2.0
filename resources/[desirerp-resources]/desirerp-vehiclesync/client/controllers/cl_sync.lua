...
function SetEngineSound(pVehicle)
    local sound = exports['desirerp-vehicles']:GetVehicleAfterMarket(pVehicle, 'engineSound')
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('desirerp-vehicleSync:updateSyncState', netId, syncState)
    end)
end
...
RegisterNetEvent('desirerp-vehicleSync:updateSyncState')
AddEventHandler('desirerp-vehicleSync:updateSyncState', function(pNetId, pSyncState)
...
RegisterNetEvent('desirerp-vehicles:spawnedGarageVehicle')
AddEventHandler('desirerp-vehicles:spawnedGarageVehicle', function(pNetId, pModel)
    Citizen.Wait(1000)
    ...
    local afterMarkets = exports['desirerp-vehicles']:GetVehicleAfterMarket(vehicle)
...
Citizen.CreateThread(function()
    exports["desirerp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights", "-toggleNeonLights")
    exports["desirerp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator", "-toggleRightIndicator")
    exports["desirerp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator", "-toggleLeftIndicator")
    exports["desirerp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights", "-toggleHazardLights")
end)