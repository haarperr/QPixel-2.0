...
RegisterNUICallback('wenmoSubmit', function(data)
    ...
    TriggerServerEvent('desirerp-phone:transferWenmo',num,amount,comment)
end)

RegisterNUICallback("desirerp-phone:getWenmo", function(data, cb)
    local success, message = RPC.execute("desirerp-phone:getWenmo")
    local wenmo = {}
