...
RPC.register("desirerp-phone:getIdleGroup", function(source)
    local src = source
    local idle = {}
...
RPC.register("desirerp-phone:getMyGroup", function(source)
    local src = source
    local idle = {}
    local g = MySQL.query.await([[
        SELECT * FROM job_group
...
RPC.register("desirerp-phone:c_group", function(source)
    local src = source
...
RPC.register("desirerp-phone:j_group", function(source, id)
    local src = source
    local user = exports["desirerp-base"]:getModule("Player"):GetUser(src)
...
RPC.register("desirerp-phone:get_groupsMem", function(source, id)
...
RPC.register('desirerp-phone:g_ready', function(source,stat,id)
    local src = source
...
RPC.register('desirerp-phone:leave_group', function(source,id)
    local src = source
    local gId = id.param
...
--         end
--       end
--     --   TriggerLatentClientEvent('mhdesirerp-housing:collectHouses', -1, 30000, Houses)
--     end)
-- end)