RPC.register("desirerp-phone:submitNewEventDiamondSports", function(pSource, pEventName, pEventLocation, pTimeZone, pEventTimeHr, pEventTimeMin, pEventDate)
...
RPC.register("desirerp-phone:getDiamondSportsEvents", function(pSource)
...
RPC.register("desirerp-phone:deleteDiamondEvent", function(pSource, pID)
