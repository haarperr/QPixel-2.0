...
--   })
    ...
    exports["desirerp-textdisplay"]:HideText()
  end
end
...
RegisterInterfaceCallback("desirerp-interface-slotmachines:placeBet", function(data, cb)
  ...
  exports["desirerp-interface"]:hideContextMenu(data)
  ...
  if currentSlotMachine and not isSlotMachineSpinning then
    ...
    if not exports["desirerp-inventory"]:hasEnoughOfItem("redchip", currentBet, false, true) then 
    ...
    local title = "Slot Machine - " .. currentSlotMachineLabel
    --local balance = RPC.execute("desirerp-casino:getCurrentChipCount")
    local balance = exports["desirerp-inventory"]:getQuantity("redchip")
    --local values = {}
    --table.insert(values, "Balance: $" .. balance)
      exports["desirerp-textdisplay"]:DisplayText({
      header = title,
