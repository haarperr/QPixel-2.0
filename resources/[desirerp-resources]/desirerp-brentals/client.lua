RegisterNetEvent('desirerp-bikerent:menu')
AddEventHandler('desirerp-bikerent:menu', function()                           
  TriggerEvent('desirerp-context:sendMenu', {
        ...
        },
        {
			...
			params = {
                event = "desirerp-bikerent:checkmoney",
                args = {
                    car = Config.bike1,
...
RegisterNetEvent('desirerp-bikerent:checkmoney')
AddEventHandler('desirerp-bikerent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("desirerp-bikerent:hasmoney", price, vehicle)

end)

RegisterNetEvent('desirerp-bikerent:spawnbike')
AddEventHandler('desirerp-bikerent:spawnbike', function(vehicleName)                            
