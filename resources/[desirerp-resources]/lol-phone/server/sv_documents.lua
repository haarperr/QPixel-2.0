...
local documents = {}
RPC.register('desirerp-phone:getDocuments', function(pSource, pType)
...
RegisterNetEvent("desirerp-phone:checkForNonDocumentedLicenses", function(pCid)
    local sex = "sex"
...
RPC.register("desirerp-phone:shareDocumentPermanent", function(pSource, dID, tCID)
...
RPC.register("desirerp-phone:acceptDocumentReceiveRequest", function(pSource, pDocumentID)
    local doc = MySQL.query.await([[
        SELECT * FROM __documents WHERE id = ?
    ]], {pDocumentID})
...
RPC.register('desirerp-phone:deleteDocument', function(pSource, pId)
    exports.oxmysql:execute("DELETE FROM __documents WHERE id = ?",{pId})
end)

RPC.register('desirerp-phone:updateDocument', function(pSource, pId, pTitle, pText)
...
RPC.register("desirerp-phone:createDocument", function(pSource, pOwner, pTitle, pText, pType)
    MySQL.query.await([[
