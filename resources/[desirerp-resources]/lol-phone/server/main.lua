...
RPC.register("desirerp-phone:getPhoneNumber", function(pSource)
...
RPC.register("desirerp-phone:sendThePM", function(src, msg)
...
RPC.register("desirerp-phone:getChips", function(pSource)
    local src = source
    local user = exports["desirerp-base"]:getModule("Player"):GetUser(src)
    local char = user:getVar("character")
    local id = char.id
