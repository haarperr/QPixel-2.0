...
function loadSMS(cid)
  print("LOAD SMS")
  local messages, phone = RPC.execute("desirerp-phone:getSMS",cid)
  local _messages = {}
...
function loadSMSBurner(cid)
  print("LOAD SMS")
  local messages, phone = RPC.execute("desirerp-phone:getTextsFromNumber",cid)
  local _messages = {}
  for i, v in ipairs(messages) do
      local name = ""
...
local data = message
local app = "sms"
if exports["desirerp-phone"]:phasPhone() then
  if exports['desirerp-phone']:pNotify() == true then
