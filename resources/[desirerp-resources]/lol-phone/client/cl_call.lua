...
RegisterNUICallback('getCallHistory', function()
  local recentCallHistory = RPC.execute("desirerp-phone:getRecentCallsByCid", exports['isPed']:isPed("cid"))
  SendNUIMessage({
...
Citizen.CreateThread(function()
  while true do
    Wait(10000)
    TriggerServerEvent("desirerp-phone:sendRecentCalls", recentcalls, exports['isPed']:isPed("cid"))
  end
end)
