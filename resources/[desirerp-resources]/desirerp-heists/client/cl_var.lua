RegisterNetEvent('desirerp-heists:door_thermite')
AddEventHandler('desirerp-heists:door_thermite', function()
    TriggerServerEvent('desirerp-heists:thermite_var')
end)

RegisterNetEvent('desirerp-heists:var_door_to_lobby')
AddEventHandler('desirerp-heists:var_door_to_lobby', function()
    local player = GetEntityCoords(PlayerPedId())
    local distance = #(vector3(-209.2301, -303.5382, 74.482246) - player)
    if distance < 1.5 then
        if exports["desirerp-inventory"]:hasEnoughOfItem("thermal_charge", 1) then
            TriggerEvent('desirerp-hud:show_hackerman')
            LobbyDoor()
            exports['desirerp-thermite']:OpenThermiteGame(function(success)
                if success then
                    TriggerServerEvent('desirerp-heists:var_thermite')
                    TriggerEvent('desirerp-hud:hide_hackerman')
                    TriggerEvent("inventory:removeItem", "thermal_charge", 1)
                    TriggerServerEvent('desirerp-doors:change-lock-state', 573, false) 
                    Citizen.Wait(3000)
...
exports["desirerp-polytarget"]:AddCircleZone("var_computer_1",  vector3(-212.7, -298.21, 74.49), 0.35, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_computer_1", {
    {
        event = "desirerp-heists:var_event_1",
        id = "var_computer_1",
        icon = "user-secret",
...
RegisterNetEvent('desirerp-heists:var_event_1')
AddEventHandler('desirerp-heists:var_event_1', function()
    TriggerServerEvent('desirerp-heists:in_var_1_srv')
end)

RegisterNetEvent('desirerp-heists:enter_var_location_1')
AddEventHandler('desirerp-heists:enter_var_location_1', function()
    if exports['desirerp-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
...
exports["desirerp-polytarget"]:AddCircleZone("var_computer_2",  vector3(-211.2, -301.14, 74.49), 0.45, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_computer_2", {
    {
        event = "desirerp-heists:var_event_2",
        id = "var_computer_2",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('desirerp-heists:var_event_2')
AddEventHandler('desirerp-heists:var_event_2', function()
    TriggerServerEvent('desirerp-heists:in_var_2_srv')
end)

RegisterNetEvent('desirerp-heists:enter_var_location_2')
AddEventHandler('desirerp-heists:enter_var_location_2', function()
    if exports['desirerp-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["desirerp-polytarget"]:AddCircleZone("var_computer_3",  vector3(-206.6, -297.19, 74.49), 0.45, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_computer_3", {
    {
        event = "desirerp-heists:var_event_3",
        id = "var_computer_3",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('desirerp-heists:var_event_3')
AddEventHandler('desirerp-heists:var_event_3', function()
    TriggerServerEvent('desirerp-heists:in_var_3_srv')
end)

RegisterNetEvent('desirerp-heists:enter_var_location_3')
AddEventHandler('desirerp-heists:enter_var_location_3', function()
    if exports['desirerp-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["desirerp-polytarget"]:AddCircleZone("var_computer_4",  vector3(-207.02, -294.14, 74.49), 0.5, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_computer_4", {
    {
        event = "desirerp-heists:var_event_4",
        id = "var_computer_4",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('desirerp-heists:var_event_4')
AddEventHandler('desirerp-heists:var_event_4', function()
    TriggerServerEvent('desirerp-heists:in_var_4_srv')
end)

RegisterNetEvent('desirerp-heists:enter_var_location_4')
AddEventHandler('desirerp-heists:enter_var_location_4', function()
    if exports['desirerp-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["desirerp-polytarget"]:AddCircleZone("var_computer_5",  vector3(-209.4, -293.28, 74.49), 0.4, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_computer_5", {
    {
        event = "desirerp-heists:var_event_5",
        id = "var_computer_5",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('desirerp-heists:var_event_5')
AddEventHandler('desirerp-heists:var_event_5', function()
    TriggerServerEvent('desirerp-heists:in_var_5_srv')
end)

RegisterNetEvent('desirerp-heists:enter_var_location_5')
AddEventHandler('desirerp-heists:enter_var_location_5', function()
    if exports['desirerp-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
AddEventHandler('varhack:1', function()
    exports['desirerp-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('desirerp-heists:hackfalse')
        else
...
TriggerServerEvent('desirerp-heists:hack1')
end)


exports["desirerp-polytarget"]:AddCircleZone("var_hack1",  vector3(2167.94, 2925.92, -81.38), 0.5, {
    useZ = true
})


exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_hack1", {
    {
...
AddEventHandler('varhack:2', function()
    exports['desirerp-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('desirerp-heists:hackfalse2')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail1')
          print("lol")
...
TriggerServerEvent('desirerp-heists:hack2')
end)

exports["desirerp-polytarget"]:AddCircleZone("var_hack2",  vector3(2135.66, 2901.72, -84.27), 0.53, {
    useZ = true
})


exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_hack2", {
    {
...
AddEventHandler('varhack:3', function()
    exports['desirerp-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('desirerp-heists:hackfalse3')
          print("working?")
        else
...
TriggerServerEvent('desirerp-heists:hack3')
end)

exports["desirerp-polytarget"]:AddCircleZone("var_hack3",  vector3(2171.24, 2927.76, -81.38), 0.41, {
    useZ = true
})


exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_hack3", {
    {
...
AddEventHandler('varhack:4', function()
    exports['desirerp-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped')
            TriggerServerEvent('desirerp-heists:hackfalse4')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail2')
          print("basarisiz")
...
TriggerServerEvent('desirerp-heists:hack4')
end)

exports["desirerp-polytarget"]:AddCircleZone("var_hack4",  vector3(2087.82, 2946.72, -84.22), 0.53, {
    useZ = true
})


exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_hack4", {
    {
...
AddEventHandler('varhack:5', function()
    exports['desirerp-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped2')
            TriggerServerEvent('desirerp-heists:hackfalse5')
          print("working?")
        else
...
TriggerServerEvent('desirerp-heists:hack5')
end)

exports["desirerp-polytarget"]:AddCircleZone("var_hack5",  vector3(2174.89, 2927.76, -81.38), 0.4, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_hack5", {
    {
...
AddEventHandler('varhack:6', function()
    exports['desirerp-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('desirerp-heists:hackfalse6')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail')
          print("basarisiz")
...
TriggerServerEvent('desirerp-heists:hack6')
end)

exports["desirerp-polytarget"]:AddCircleZone("var_hack6",  vector3(2327.77, 2945.95, -84.47), 0.55, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_hack6", {
    {
...
AddEventHandler('varhack:7', function()
    exports['desirerp-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped2')
            TriggerServerEvent('desirerp-heists:hackfalse7')
...
if exports["desirerp-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('desirerp-heists:hack7')
end 
end)

exports["desirerp-polytarget"]:AddCircleZone("var_hack7",  vector3(2185.9, 2913.24, -84.8), 0.5, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_hack7", {
    {
...
AddEventHandler('varhack:8', function()
    exports['desirerp-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped')
            TriggerServerEvent('desirerp-heists:hackfalse8')
            TriggerEvent("inventory:removeItem", "varusb", 1)
...
if exports["desirerp-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('desirerp-heists:hack8')
end 
end)

exports["desirerp-polytarget"]:AddCircleZone("var_hack8",  vector3(2185.94, 2928.69, -84.8), 0.5, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("var_hack8", {
    {
...
exports["desirerp-polytarget"]:AddCircleZone("leave",  vector3(2156.4, 2922.22, -81.08), 0.5, {
    useZ = true
})

exports["desirerp-interact"]:AddPeekEntryByPolyTarget("leave", {
    {
...
TriggerServerEvent('desirerp-leavevar2')
end)
...
RegisterNetEvent('desirerp-heists:loot_peds')
AddEventHandler('desirerp-heists:loot_peds', function()
...
RegisterNetEvent('desirerp-heists:var_loot_ped')
AddEventHandler('desirerp-heists:var_loot_ped', function()
    if isPlayerInVar == 1 then
        TriggerEvent('desirerp-heists:loot_peds')
        TriggerServerEvent('desirerp-var:lootcooldown')
    else
        print('cooldown')
    end
end)

RegisterNetEvent('desirerp-heists:svclientloot')
AddEventHandler('desirerp-heists:svclientloot', function()
    TriggerServerEvent('desirerp-evannicxvar:varlootcooldown')
end)

function removevarmedkits()
    local qty = exports["desirerp-inventory"]:getQuantity("varmedkit")
  ...
  function removevpistolammo()
    local qty = exports["desirerp-inventory"]:getQuantity("pistolammo")
    if qty and qty > 0 then
  ...
  function removevsubammo()
    local qty = exports["desirerp-inventory"]:getQuantity("subammo")
    if qty and qty > 0 then
  ...
  function removevrifleammo()
    local qty = exports["desirerp-inventory"]:getQuantity("rifleammo")
    if qty and qty > 0 then
