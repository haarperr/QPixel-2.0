RegisterNetEvent('desirerp-heists:checkAvailability')
AddEventHandler('desirerp-heists:checkAvailability', function() 
    ...
    exports["desirerp-interface"]:showContextMenu(FatCunt)
end)

RegisterNetEvent('desirerp-heists:purchaseHeistEquipment')
AddEventHandler('desirerp-heists:purchaseHeistEquipment', function()
    local HeistEquipment = {
		{
            ...
            children = {
                ...
                action = "desirerp-heists:purchaseGreenLaptop",
            },
        },
        {
            title = "Paleto Laptop",
            ...
            children = {
                ...
                action = "desirerp-heists:purchaseBlueLaptop",
            },
        },
    }
...
RegisterInterfaceCallback('desirerp-heists:purchaseGreenLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['desirerp-inventory']:hasEnoughOfItem('heistusb5', 1) then
        TriggerEvent('inventory:removeItem', 'heistusb5', 1)
        TriggerEvent("player:receiveItem", "heistlaptop3", 1)
    end
end)

RegisterInterfaceCallback('desirerp-heists:purchaseBlueLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['desirerp-inventory']:hasEnoughOfItem('heistusb1', 1) then
