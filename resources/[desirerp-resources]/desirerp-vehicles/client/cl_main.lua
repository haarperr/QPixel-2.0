...
AddEventHandler("mech:tools", function(material, amount)
    ...
    if exports["desirerp-inventory"]:hasEnoughOfItem(material, amount,false) then
...
AddEventHandler("mech:tools:cl2", function(input, input2)
    local isEmployedTuner = exports["desirerp-business"]:IsEmployedAt("tuner_shop")
    local isEmployedHayes = exports["desirerp-business"]:IsEmployedAt("hayes_autos")
    local isEmployedOttos = exports["desirerp-business"]:IsEmployedAt("ottos_autos")
    local isEmployedHarmony = exports["desirerp-business"]:IsEmployedAt("harmony_repairs")
    ...
    if isEmployedTuner or isEmployedHayes or isEmployedOttos or isEmployedHarmony then
        if tuner_internalz or hayes_internalz or ottos_internalz or harmony_internalz  then
            ...
            if amount <= 10 then
                ...
                if exports['desirerp-inventory']:hasEnoughOfItem(itemname, amount) then
                    ...
                    local finished = exports["desirerp-taskbar"]:taskBar(5000, "Repairing...")
    ...
    if isEmployedTuner or isEmployedHayes or isEmployedOttos or isEmployedHarmony then
        if tuner_internalz or hayes_internalz or ottos_internalz or harmony_internalz  then
            exports['desirerp-interface']:openApplication('textbox', {
                callbackUrl = 'desirerp-vehicles:repair:part',
                key = 1,
                items = {
                    {
                        icon = "toolbox",
...
RegisterInterfaceCallback('desirerp-vehicles:repair:part', function(data, cb)
...
Citizen.CreateThread(function()
    -- Tuner --
    exports["desirerp-polyzone"]:AddBoxZone("tuner_shop_zone", vector3(138.56, -3033.86, 7.03), 30, 30, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("hayes_autos_zone", vector3(-1419.09, -446.42, 35.9), 15, 23.2, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("ottos_autos_zone", vector3(829.81, -813.39, 26.33), 15, 20.0, {
    ...
    exports["desirerp-polyzone"]:AddBoxZone("harmony_repairs_zone", vector3(1177.6, 2639.84, 37.75), 10, 13.0, {
