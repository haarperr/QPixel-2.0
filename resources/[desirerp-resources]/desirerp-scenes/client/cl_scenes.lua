...
RegisterNetEvent("desirerp-scenes:allScenes")
AddEventHandler("desirerp-scenes:allScenes", function(scenes)
  activeScenes = scenes
end)

RegisterNetEvent("desirerp-scenes:refreshScenes")
AddEventHandler("desirerp-scenes:refreshScenes", function(sceneId, scene)
...
RegisterNetEvent("desirerp-scenes:deleteScene")
AddEventHandler("desirerp-scenes:deleteScene", function(removeId)
  if removeId then
...
function calculateScenesToDraw()
  ...
  local isPeekActive = exports['desirerp-interact']:IsPeeking()
...
RegisterInterfaceCallback("desirerp-ui:scenes:input", function(data, cb)
...
RegisterCommand("+startScene", function()
  if sceneStarted then
    ...
    exports['desirerp-interface']:openApplication('textbox', {
      callbackUrl = 'desirerp-ui:scenes:input',
      key = 1,
      items = {
        {
          icon = "pencil-alt",
...
RegisterCommand("+deleteScene", function()
  ...
  TriggerServerEvent("desirerp-scenes:deleteScene", GetEntityCoords(PlayerPedId()))
end, false)
RegisterCommand("-deleteScene", function() end, false)

Citizen.CreateThread(function()
  exports["desirerp-keybinds"]:registerKeyMapping("", "Scenes", "Start / Place Scene", "+startScene", "-startScene")
  exports["desirerp-keybinds"]:registerKeyMapping("", "Scenes", "Enable / Disable", "+enableScene", "-enableScene")
  exports["desirerp-keybinds"]:registerKeyMapping("", "Scenes", "Delete Closest Scene", "+deleteScene", "-deleteScene")
  RequestStreamedTextureDict('commonmenu', true)
  Wait(5000)
  TriggerServerEvent("desirerp-scenes:getScenes")
end)