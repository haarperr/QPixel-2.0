...
AddEventHandler("desirerp-ui:voice:setvoiceRange", function(proximity)
    sendAppEvent("hud", {
...
AddEventHandler("desirerp-ui:voice:setRadioActive", function()
    sendAppEvent("hud", {
        voiceActive = false,
...
AddEventHandler("desirerp-ui:voice:setRadioActiveFinished", function()
    sendAppEvent("hud", {
        voiceActive = false,
