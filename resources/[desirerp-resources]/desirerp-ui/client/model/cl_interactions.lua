...
AddEventHandler("interactions", function(zone, data)
            exports["desirerp-interface"]:showInteraction("Shared PD")
end)
...
RegisterCommand("testcontextmenu", function()
    local menuData = {
        ...
        },
        {
            ...
            key = "EVENTS.EVIDENCE",
            children = {
                { title = "Confirm Purchase", action = "desirerp-interface:rentalPurchase", key = "EVENTS.EVIDENCE" },
            },
        },
        {
            title = "Trash",
        ...
        },
        {
            ...
            key = "EVENTS.SWITCHER",
            children = {
                { title = "Confirm Purchase", action = "desirerp-interface:rentalPurchase", key = "EVENTS.SWITCHER" },
            },
        },
    }
...
-- Show Interaction
-- exports["desirerp-interface"]:showInteraction(msg,type)
