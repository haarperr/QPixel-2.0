...
exports['desirerp-ui']:openApplication('textbox', {
    callbackUrl = 'desirerp-ui:scenes:input', -> callbackUIName
    key = 1,
    items = {
        {
...
RegisterUICallback("desirerp-ui:scenes:input", function(data, cb)
    ...
    local data = {
        {
            ...
            key = true,
            children = {
				{ title = "Confirm Purchase", action = "desirerp-ui:wheelchairPurchase", key = true }, -> action is name of UICallback
			},
        },
    }
...
RegisterUICallback("desirerp-ui:wheelchairPurchase", function(data, cb)
...
####
exports["desirerp-ui"]:taskBarSkill(timer, skillGapSent)
####
...
###
exports["desirerp-ui"]:sendAppEvent("game", {
    modeDev = true / false,
