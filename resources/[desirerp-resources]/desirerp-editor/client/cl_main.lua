...
RegisterNetEvent("desirerp-editor:loadEditor")
AddEventHandler("desirerp-editor:loadEditor", function(data)
    loadEditor(data)
end)
...
AddEventHandler('__cfx_nui:close_ui', function(data, callback)
    ...
    TriggerEvent("desirerp-editor:closeEditor",CURRENT_NAME)
    closingUI()
    menuOpen = false
    clearSpecial()
    destroyZone()
