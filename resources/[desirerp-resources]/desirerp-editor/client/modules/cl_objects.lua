...
RegisterNetEvent("desirerp-editor:buildName")
AddEventHandler("desirerp-editor:buildName", function(name, objects)
    if objects then
...
RegisterNetEvent("desirerp-editor:destroyName")
AddEventHandler("desirerp-editor:destroyName", function(name)
    cleanUpArea(name)
