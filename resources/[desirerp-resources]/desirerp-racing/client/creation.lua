...
function startRaceCreation(options)
    ...
    while raceName ~= nil and options.raceName == nil and RPC.execute("desirerp-racing:isRaceNameTaken", raceName) == true do
...
function finishRaceCreation()
    ...
    TriggerServerEvent("desirerp-racing:recieveCreateData", raceName, raceType, raceThumbnail, checkpoints)
...
RegisterNetEvent("desirerp-racing:cmd:racecreate")
AddEventHandler("desirerp-racing:cmd:racecreate", function(options)
    if GetVehiclePedIsIn(PlayerPedId(), false) ~= 0 then
        startRaceCreation(options)
    end
end)

RegisterNetEvent("desirerp-racing:cmd:racecreatedone")
AddEventHandler("desirerp-racing:cmd:racecreatedone", function()
    finishRaceCreation()
end)

RegisterNetEvent("desirerp-racing:cmd:racecreatecancel")
AddEventHandler("desirerp-racing:cmd:racecreatecancel", function()
    cancelRaceCreation()
end)
