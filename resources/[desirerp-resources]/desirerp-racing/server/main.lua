...
RPC.register("desirerp-racing:getAllRaces", function(pSrc)
    local src = pSrc
...
RegisterNetEvent('desirerp-racing:allRaces')
AddEventHandler('desirerp-racing:allRaces', function()
    local allRaces = {
        races = Races,
        pendingRaces = PendingRaces,
        activeRaces = ActiveRaces,
    ...
    TriggerEvent('desirerp-phone:allRaces', allRaces) 
end)
...
RPC.register("desirerp-racing:awardPlayer", function(pSrc, pAmt)
...
Citizen.CreateThread(function()
    ...
    Wait(100)
    TriggerEvent('desirerp-racing:allRaces')
end)

RPC.register('desirerp-racing:setAlias', function(src, usedItemIds, usedItemSlots, usedItemMetadatas, aliass)
...
RPC.register('desirerp-racing:giveRacingUSB', function(pSource)
