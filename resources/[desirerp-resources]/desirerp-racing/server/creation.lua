RegisterNetEvent("desirerp-racing:recieveCreateData")
AddEventHandler("desirerp-racing:recieveCreateData", function(pRaceName, pRaceType, pRaceThumbnail, pCheckpoints)
    local src = source
    ...
    TriggerClientEvent("desirerp-racing:addedRace", -1, {}, Races)
    TriggerClientEvent("DoLongHudText", src, "Race " .. pRaceName .. " created!")
end)

RPC.register("desirerp-racing:isRaceNameTaken", function(src, pRaceName)
