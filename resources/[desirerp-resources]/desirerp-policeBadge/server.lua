RegisterServerEvent("desirerp-policeBadge:showBadge")
AddEventHandler("desirerp-policeBadge:showBadge", function()
  local src = source
  local src = source
  local user = exports['desirerp-base']:GetModule('GetPlayer')(src)
