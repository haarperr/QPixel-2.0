;(function () {
    ...
    !(function () {
      ...
      _0x38b1ca.Events.onNet(
        'desirerp-bulletclub:gameStarted',
        (_0x5ad20c, _0x4fdc60, _0x5884b1) => {
          return _0x278f2e(_0x5ad20c, _0x4fdc60, _0x5884b1)
        }
      )
      _0x38b1ca.Events.on('desirerp-bulletclub:startGame', () => {
        const _0x3c9078 = GetPlayerServerId(PlayerId())
        return _0x38b1ca.Events.emitNet('desirerp-bulletclub:startGame', _0x3c9078)
      })
      _0x38b1ca.Events.on('desirerp-bulletclub:modifySettings', () => {
        return _0x12898d()
      })
      _0x38b1ca.Events.on('desirerp-bulletclub:viewLeaderBoard', (_0x11fb49) => {
        _0x4890c3(_0x11fb49.type)
      })
      _0x38b1ca.Events.onNet('desirerp-bulletclub:getWeapon', () => {
        _0xc88e74()
      })
      _0x38b1ca.Events.on('desirerp-bulletclub:resetGameState', () => {
        _0x38b1ca.Events.emitNet('desirerp-bulletclub:resetGameState')
      })
      _0x38b1ca.Events.onNet('desirerp-bulletclub:gameReset', () => {
        _0x1ed868()
      })
      RegisterInterfaceCallback(
        'desirerp-bulletclub:purchaseWeapon',
        (_0x396fca, _0x3c4f20) => {
          const _0x4470e0 = {
              ok: true,
              message: 'done',
      ...
      onNet('desirerp-bulletclub:updateHud', (_0x21a871) => {
        ...
        _0x518d14.g.exports['desirerp-interface'].sendAppEvent('status-hud', _0x2caba9)
      })
      onNet('current-items', () => {
        if (_0x3d9643('bullet_club')) {
          return
      ...
      const _0x3af51e = [
          ...
          const _0x5a8970 = setInterval(() => {
            ...
            if (_0x2b4ee2 && IsEntityDead(_0x2b4ee2)) {
              if (GetPedSourceOfDeath(_0x2b4ee2) === PlayerPedId()) {
                _0x576290 += 1
                _0x38b1ca.Events.emitNet('desirerp-bulletclub:targetKilled')
              }
              ...
              _0x38b1ca.Events.emitNet(
                'desirerp-bulletclub:updateEnemiesRemaining',
                _0x4618e2.length
              )
            }
            ...
            if (
              ...
              _0x38b1ca.Events.emitNet(
                'desirerp-bulletclub:gameCompleted',
                _0x5743e6,
                _0x576290
              )
              _0x38b1ca.Events.emitNet(
        ...
        _0x12898d = async () => {
          ...
          const _0x39fa20 = {
            ...
            _0x42dcf0 = await _0x518d14.g.exports['desirerp-interface'].OpenInputMenu(
              _0x1253f2
            )
          if (!_0x42dcf0) {
            return
          ...
          _0x38b1ca.Events.emitNet('desirerp-bulletclub:updateSettings', _0x4090bb)
        },
        _0x4890c3 = async (_0x566cdf) => {
          const _0x24f0f5 = await _0x38b1ca.Procedures.execute(
              'desirerp-bulletclub:getLeaderBoard',
              _0x566cdf
            ),
          ...
          _0x518d14.g.exports['desirerp-interface'].showContextMenu(_0x3cbfda)
        },
        _0xc88e74 = () => {
          const _0x18d817 = [],
            _0x349ca3 = {
          ...
          for (const _0x1ba8b2 of _0xf2c705) {
            const _0xfe183a = {
              ...
              action: 'desirerp-bulletclub:purchaseWeapon',
              key: { weapon: _0x1ba8b2.item },
            }
            _0x18d817.push(_0xfe183a)
          }
          _0x518d14.g.exports['desirerp-interface'].showContextMenu(_0x18d817)
        },
        _0x450127 = () => {
          let _0x3110c1 = false
      ...
      on('desirerp-polyzone:enter', (_0x27dff7) => {
        _0x1b1ac3.add(_0x27dff7)
      })
      on('desirerp-polyzone:exit', (_0x40fc2) => {
        _0x1b1ac3.delete(_0x40fc2)
      })
      on('desirerp-polyzone:enter', (_0x38da11) => {
        if (_0x38da11 !== 'bullet_club') {
          return
        }
        _0x38b1ca.Events.emitNet('desirerp-bulletclub:enteredBuilding')
        SetPedInfiniteAmmoClip(PlayerPedId(), true)
      })
      on('desirerp-polyzone:exit', (_0x587634) => {
        if (_0x587634 !== 'bullet_club') {
          return
        }
        _0x518d14.g.exports['desirerp-interface'].sendAppEvent('status-hud', _0x208bee)
      ...
      const _0x17f261 = (_0x218b36, _0x336906) => {
        ...
        _0x1a5e7c = () => {
          ...
          const _0x3d9631 = {
            ...
            _0x20c227 = {
              ...
              minZ: 18.43,
              maxZ: 22.83,
              zoneEvents: 'desirerp-bulletclub:updateHud',
              data: { id: 'bullet_club' },
              debugPoly: false,
            }
          _0x518d14.g.exports['desirerp-polyzone'].AddBoxZone(
            'bullet_club',
            _0x3d9631,
            22.9,
            24.6,
          ...
          _0x518d14.g.exports['desirerp-polytarget'].AddBoxZone(
        ...
        _0x35dc5b = () => {
          ...
          const _0x4c168d = {
              APXEvent: 'desirerp-bulletclub:startGame',
              id: 'bullet_club_start',
              icon: 'play',
              label: 'Start Game ($500)',
            },
            _0x47f55f = { distance: { radius: 3.5 } }
          _0x518d14.g.exports['desirerp-interact'].AddPeekEntryByPolyTarget(
            'bullet_club_controls',
            [_0x4c168d],
            _0x47f55f
          )
          const _0x51840 = {
            APXEvent: 'desirerp-bulletclub:resetGameState',
          ...
          const _0x7be691 = {
            APXEvent: 'desirerp-bulletclub:modifySettings',
          ...
          const _0x4acabc = {
            APXEvent: 'desirerp-bulletclub:getWeapon',
          ...
          const _0x5b2891 = {
              APXEvent: 'desirerp-bulletclub:viewLeaderBoard',
