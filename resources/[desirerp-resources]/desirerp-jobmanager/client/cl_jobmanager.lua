...
AddEventHandler("desirerp-jobmanager:playerBecameJob", function(job, name, notify)
   ...
   -- TriggerServerEvent("desirerp-items:updateID",job,exports["isPed"]:retreiveBusinesses())
end)

RegisterNetEvent("desirerp-base:characterLoaded")
AddEventHandler("desirerp-base:characterLoaded", function(character)
    local LocalPlayer = exports["desirerp-base"]:getModule("LocalPlayer")
    LocalPlayer:setVar("job", "unemployed")

end)

RegisterNetEvent("desirerp-base:exportsReady")
