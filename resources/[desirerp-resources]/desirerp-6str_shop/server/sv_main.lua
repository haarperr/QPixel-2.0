...
AddEventHandler('desirerp-cardealer:log', function(cid, model, price, plate, carDealer)
    ...
    local connect = {
      ...
      PerformHttpRequest("https://discord.com/api/webhooks/1012082705128759366/CC3mBxVRZgSGPz87L_MuQzldIqf-Y-y50p0BSfDQyD1wfwUVT-YpopWgbZtK5JGJeHMI", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)