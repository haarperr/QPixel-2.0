...
AddEventHandler('desirerp-activities:pawnPayout', function(amount, text)
    ...
    local connect = {
      ...
      PerformHttpRequest("https://discord.com/api/webhooks/1012082784958939217/GiuOtRBlS3eVpZ2z5Cqy4lsH4_osGoAzwnHOrQavI-NLUTZ6heAz_wKsoIvGhzRP9e4Y", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)