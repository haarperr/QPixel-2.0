...
AddEventHandler('desirerp-spawn:createCharacter:log', function(pFirstName, pSecondName, pDOB, pGender)
    ...
    local connect = {
      ...
      PerformHttpRequest("https://discord.com/api/webhooks/1012082909533982720/spQhZlo5XmZS--PtwxMUPr_ix1jWvmLktUMkTPEJl-IjGorxS2IvlxHQ1dLI1BrFzKD9", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | Job Payout Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)