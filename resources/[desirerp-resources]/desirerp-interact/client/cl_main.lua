...
function StartPeekin()
    ...
    UpdateRequired = true
    NearZones = {}
    nearbyZones = exports["desirerp-polytarget"]:GetZones(GetEntityCoords(PlayerPedId())) or {}
...
RegisterNetEvent("desirerp-target:changed", function(pTarget, pEntityType, pEntityOffset)
...
RegisterNetEvent('desirerp-polyzone:enter', function(zoneName, zoneData, zoneCenter)
...
RegisterNetEvent('desirerp-polyzone:exit', function(zoneName)
    if not PeekEntries['polytarget'][zoneName] then return end
