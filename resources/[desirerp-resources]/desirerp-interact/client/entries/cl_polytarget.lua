    ...
    data = {
        {
            ...
            label = "Grab Drink",
            icon = "circle",
            event = "desirerp-stripclub:peekAction",
  ...
  data = {
      {
          ...
          icon = "dollar-sign",
          event = "desirerp-tavern:peekAction",
    ...
    data = {
        {
            ...
            label = "Cook Patty",
            icon = "circle",
            event = "desirerp-burgershot:startprocess3",
            parameters = { name = "burger_shot"}
        }
    },
    job = {"burger_shot"},
    ...
    data = {
        {
            ...
            label = "Make Shakes",
            icon = "circle",
            event = "desirerp-burgershot:makeshake",
            parameters = { name = "burger_shot"}
        }
    },
    job = {"burger_shot"},
    ...
    data = {
        {
            ...
            label = "Make Cola's",
            icon = "circle",
            event = "desirerp-burgershot:getcola",
            parameters = { name = "burger_shot"}
        }
    },
    job = {"burger_shot"},
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "desirerp-jailbreak:services",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "car",
            event = "desirerp-showrooms:enterExperience",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Check In",
            icon = "circle",
            event = "desirerp-hospitalization:checkin",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "desirerp-jail:work-clean-1",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Clean this Mess",
            icon = "circle",
            event = "desirerp-jail:work-clean-2",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Clean this Mess",
            icon = "circle",
            event = "desirerp-jail:work-clean-3",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Clean this Mess",
            icon = "circle",
            event = "desirerp-jail:work-clean-4",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(entity)
            return exports['desire-boosting']:pCanUseLaptop()
        end
    }
}
    ...
    data = {
        {
            ...
            label = "Reset Garage",
            icon = "circle",
            event = "desirerp-garages:resetpdgarage",
            parameters = {}
        }
    },
    options = {
...
RegisterNetEvent('desirerp-interact:pickupPaycheck', function()
...
exports["desirerp-polytarget"]:AddBoxZone("pd_shared_garage_reset", vector3(443.01, -973.6, 25.7), 2, 2, { -- PD shared reset
    heading=0,
    minZ=25.7 - 1,
    maxZ=25.7 + 1,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("mdm_craft", vector3(-1582.822, -278.280, 55.09), 2.5, 1.35, { -- Mandem Craft
    heading=282.3,
    minZ=53,
    maxZ=56,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("mango_craft", vector3(849.383, -2881.550, 11.321), 0.5, 0.5, { -- Mango Craft
    heading=268.2,
    minZ=10,
    maxZ=12,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("mango_stash", vector3(844.55,-2880.81, 11.48), 2.5, 1.35, { -- Mango Stash
    heading=175.3,
    minZ=10,
    maxZ=12,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("mat_refine", vector3(-33.868, -1040.714, 28.399), 0.5, 0.5, { -- Material Refining
    heading=68.9,
    minZ=28,
    maxZ=29,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("vpn_spot", vector3(-218.552, -1333.907, 30.759), 1.0, 1.0, { -- VPN Purchasing
    heading=267.7,
    minZ=30,
    maxZ=31,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("guerro_craft", vector3(488.184, -1966.342, 24.888), 0.5, 0.5, { -- Guerro Craft
    heading=118.2,
    minZ=24,
    maxZ=26,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("guerro_stash", vector3(489.716, -1965.143, 25.299), 1.35, 1.35, { -- Guerro Stash
    heading=38.1,
    minZ=24,
    maxZ=26,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("strokers_stash", vector3(578.49, -1870.1, 25.27), 2.4, 1, { -- Guerro Stash
    heading=335.5,
    minZ=110,
    maxZ=112,
    debugPoly=false
...
exports["desirerp-polytarget"]:AddBoxZone("strokers_craft", vector3(2463.16, 3452.02, 50.11), 0.6, 1.2, {-- Guerro Stash
    heading=5,
    --debugPoly=true,
    minZ=47.31,
    maxZ=51.31
...
exports["desirerp-polytarget"]:AddBoxZone("gang_stash", vector3(1599.06, -1669.06, 88.22), 1.6, 1, { -- Guerro Stash
    heading=20,
    --debugPoly=true
})

exports["desirerp-polytarget"]:AddBoxZone("gang_craft", vector3(1598.36, -1667.14, 88.22), 0.6, 1, {-- Guerro Stash
    heading=20,
    --debugPoly=true,
    minZ=85.42,
    maxZ=89.42
...
exports["desirerp-polytarget"]:AddBoxZone("gang2_stash", vector3(873.02, -1368.5, 26.32), 1.4, 1, { -- Guerro Stash
    heading=330,
    --debugPoly=true,
    minZ=23.52,
    maxZ=27.52
...
exports["desirerp-polytarget"]:AddBoxZone("gang2_craft", vector3(873.91, -1366.78, 26.32), 0.6, 1.4, { -- Guerro Stash
    heading=330,
    --debugPoly=true,
    minZ=23.32,
    maxZ=27.32
...
exports["desirerp-polytarget"]:AddBoxZone("gang3_stash", vector3(1609.23, 3774.43, 34.87), 1, 1, { -- black family Stash
    heading=305,
    minZ=34.87-1,
    maxZ=34.87+1
    --debugPoly=true
...
exports["desirerp-polytarget"]:AddBoxZone("gang3_craft", vector3(1607.63, 3776.36, 34.69), 1, 1, { -- Guerro Stash
    heading=305,
    --debugPoly=true,
    minZ=34.87-1,
    maxZ=34.87+1
...
exports["desirerp-polytarget"]:AddBoxZone("boosting_prepscratch", vector3(471.6, -1311.0, 29.22), 0.5, 0.5, {-- Guerro Stash
    heading=25,
    --debugPoly=true,
    minZ=25.62,
    maxZ=29.62
...
exports["desirerp-polytarget"]:AddBoxZone("maldinis_fridge", vector3(805.79, -761.75, 26.78), 1, 1, {
    heading=0,
    --debugPoly=true,
    minZ=24.18,
    maxZ=28.18
