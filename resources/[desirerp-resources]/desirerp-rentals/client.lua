...
Citizen.CreateThread(function()
    ...
    while(true) do
		...
		if addedPolyZone == false then
			    exports["desirerp-polyzone"]:AddBoxZone("carrent", vector3(110.4619140625, -1090.6267089844, 29.302474975586), 0.8, 0.9, {
				name="carrent",
				heading=331.47,
				debugPoly=false,
				minZ=22.37,
...
--RegisterNetEvent('desirerp-carrent:menu')
--AddEventHandler('desirerp-carrent:menu', function()   
...
AddEventHandler('desirerp-carrent:menu', function()                           
  TriggerEvent('desirerp-context:sendMenu', {
        ...
        },
        {
			...
			params = {
                event = "desirerp-carrent:checkmoney",
                args = {
                    car = Config.Car1,
...
RegisterNetEvent('desirerp-carrent:checkmoney')
AddEventHandler('desirerp-carrent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("desirerp-carrent:hasmoney", price, vehicle)

end)

RegisterNetEvent('desirerp-carrent:spawncar')
AddEventHandler('desirerp-carrent:spawncar', function(vehicleName)                            
