...
Citizen.CreateThread(function()
	exports["desirerp-polyzone"]:AddBoxZone("recyle_enter", vector3(892.37, -2171.84, 32.29), 1.4, 1, {
		name="recyle_enter",
		heading=85,
		--debugPoly=true,
		minZ=29.49,
	...
	exports["desirerp-polyzone"]:AddBoxZone("recycle_exit", vector3(997.49, -3091.93, -38.75), 1.2, 1, {
		name="recycle_exit",
		heading=0,
		--debugPoly=true,
		minZ=-41.75,
...
AddEventHandler('desirerp-polyzone:enter', function(name)
    if name == "recyle_enter" then
        nearRecyle = true
		exports["desirerp-interface"]:showInteraction('[E] Enter Recycle')
		NearRecyleSpot()
    elseif name == "recycle_exit" then
        nearExitRecyle = true
		exports["desirerp-interface"]:showInteraction('[E] Exit Recycle')
		ExitRecyle()
	end
end)
