...
RegisterServerEvent('desirerp-scoreboard:AddPlayer')
AddEventHandler("desirerp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("desirerp-scoreboard:AddPlayer", -1, data )
...
function DPX.Scoreboard.AddAllPlayers(self)
    ...
    for i, _PlayerId in pairs(GetPlayers()) do
        ...
        TriggerClientEvent("desirerp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("desirerp-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("desirerp-scoreboard:RemoveRecent", -1, plyid)
end)
