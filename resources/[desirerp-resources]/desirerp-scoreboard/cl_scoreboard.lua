...
RegisterNetEvent("desirerp-scoreboard:RemovePlayer")
AddEventHandler("desirerp-scoreboard:RemovePlayer", function(data)
    DPX.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("desirerp-scoreboard:AddPlayer")
AddEventHandler("desirerp-scoreboard:AddPlayer", function(data)
    DPX.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("desirerp-scoreboard:RemoveRecent")
AddEventHandler("desirerp-scoreboard:RemoveRecent", function(src)
    DPX.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("desirerp-scoreboard:AddAllPlayers")
AddEventHandler("desirerp-scoreboard:AddAllPlayers", function(data)
