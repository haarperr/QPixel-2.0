...
AddEventHandler("desirerp_clothing:list_outfits",function()
    ...
    exports.oxmysql:execute("SELECT slot, name FROM character_outfits WHERE cid = @cid", {['cid'] = cid}, function(skincheck)
    	TriggerClientEvent("desirerp_clothing:ListOutfits",src, skincheck)
	end)
end)

RegisterServerEvent("desirerp_clothing:remove_outfit")
...
RegisterServerEvent("desirerp_clothing:get_outfit")
AddEventHandler("desirerp_clothing:get_outfit",function(slot)
    ...
    exports.ghmattimysql:execute("SELECT * FROM character_outfits WHERE cid = @cid and slot = @slot", {
        ...
        if result and result[1] then
            ...
            TriggerClientEvent("desirerp_clothing:setclothes", src, data , 0)
...
RegisterServerEvent("desirerp_clothing:set_outfit")
