...
RegisterNetEvent("cocaine-search", function()
    ...
    local finished = exports["desirerp-taskbar"]:taskBar(3000,"Searching Vehicle")
...
RegisterNetEvent("desirerp-heists:cocaine:failure")
AddEventHandler("desirerp-heists:cocaine:failure", function ()
...
RegisterNetEvent("desirerp-heists:cocaine:begin_start")
AddEventHandler("desirerp-heists:cocaine:begin_start", function ()
...
RegisterNetEvent("desirerp-heists:cocaine:success:2")
AddEventHandler("desirerp-heists:cocaine:success:2", function ()
    if not enabled or not eventStarted then
        return
    end
    blackoutStatus = false
...
RegisterNetEvent("desirerp-heists:cocaine:success:3")
AddEventHandler("desirerp-heists:cocaine:success:3", function ()
    if not enabled or not eventStarted then
        return
    end
    blackoutStatus = false
...
RegisterNetEvent("desirerp-heists:cocaine:success:4")
AddEventHandler("desirerp-heists:cocaine:success:4", function ()
...
Citizen.CreateThread(function()
    ...
    -- exports["desirerp-polytarget"]:AddBoxZone("heist_cocaine_phonecall", vector3(129.2166,244.865,107.45), 3.5, 3.5, {
    --     heading= 0
    -- })
    ...
    exports['desirerp-interact']:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
        event = "desirerp-heists:cocaine:failure",
    ...
    -- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
    --     event = "desirerp-heists:cocaine:begin_start",
    ...
    -- exports["desirerp-polytarget"]:AddBoxZone(
    ...
    -- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_second', {{
    --     event = "desirerp-heists:cocaine:failure",
    ...
    -- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_second', {{
    --     event = "desirerp-heists:cocaine:success:2",
    ...
    -- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_third', {{
    --     event = "desirerp-heists:cocaine:failure",
    ...
    -- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_third', {{
    --     event = "desirerp-heists:cocaine:success:3",
    ...
    -- exports["desirerp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{
    --     event = "desirerp-heists:cocaine:success:4",
...
RegisterNetEvent("desirerp-heists:doVehicle", function(pVehicle, x,y,z)
...
RegisterCommand('cocaine', function()
    ...
    Wait(5500)
    TriggerEvent('desirerp-heists:cocaine:success:4')
end)