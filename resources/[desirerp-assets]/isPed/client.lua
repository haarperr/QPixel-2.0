...
AddEventHandler("desirerp-jobmanager:playerBecameJob", function(jobpassed, name, notify)
	job = jobpassed
    if not job then
        job = "None"
    end
...
AddEventHandler('desirerp-base:addedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

RegisterNetEvent('desirerp-base:removedMoney')
AddEventHandler('desirerp-base:removedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)
