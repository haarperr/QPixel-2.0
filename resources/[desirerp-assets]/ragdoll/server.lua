...
RegisterServerEvent('desirerp-ragdoll:removeallitems')
AddEventHandler('desirerp-ragdoll:removeallitems', function()
    local src = source
...
AddEventHandler('ragdoll:reviveSV', function(t)
    ...
    TriggerClientEvent('desirerp-hospital:client:RemoveBleed', t) 
    TriggerClientEvent('desirerp-hospital:client:ResetLimbs', t)
end)
