...
Citizen.CreateThread(function()
    exports["desirerp-polytarget"]:AddBoxZone("prison_services", vector3(1832.04, 2579.93, 46.01), 1.0, 1.0, {
        heading=0,
        minZ=45.81,
        maxZ=47.21
      })
      ...
      while jailbreak do 
        Wait(1)
          ...
          if #(vector3(1643.5603027344,2585.4670410156,45.564853668213) - GetEntityCoords(PlayerPedId())) < 1 then
            exports["desirerp-base"]:getModule("Util"):MissionText("Enter Court Yard", 500)
          ...
          elseif #(vector3(1636.2059326172,2565.4235839844,45.56485748291) - GetEntityCoords(PlayerPedId())) < 1 then
            exports["desirerp-base"]:getModule("Util"):MissionText("Exit Court Yard", 500)
            if not teleported then
              teleported = true
