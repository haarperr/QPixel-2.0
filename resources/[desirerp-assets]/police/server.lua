...
AddEventHandler("911", function(args, pStreetName)
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1012082593790951525/jOaujaZf4fXM5XVf8hiVBfylIGS65mGODaGY3G7xvmOMo6KHkyhWjd6xvNDyeCMfQ4OR", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | 911 Call", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
...
AddEventHandler("311", function(args)
    ...
    TriggerClientEvent("chatMessage", src,
        ...
        PerformHttpRequest("https://discord.com/api/webhooks/1012082637910847600/cKpN2i_Sn8PNYulkz54mPViM_SawPRIVmzrUUfKXXdSY6OeGUvR9n970_1_y2ixT36Tt", function(err, text, headers) end, 'POST', json.encode({username = "DesireRP | 311 Call", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
