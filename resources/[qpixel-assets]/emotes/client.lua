...
AddEventHandler("Animation:Set:Gait", function(pArgs)
    ...
    if setGait == "move_m@swagger" then
      if exports["qpixel-inventory"]:hasEnoughOfItem("pimpcane", 1) then
...
anims = {
    ...
    ["c"] = function(ped)
        if exports["qpixel-flags"]:HasPedFlag(PlayerPedId(), 'isSittingOnChair') then
          TriggerEvent("novelemotes:sitOnChair")
        elseif exports["qpixel-flags"]:HasPedFlag(PlayerPedId(), 'isPoledancing') then
    ...
    ["umbrella"] = function(ped)
        if obj ~= 0 then
            ...
            TriggerEvent("destroyPropPerm")
            if exports["qpixel-inventory"]:hasEnoughOfItem("umbrella", 1) then
    ...
    ["smoke"] = function(ped)
        ...
        if exports["qpixel-inventory"]:hasEnoughOfItem("ciggy", 1) then
            ClearPedTasks(PlayerPedId())
    ...
    ["cigar"] = function(ped)
        if exports["qpixel-inventory"]:hasEnoughOfItem("cigar", 1) then
            local animDict = "amb@world_human_smoking@male@male_a@enter"
            local animation = "enter"
            if IsPedArmed(ped, 7) then
                SetCurrentPedWeapon(ped, 0xA2719263, true)
