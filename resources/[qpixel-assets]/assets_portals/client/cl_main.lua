...
AddEventHandler('meth:enter', function()
	if exports["qpixel-inventory"]:hasEnoughOfItem("methlabkey",1,false) then
		DoScreenFadeOut(1)
		Citizen.Wait(100)
		TriggerEvent("dooranim")
		TriggerEvent('InteractSound_CL:PlayOnOne', 'DoorOpen', 0.8)
...
exports["qpixel-polytarget"]:AddBoxZone("roof_up", vector3(331.85, -597.17, 43.28), 0.2, 0.2, {
    heading=0
  })

  exports["qpixel-polytarget"]:AddBoxZone("roof_exit", vector3(338.62, -583.84, 74.16), 3.0, 1, {
    heading=0
  })

  exports["qpixel-polytarget"]:AddBoxZone("hos_lower", vector3(329.92, -602.65, 43.28), 0.6, 0.6, {
    heading=0
  })

  exports["qpixel-polytarget"]:AddBoxZone("hos_upper", vector3(344.71, -584.7, 28.8), 0.6, 1, {
    heading=0
  })