...
AddEventHandler('veh.randomDegredation', function(upperLimit,vehicle,spinAmount)
    ...
    if checkPlayerOwnedVehicles then
		...
		print("[qpixel-vehicles]: Random Degredation | Plate Number: " ..plate .. " | Internal Values: "..round(br/ 10,2) .. " " ..round(ax/ 10,2) .. " " ..round(rad/ 10,2).. " " ..round(cl/ 10,2) .. " " ..round(tra/ 10,2) .. " " ..round(elec/ 10,2).. " " ..round(fi/ 10,2) .. " " .. round(ft/ 10,2))
