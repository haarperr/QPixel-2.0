...
RegisterServerEvent('qpixel-ragdoll:removeallitems')
AddEventHandler('qpixel-ragdoll:removeallitems', function()
    local src = source
...
AddEventHandler('ragdoll:reviveSV', function(t)
    ...
    TriggerClientEvent('qpixel-hospital:client:RemoveBleed', t) 
    TriggerClientEvent('qpixel-hospital:client:ResetLimbs', t)
end)
