...
Citizen.CreateThread(function()
    exports["qpixel-polyzone"]:AddBoxZone("banking", vector3(149.97, -1040.54, 29.37), 1.5, 2, {
        name="banking",
        heading=157.96,
        debugPoly=false,
        minZ=27.6,
    ...
    exports["qpixel-polyzone"]:AddBoxZone("banking", vector3(-1212.980, -330.841, 37.787), 1.5, 2, {
        name="banking",
        heading=208.95,
        debugPoly=false,
        minZ=36.68,
	...
	exports["qpixel-polyzone"]:AddBoxZone("banking", vector3(-2962.582, 482.627, 15.703), 1.5, 2, {
        name="banking",
        heading=264.78,
        debugPoly=false,
        minZ=14.6,
	...
	exports["qpixel-polyzone"]:AddBoxZone("banking", vector3(-112.202, 6469.295, 31.626), 1.5, 2, {
        name="banking",
        heading=320.61,
        debugPoly=false,
        minZ=30.6,
	...
	exports["qpixel-polyzone"]:AddBoxZone("banking", vector3(314.187, -278.621, 54.170), 1.5, 2, {
        name="banking",
        heading=161.0,
        debugPoly=false,
        minZ=53.23,
	...
	exports["qpixel-polyzone"]:AddBoxZone("banking", vector3(-350.8, -49.53, 49.04), 1.5, 2, {
        name="banking",
        heading=163.22,
        debugPoly=false,
        minZ=48.04,
	...
	exports["qpixel-polyzone"]:AddBoxZone("banking", vector3(1175.06, 2706.64, 38.09), 1.5, 2, {
        name="banking",
        heading=359.12,
        debugPoly=false,
        minZ=36.99,
	...
	exports["qpixel-polyzone"]:AddBoxZone("wakingup", vector3(316.09, -582.32, 43.28), 17.0, 7.4, {
    name="wakingup",
		heading=359.12,
		debugPoly=false,
		minZ=36.99,
...
AddEventHandler('qpixel-polyzone:enter', function(name)
    if name == "banking" then
        banking = true
        exports["qpixel-interface"]:showInteraction("[E] Banking")
        bankingopen()
    end
end)
    ...
    if IsNearATM() then
      if ( DoesEntityExist( player ) and not IsEntityDead( player )) then 
          ...
          if ( atmuse ) then 
              ...
              atmuse = false
              local finished = exports["qpixel-taskbar"]:taskBar(3000,"Retrieving Card")
              ClearPedTasks(PlayerPedId())
          else
              atmuse = true
        ...
        if ( DoesEntityExist( player ) and not IsEntityDead( player )) then 
            ...
            if ( atmuse ) then 
                ...
                atmuse = false
                local finished = exports["qpixel-taskbar"]:taskBar(1000,"Retrieving Card")
                ClearPedTasks(PlayerPedId())
            else
                atmuse = true
                TaskPlayAnim( player, "mp_common", "givetake1_a", 1.0, 1.0, -1, 49, 0, 0, 0, 0 )
...
RegisterNetEvent("qpixel-base:addedMoney")
AddEventHandler("qpixel-base:addedMoney", function(amt, total)
  TriggerEvent("banking:updateCash", total)
  TriggerEvent("banking:addCash", amt)
end)

RegisterNetEvent("qpixel-base:removedMoney")
AddEventHandler("qpixel-base:removedMoney", function(amt, total)
  TriggerEvent("banking:updateCash", total)
