...
AddEventHandler("qpixel-jobmanager:playerBecameJob", function(jobpassed, name, notify)
	job = jobpassed
    if not job then
        job = "None"
    end
...
AddEventHandler('qpixel-base:addedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)

RegisterNetEvent('qpixel-base:removedMoney')
AddEventHandler('qpixel-base:removedMoney', function(blah,amount)
  cash = math.ceil(amount)
end)
