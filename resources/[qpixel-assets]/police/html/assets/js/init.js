            ...
            switch(event.data.action) {
                ...
                case 'showMenu':
                    ...
                    $('#hud-on').on('change',function(){
                        ...
                        $.post('https://qpixel-hud/hud_on',JSON.stringify({
                            hud_on: hud_on
                        }));
                    });
                    ...
                    $('#compassinput').on('change',function(){
                        ...
                        $.post('https://qpixel-hud/compassinput',JSON.stringify({
                    ...
                    $('#compassTime').on('change',function(){
                        ...
                        $.post('https://qpixel-hud/compassTime',JSON.stringify({
                    ...
                    $('#compassStreet').on('change',function(){
                        ...
                        $.post('https://qpixel-hud/compassStreet',JSON.stringify({
                    ...
                    $('#d_minimap').on('change',function(){
                        ...
                        $.post('https://qpixel-hud/minimap_clip',JSON.stringify({
                            d_minimap: d_minimap
                        }));
                    });
                    ...
                    $('#speedmeter').keyup(function(){
                        ...
                        $.post('https://qpixel-hud/update:timer:speed',JSON.stringify({
                            fps_speed: fps_speed
                        }));
                    });
...
$('#minimap').change(function(){
    let on = this.checked
    $.post('https://qpixel-hud/ayar-minimap',JSON.stringify({
        minimap: on
    }));
});
...
ronin.CloseAyarMenu = function() {
    ...
    $.post('https://qpixel-hud/close-ayar-menu');
};
