...
Citizen.CreateThread(function()
    ...
    exports["qpixel-polyzone"]:AddBoxZone("mrpd_clothing_lockers", vector3(461.81, -997.79, 30.69), 4.4, 4.8, {
        heading = 0,
        minZ = 29.64,
        maxZ = 32.84
    })

    exports["qpixel-polyzone"]:AddBoxZone("mrpd_armory", vector3(481.59, -995.35, 30.69), 3.2, 0.8, {
        heading = 90,
        minZ = 29.69,
        maxZ = 32.49
    })

    exports["qpixel-polyzone"]:AddBoxZone("mrpd_evidence", vector3(474.84, -996.26, 26.27), 1.2, 3.0, {
        heading = 90,
        minZ = 25.27,
        maxZ = 27.87
    })

    exports["qpixel-polyzone"]:AddBoxZone("mrpd_trash", vector3(472.88, -996.28, 26.27), 1.2, 3.0, {
        heading = 90,
        minZ = 25.27,
        maxZ = 27.87
    })

    exports["qpixel-polyzone"]:AddBoxZone("mrpd_character_switcher", vector3(478.88, -983.49, 30.69), 1.35, 1.3, {
        heading = 0,
        minZ = 29.74,
        maxZ = 32.74
    })
    ...
    -- Davis PD
    exports["qpixel-polyzone"]:AddBoxZone("davispd_character_switcher", vector3(358.51, -1597.88, 25.45), 1.65, 4.8, {
        heading = 320,
        minZ = 24.45,
        maxZ = 27.25
    })

    exports["qpixel-polyzone"]:AddBoxZone("davispd_clothing_lockers", vector3(362.38, -1593.53, 25.45), 5.0, 4.2, {
        heading = 320,
        minZ = 24.45,
        maxZ = 27.05
    })

    exports["qpixel-polyzone"]:AddBoxZone("davispd_armory", vector3(365.28, -1603.51, 25.45), 3.2, 1.4, {
        heading = 319,
        minZ = 24.25,
        maxZ = 26.65
    })
    ...
    -- Armory, VBPD
    exports["qpixel-polyzone"]:AddBoxZone("vbpd_armory", vector3(-1075.05, -830.85, 19.3), 4.6, 1.2, {
        heading = 308,
        minZ = 18.3,
        maxZ = 21.1
    })

    exports["qpixel-polyzone"]:AddBoxZone("vbpd_clothing_lockers", vector3(-1087.41, -832.43, 19.3), 4.2, 11.2, {
        heading = 308,
        minZ = 18.15,
        maxZ = 21.95
    })

    exports["qpixel-polyzone"]:AddCircleZone("vbpd_character_switcher", vector3(-1081.85, -834.42, 19.3), 0.5, {
        useZ = true
    })

    exports["qpixel-polyzone"]:AddCircleZone("vbpd_evidence", vector3(-1099.11, -824.35, 19.3), 0.7, {
        useZ = true
    })

    exports["qpixel-polyzone"]:AddCircleZone("vbpd_trash", vector3(-1096.47, -818.9, 19.3), 0.3, {
        useZ = true
    })

    exports["qpixel-polyzone"]:AddBoxZone("sandy_clothing_lockers", vector3(1855.59, 3692.15, 34.22), 2.1, 2.9, {
        heading = 30,
        minZ = 31.42,
        maxZ = 35.42
    })

    exports["qpixel-polyzone"]:AddBoxZone("sandy_character_switch_evidence_trash_armory", vector3(1862.08, 3690.21, 34.22),
        2.6, 3.8, {
            heading = 30,
            minZ = 32.02,
            maxZ = 36.02
    ...
    exports["qpixel-polyzone"]:AddBoxZone("paleto_clothing_lockers_character_switch_evidence_trash_armory",
    ...
    exports["qpixel-polyzone"]:AddBoxZone("paleto_clothing_lockers_character_switch", vector3(-438.57, 6010.16, 37.0), 4.8,
        3.6, {
            heading = 316,
            minZ = 35.8,
            maxZ = 38.4
    ...
    exports["qpixel-polyzone"]:AddBoxZone("beaverpd_clothing_lockers_character_switch_evidence_trash_armory",
    ...
    exports["qpixel-polyzone"]:AddBoxZone("doc_clothing_lockers", vector3(1834.65, 2571.73, 46.01), 2.8, 2.2, {
        heading = 0,
        minZ = 45.01,
        maxZ = 47.81
    })

    exports["qpixel-polyzone"]:AddBoxZone("doc_armory", vector3(1841.37, 2573.99, 46.01), 1.6, 1.6, {
        heading = 0,
        minZ = 45.01,
        maxZ = 47.61
    })

    exports["qpixel-polyzone"]:AddBoxZone("doc_character_switcher", vector3(1841.34, 2569.78, 46.05), 2.2, 1.8, {
        heading = 0,
        minZ = 45.05,
        maxZ = 47.85
    })
    ...
    -- davis pd
    exports["qpixel-polyzone"]:AddBoxZone("davispd_evidence", vector3(361.84, -1599.58, 25.45), 2.0, 2.0, {
        heading = 50,
        minZ = 24.15,
        maxZ = 26.95
    })

    exports["qpixel-polyzone"]:AddBoxZone("davispd_trash", vector3(360.72, -1602.23, 25.45), 2, 1.5, {
        heading = 90,
        minZ = 23.35,
        maxZ = 27.35
    })
    ...
    -- Prison - Bus Spawn
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(1689.371948, 2605.291992, 44.564999), 5.8, 15.0, {
        heading = 0,
        minZ = 44.56,
        maxZ = 47.56
    })
    ...
    -- MRPD - Underground B
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(425.97, -980.22, 25.7), 11.6, 6.4, {
        heading = 0,
        minZ = 24.7,
        maxZ = 29.7
    })
    ...
    -- MRPD - Bus Spawn
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(479.43, -1019.49, 27.96), 6.0, 15.0, {
        heading = 0,
        minZ = 26.96,
        maxZ = 28.96
    })
    ...
    -- MRPD Helipads
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(466.16, -981.74, 43.69), 13.6, 46.8, {
        heading = 0,
        minZ = 39.89,
        maxZ = 46.89
    })
    ...
    -- Vespucci PD Helipad
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(-1095.58, -834.96, 37.68), 14.0, 13.6, {
        heading = 40,
        minZ = 36.48,
        maxZ = 40.68
    })
    ...
    -- Paleto PD Helipad
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(-475.69, 5988.67, 31.34), 14.0, 13.6, {
        heading = 40,
        minZ = 30.34,
        maxZ = 34.54
    })
    ...
    -- VBPD Garage
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(-1131.84, -836.9, 3.75), 37.35, 62.6, {
        heading = 37,
        minZ = 2.55,
        maxZ = 6.75
    })
    ...
    -- Paleto PD Garage
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(-474.19, 6029.99, 31.34), 28.4, 12.8, {
        heading = 315,
        minZ = 30.24,
        maxZ = 34.24
    })
    ...
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(-585.92, -236.39, 35.7), 36.0, 4.4, {
        heading = 30,
        minZ = 34.7,
        maxZ = 37.9
    })
    ...
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(1847.74, 3671.26, 33.87), 50.6, 7.8, {
        heading = 300.0,
        minZ = 32.27,
        maxZ = 36.07
    })
    ...
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(374.53, 795.94, 187.28), 10, 8, {
        heading = 180.0,
        minZ = 186.08,
        maxZ = 191.28
    })
    ...
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(1770.36, 3239.85, 41.36), 14.0, 14.8, {
        heading = 15,
        minZ = 40.79,
        maxZ = 45.79
    })
    ...
    -- Sandy PD
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(1843.4, 3636.82, 35.64), 11.2, 10.0, {
        heading = 355,
        minZ = 34.24,
        maxZ = 39.44
    })
    ...
    -- Davis PD
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared", vector3(397.73, -1623.0, 29.29), 19.0, 5.8, {
        heading = 320,
        minZ = 28.29,
        maxZ = 31.69
    })

    exports["qpixel-polyzone"]:AddBoxZone("pd_shared_bike", vector3(1880.59, 3691.18, 33.54), 6.4, 7.0, {
        heading = 30,
        minZ = 32.14,
        maxZ = 35.94
    })

    exports["qpixel-polyzone"]:AddBoxZone("pd_shared_bike", vector3(-1119.91, -859.81, 13.41), 23.8, 9.6, {
        heading = 304,
        minZ = 12.31,
        maxZ = 17.31
    })

    exports["qpixel-polyzone"]:AddBoxZone("pd_shared_bike", vector3(-457.98, 6044.63, 31.34), 16.2, 7.0, {
        heading = 45,
        minZ = 30.14,
        maxZ = 35.34
    })
    ...
    exports["qpixel-polyzone"]:AddBoxZone("pd_shared_bike", vector3(389.89, -1611.71, 29.29), 12.4, 6.0, {
        heading = 321,
        minZ = 28.29,
        maxZ = 31.89
    })

    exports["qpixel-polyzone"]:AddBoxZone("ems_shared", vector3(352.26, -588.32, 74.36), 15.8, 16.4, {
        name = "emschop",
        heading = 330,
        minZ = 73.0,
        maxZ = 76.36
    ...
    exports["qpixel-polyzone"]:AddBoxZone("ems_shared", vector3(-790.76, -1191.65, 53.03), 14.2, 13.2, {
        name = "ems3",
        heading = 320,
        minZ = 51.03,
        maxZ = 55.03
    ...
    exports["qpixel-polyzone"]:AddBoxZone("ems_shared", vector3(1217.43, -1525.4, 34.69), 16.6, 6.4, {
        name = "emsrancho",
        heading = 90,
        minZ = 33.49,
        maxZ = 39.69
    ...
    exports["qpixel-polyzone"]:AddBoxZone("ems_shared", vector3(1814.22, 3686.16, 34.22), 9.2, 5.2, {
        name = "ems_sandy",
        heading = 299,
        minZ = 32.62,
        maxZ = 36.62
    ...
    exports["qpixel-polyzone"]:AddCircleZone("ems_shared", vector3(1865.39, 3647.48, 35.6), 9.75, {
        name = "ems_sandy_heli"
    })
...
RegisterInterfaceCallback("qpixel-police:handler", function(data, cb)
        ...
        while listening do
            if IsControlJustReleased(0, 38) then
                ...
                if pZone == "mrpd_clothing_lockers" or pZone == "vbpd_clothing_lockers" or pZone ==
                    ...
                    exports["qpixel-interface"]:showContextMenu(zoneData[pZone].menuData)
...
AddEventHandler("qpixel-polyzone:enter", function(zone)
    ...
    if currentZone then -- and isCop
        ...
        exports["qpixel-interface"]:showInteraction(prompt)
...
AddEventHandler('qpixel-inventory:itemUsed', function(itemId, itemInfo, inventoryName, slot)
    ...
    if not metaData.inventoryId then
        exports['qpixel-interface']:openApplication('textbox', {
            callbackUrl = 'qpixel-interface:saveEvidenceBag',
            key = {
                slot = slot
            },
            items = {{
...
RegisterInterfaceCallback("qpixel-interface:saveEvidenceBag", function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
