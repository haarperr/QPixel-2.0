...
--     local user = exports["qpixel-base"]:getModule("Player"):GetUser(src)
--     local char = user:getCurrentCharacter()
--     local target = exports["qpixel-base"]:getModule("Player"):GetUser(tonumber(args[1]))

--     if user:getVar("job") == 'police' or user:getVar("job") == 'doc' then
--         if tonumber(args[1]) and exports["qpixel-base"]:getModule("Player"):GetUser(tonumber(args[1])) then
