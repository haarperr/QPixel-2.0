...
function openMenu()
    local myjob = exports['divine-fw']:CurrentJob()
...
RegisterNetEvent('divine-dispatch:altercallsign;spawn')
AddEventHandler('divine-dispatch:altercallsign;spawn',function(getCallsign,pStatusType)
    exports['divine-dispatch']:callsign_command(getCallsign,pStatusType)
end)
...
AddEventHandler("civilian:alertPolice",function(basedistance,alertType,objPassed,isGunshot,isHunting,sentWeapon)
    local isPolice = exports['divine-fw']:CurrentJob() == 'police' or exports['divine-fw']:CurrentJob() == 'sheriff' or exports['divine-fw']:CurrentJob() == 'state'
...
RegisterCommand('911', function(source, args, rawCommand)
    ...
    if string.len(msg) > 0 then
        local user = exports["divine-fw"]:GetModule("LocalPlayer")
        ...
        exports['divine-taskbar']:Progress({
            duration = 10000,
            label = "Dialing 911",
        }, function(cancelled)
