...
function setCoords(x, y) {
    $.post('https://divine-dispatch/set-coords', JSON.stringify({
        x: x,
        y: y
    }));
}
...
$(document).ready(function() {
	window.addEventListener('message', function(event){
        ...
        if (event.data.action == "close") {
            $.post('https://divine-dispatch/close', JSON.stringify({}));
            outKapa();
		}

        if (event.data.action == "close-callsign") {

            $.post('https://divine-dispatch/close-callsign', JSON.stringify({}));
            outKapa();
		}
        ...
        $('.create-call').click(function() {
            $.post('https://divine-dispatch/create_call', JSON.stringify({
                number: roninNumber
            }));
        })
        ...
        $('.dismiss-pingg').click(function() {
            ...
            $('.called-list').fadeOut();
            $.post('https://divine-dispatch/dismiss_call-2', JSON.stringify({
                number: roninNumber
            }));
        })
    ...
    function vehiclesClick() {
        $('.vehicles').click(function() {
            ...
            if (value == 1) {
                ...
                removeItem()
                mesaiHold()
                $.post('https://divine-dispatch/change-vehicle', JSON.stringify({
                    name: policeName,
                    icon: icon
                }));
                ...
                $.post('https://divine-dispatch/table_ayril', JSON.stringify({
                    name: remove
                }));
    ...
    $('.dismiss-ping').click(function() {
        ...
        $.post('https://divine-dispatch/dismiss_call-1', JSON.stringify({
            number: roninNumber
        }));
    })
    ...
    function assignButtons(){
        $('.assing-buttons').click(function() {
            $.post('https://divine-dispatch/add_police-assign', JSON.stringify({
    ...
    $('.crate-dismiss').click(function() {
        ...
        $.post('https://divine-dispatch/create_call-2', JSON.stringify({
            number: roninNumber
        }));
    })
    ...
    $('.remove-dismis-ping').click(function() {
        $('.dismiss-list').fadeOut();
        createCall4.remove();
        $.post('https://divine-dispatch/remove-call', JSON.stringify({
            number: roninNumber
        }));
    })
    ...
    function cureungotunu() {
        ...
        $('.remove-unit').click(function() {
            ...
            $.post('https://divine-dispatch/delete', JSON.stringify({
                name: player
            }));
            ...
            $('.mesai-personel').each(function() {
                if ($.trim($(this).text()) == text) {
                    ...
                    if (owner == player) {
                        ...
                        $.post('https://divine-dispatch/under-police', JSON.stringify({
                            player: player,
                            owner: owner
                        }));
                    }
    ...
    function callCameRemove(){
        $('.call-came').dblclick(function(e){
            ...
            $('.remove-list .MuiPaper-rounded ul li').click(function(){
                $.post('https://divine-dispatch/delete_police-assign', JSON.stringify({
                    ronin: callCame
                }));
            })
        })
    ...
    function save(){
        ...
        $.post('https://divine-dispatch/save', JSON.stringify({
            html: save
        }));
